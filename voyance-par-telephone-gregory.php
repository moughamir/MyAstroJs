...
$voyant = "BONNET GREGORY";
$prenom = "Gregory";
$n_photo = "08";
$text_l = "J";
$text = "e répondrai avec la plus grande précision à toutes les questions que vous vous posez dans tous les domaines qui vous préoccupent. Je vous dirai honnêtement tout ce qui m’apparaît et vous encouragerai dans votre vie. Plus que tout pour moi, ce qui compte c'est la qualité de l'échange et le respect de ce don de voyance qui m'anime. Je le cultive tous les jours et c'est toujours avec le même plaisir que je le vis et le partage.";

$nom_com_1 ="Elysa";
$commentaire_1 = "un très bon voyant qui ne vous pose pas de question qui a su voir mon passé, mon présent et le futur que j'attends de voir... déja un petit retour positif pour les événements récents je ne manquerai pas de te tenir au courant pour la suite merci";
$date_1 ="30 Mar 2013, 09:00 PM";

$nom_com_2 ="patricia";
$commentaire_2 = "tjrs un plaisir de parler avec toi et jusqu'a présent tu as tjrs vu juste pourrais tu me redire si j'aurai de ses nouvellez bientot je crois te l'avoir demandé mais je sais plus ce que tu as répondu a bientot";
$date_2 ="30 Mar 2013, 3:45 AM";

$nom_com_3 ="sensualité";
$commentaire_3 = "Simon a peur de quoi quant à notre différence d'âge? Il a peur d'assumer quoi? Construirons-nous une relation ou jamais? J'ai peur de perdre mon temps, et un temps fou!";
                        ...
                        <div class="posts-in-widget">
                            <div class="row-fluid modern-items-list">
                            	<?php 
                                    ...
                                    ?>
                                        <img src="images/bannieres/VTE2/gregory.png"  alt="VOYANCE PAR TELEPHONE">
                                    <?php
                                    } else {
                                    ?>
                                    <img src="images/bannieres/voyant-skyscraper/gregory-voyant.jpg"  alt="VOYANCE PAR TELEPHONE">
                                    <?php
                                    }
                                ?>
...
<!--<div class="rating"  style="text-align:right;margin-right:10px;" itemprop="reviewRating" itemscope="" itemtype="http://schema.org/Rating">
  ...
  <div style="text-align:right;margin-right:20px;margin-top:10px;">  
                                                                ...
                                                                <span style="color:#000000;font-weight:bold;font-size:13px;font-family:tahoma, verdana, arial, sans-serif;"><br>Tarifs : 5,5€/MIN SUP<br><br>VOYANT ET MEDIUM PUR</span>
