                            ...
                            <header>
                                <div itemscope >
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li><a href="<?= PROTOCOL.'://'.ROOT_URL ?>/astrologie-gratuite" >Astrologie gratuite</a><i class="icon-caret-right icon-fixed-width"></i><li><a href="<?= PROTOCOL.'://'.ROOT_URL ?>/portrait-astrologique-masculin" >Portrait astrologique masculin</a></li></li><i class="icon-caret-right icon-fixed-width"></i><li>Portrait astrologique masculin Gémeaux</li></h4>
