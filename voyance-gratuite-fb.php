...
<html lang="fr">
	...
	<?= $tracker->getCanonical() ?>
        ...
        <script type="text/javascript" src="./voyance-gratuite-6_files/bootstrap.min.js">
        </script> <script type="text/javascript" src="js/formValidator.js"></script>
                    ...
                    <div class="widget w-adv">
                        <div id="form-w" class="widget-content clearfix">
                            <div class="visible-part form-part form-part-two">
                                ...
                                <form id="">
                                    <input type="hidden" name="source" value="voyance-gratuite-fb" /> <!-- source unique pour la campagne adwords -->
