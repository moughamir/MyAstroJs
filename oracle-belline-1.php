...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    <head>
    <title>Oracle Belline : votre tirage de cartes interprété | MyAstro</title>
...
<body class="oracle oracle-belline">
<div class="subbody">
    <div class="top-nav">
    ...
    <div class="main">
        <div class="left-part">
            ...
            <div class="content">
                <h1>Oracle <strong>Belline</strong></h1>
                <div class="txt-content">
                    <p>Avec notre jeu de lames de l'Oracle de Belline, effectuez un tirage gratuit et en toute simplicité pour connaître votre avenir. Les mystères du destin vous seront ainsi révélés.</p>
                    <p>Une fois les lames de l'Oracle de Belline tirées, l'un de nos experts vous enverra leur interprétation, afin que vous sachiez précisément ce qu'elles veulent dire.</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="paquet">
                            ...
                            <div class="title">Tirez <strong>5</strong> lames</div>
                                ...
                                for ($i = 1; $i <= 21; $i++)
                                {
                                    ...
                                    echo '<img src="images_landing/carte-oracle-belline.png" class="tarot-dos tarot-' . $i . '" data-pos="' . $datapos . '"/>';
                                }
                                ?>
                                </div>
    ...
    <div class="main bottom-part" id="secondpart">
        ...
        <div class="left-bottom-part">
             <div class="comment-ca-marche">
                ...
                <img src="images_landing/oracle-belline.jpg" width="577" height="111" alt="Oracle belline"/>
            </div>
        </div>
                ...
                <aside class="widget w-adv">
                    ...
                    <div id="form-w" class="widget-content clearfix">
                        <div class="visible-part form-part form-part-one">
                            ...
                            <form id="">
                                <input type="hidden" name="source" value="myastro-oracle-a5" />
