...
$voyant = "TOUZET ALEXIS";
$prenom = "Alexis";
$n_photo = "13";
$text_l = "M";
$text = "édium pur de naissance, je vous offre une voyance auditive sérieuse dotée de flashs et de ressentis précis. Mon aide est efficace dans tous les domaines de votre avenir. Je mets en place des tirages de cartes, de tarots et d’autres outils tels que le pendule.";

$nom_com_1 ="linette";
$commentaire_1 = "J’étais très angoissée car je n’arrivais pas à trouver le travail qui correspondait au diplôme que je venais d’obtenir. A part des jobs inintéressants et mal payés, je ne voyais pas la fin du tunnel. J’ai écouté vos conseils et comme vous me l’aviez dit, on m’a contacté pour me proposer un poste qui correspondait complètement à mes attentes. Si vos voyantes n’avaient pas été là pour me rassurer sur mon avenir professionnel, je ne sais pas ce que je serais devenue… Plein de mercis à toute l’équipe my astro qui m’a aidé à traverser cette période difficile";
$date_1 ="19 Avr 2013, 14:16 PM";

$nom_com_2 ="Starou";
$commentaire_2 = "Je dois bien vous avouer que je ne croyais pas à la voyance mais comme tout le monde, quand il vous arrive un coup dur, je me suis dit : Pourquoi ne pas essayer, qu’est ce que je risque ? J’ai noté sur un papier les prédictions du voyant car j’avais peur d’oublier ce qu’il me disait. Je n’en suis pas revenu, j’ai déménagé dans une autre ville avec un nouveau travail alors que je ne m’y attendais pas du tout. Tout s’est réalisé comme ce que le medium voyait. Cette consultation était vraiment impressionnante, elle a changé ma vie… merci et à bientôt.";
$date_2 ="30 Jan 2013, 02:50 AM";

$nom_com_3 ="toufouk";
$commentaire_3 = "ouaahh tout ce que tu m avais dit s est produit avec le temps , je garde henri un excellent souveir de notre echange. Merci pour tout le bien que tu m as fait dans ma vie.";
$date_3 ="01 Jan 2013, 10:30 AM";
...
<!--<div class="rating"  style="text-align:right;margin-right:10px;" itemprop="reviewRating" itemscope="" itemtype="http://schema.org/Rating">
  ...
  <div style="text-align:right;margin-right:20px;margin-top:10px;">  
                                                                ...
                                                                <span style="color:#000000;font-weight:bold;font-size:13px;font-family:tahoma, verdana, arial, sans-serif;"><br>Tarifs : 6,5€/MIN SUP<br><br>MEDIUM PUR</span>
...
.fermer:hover { background: #00d9ff; }
  ...
  <tr><td class="btn-voir-forfait"><div class="bloc-vf"><br><a href="<?= PROTOCOL.'://'.ROOT_URL ?>/forfait-or"><h4>VOIR LES FORFAITS</h4></a></div></td></tr>
 </table>       
