...
<head>
    <title>Votre numéroscope 2016 chiffre 2: Myastro</title>
	<meta name="description" content="Chiffre 2 : Votre numéroscope pour 2016 vous permettra de mieux cerner l'année et les comportements que vous devrez adopter au cours de celle-ci. Demandez le votre à Myastro." />
                            ...
                            <header>
                                <div itemscope >
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li>Numéroscope 2016 chiffre 2</h4></li>
                                    </ul>
                                </div>
					<div class="cat-widget-title">
                        
                            <h1 itemprop="headline">Numéroscope 2016 chiffre 2</h1>
...
<div class="row-fluid social-share-footer">
                                ...
                                <div class="share-icons">
                                    <h5 itemprop="headline">Chiffre 2 : Votre numéroscope pour 2016 vous permettra de mieux cerner l'année et les comportements que vous devrez adopter au cours de celle-ci. Demandez le votre à Myastro.</h5>
                                </div>
            ...
            <div class="span6 main-content">
                ...
                <aside class="widget w-pictures">
                    <div class="widget-title">
                        <h4>Votre Numéroscope 2016 gratuit: chiffre 2</h4>
