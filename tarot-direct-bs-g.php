...
/* 
    --------------------------------------
    --   tarot-direct-bs-g = BEESMART   --
    --------------------------------------

    Created on : 18 octobre 2016
                    ...
                    <div class="ContentBand-Column">
                        <article class="FormContainer">
                            ...
                            <div class="FormContainer-Fields Fields-Table">
                                ...
                                <input type="hidden" name="source" value="tarot-direct-bs-g" />
                                <input type="hidden" name="method" value="general-suscribe" />
                                <input type="hidden" name="support" value="tarot" />
                                <input type="hidden" name="site" value="myastro.fr" />
                                <input type="hidden" name="affiliation" value="beesmart" />
