...
?>
	...
	<body class="voyance-telephone-1 dri-3 dri-6">
	    <div class="top-nav">
	    ...
	    <div class="main">
	        <div class="right-part right-part-merci">
	        	<div class="container-fluid text-center top-header">
	        		<div class="row">
	        			<div class="col-lg-12">
	        				<img class="img-responsive" src="images_landing/logo-dri6.png" alt="MyAstro">
	        			</div>
	        		</div>
	        	</div>
	        	<div class="container-fluid header-container">
	        		<div class="row">
	        			<p>
			        		...
			        		<span class="header-txt-4"><img class="img-responsive" src="images_landing/tarif-min-dri6.png" alt="MyAstro"></span>
				        </p>
	        		</div>
	        	</div>
					...
					<div class="row">
						<aside class="widget" id="form-merci-voyance">
							...
							<div id="" class="widget-content col-xs-12 col-sm-12 col-lg-6">
								<img class="img-promo" src="images_landing/promo-dri6.png">
						...
						<div class="row row-voyant">
							<div class="voyant-membre voyant-merci-voyance">  
								...
								<div class="cols4 mg-right"><img src="images_landing/voyants/marianne.png" alt="" width="178" height="128" />M<span>arianne</span><br/></div>
								<div class="cols4 mg-right"><img src="images_landing/voyants/pierre.png" alt="" width="178" height="128" />P<span>ierre</span><br/></div>
