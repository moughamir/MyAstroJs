...
$voyant = "BELFORT VIKTOR";
$prenom = "Viktor";
$n_photo = "10";
$text_l = "E";
$text = "xpert tarologue, j’excelle dans le domaine des arts divinatoires. Tarologue très apprécié, je suis doté d'un don exceptionnel qu’il amplifie en faisant appel à l’Oracle le Belline, l’Oracle le Laetitia et le Tarot de Marseille. Mon sérieux et ma qualité de voyance sont certifiés. Mon professionnalisme a atteint une grande maturité. Les cartes qui renferment votre avenir n'ont plus aucun secret pour moi.";

$nom_com_1 ="samy";
$commentaire_1 = "oh ben la chapeau !! je n'ai rien dit et vous m'avez répondu à une question que je n'avais même pas encore posée merci beaucoup";
$date_1 ="20 Jui 2013, 03:15 PM";

$nom_com_2 ="England";
$commentaire_2 = "Plus d'unités! merci pour vos conseils,je reste confiante en mon capitaine et j'attends de ses nouvelles. à bientôt!";
$date_2 ="12 Avr 2013, 7:38 AM";

$nom_com_3 ="legumefleur";
$commentaire_3 = "bonsoir ca y est suis rentre une semaine quand meme a ce jour on arrive pas a savoir si cela a reussit; par contre je dois peu etre y retourner; des complications sont la ; tout a été fait en une seule fois; on me propose un autre système mais je suis pas trop d accord en raison du cout et je me dis peu etre que celle qui a été faite est reussi: a voir; bonne soiree";
$date_3 ="05 Fev 2013, 9:08 PM";
                        ...
                        <div class="posts-in-widget">
                            <div class="row-fluid modern-items-list">
                            	<?php 
                                    ...
                                    ?>
                                        <img src="images/bannieres/VTE2/viktor.png"  alt="VOYANCE PAR TELEPHONE">
                                    <?php
                                    } else {
                                    ?>
                                    <img src="images/bannieres/voyant-skyscraper/viktor-tarologue.jpg"  alt="VOYANCE PAR TELEPHONE">
                                    <?php
                                    }
                                ?>
...
<!--<div class="rating"  style="text-align:right;margin-right:10px;" itemprop="reviewRating" itemscope="" itemtype="http://schema.org/Rating">
  ...
  <div style="text-align:right;margin-right:20px;margin-top:10px;">  
                                                                ...
                                                                <span style="color:#000000;font-weight:bold;font-size:13px;font-family:tahoma, verdana, arial, sans-serif;"><br>Tarifs : 5,5€/MIN SUP<br><br>EXPERT TAROLOGUE</span>
