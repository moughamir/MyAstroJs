...
<head>
    <title>Compatibilité amoureuse masculine Cancer: allez-vous bien ensemble?</title>
	<meta name="description" content="Signe Cancer : Les astres, leur alignement et leur position pourront vous indiquer si cette personne que vous chérissez est bien faite pour vous et si la relation doit être entretenue." />
    ...
    <div class="container-fluid" itemscope >
        ...
        <div class="row-fluid">
                            ...
                            <header>
                                <div itemscope >
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li><a href="http://www.myastro.fr/astrologie-gratuite" >Astrologie gratuite</a><i class="icon-caret-right icon-fixed-width"></i><li><a href="http://www.myastro.fr/compatibilite-amoureuse-masculine" >Compatibilité amoureuse masculine</a></li></li><i class="icon-caret-right icon-fixed-width"></i><li>Compatibilité amoureuse masculine Cancer</li></h4>
					...
					<div class="cat-widget-title">
                            ...
                            <h1 itemprop="headline">Compatibilité amoureuse masculine Cancer</h1>
...
<div class="row-fluid social-share-footer">
                                ...
                                <div class="share-icons">
                                    <h5 itemprop="headline">Signe Cancer : Les astres, leur alignement et leur position pourront vous indiquer si cette personne que vous chérissez est bien faite pour vous et si la relation doit être entretenue.</h5>
                                </div>
            ...
            <div class="span6 main-content">
                ...
                <aside class="widget w-pictures">
                    <div class="widget-title">
                        <h4>Votre Compatibilité amoureuse masculine gratuite: Cancer</h4>
...
include('lib.php');
  ...
  $xml1 = read_astrologie('cancer', 'h' ,1);
 ...
 //echo $s_cle;
    ...
    if ($s_cle==='Homme Cancer - Femme Bélier')
	{
			$f1=$s_value;
  	}
	elseif ($s_cle==='Homme Cancer - Femme Taureau')
	{
			$f2=$s_value;
	}
	
	elseif ($s_cle==='Homme Cancer - Femme Gémeaux')
	{
			$f3=$s_value;
	}
	
	elseif ($s_cle==='Homme Cancer - Femme Cancer')
	{
			$f4=$s_value;
	}
	
	elseif ($s_cle==='Homme Cancer - Femme Lion')
	{
			$f5=$s_value;
	}
	
	elseif ($s_cle==='Homme Cancer - Femme Vierge')
	{
			$f6=$s_value;
	}
	
	elseif ($s_cle==='Homme Cancer - Femme Balance')
	{
			$f7=$s_value;
	}
	
	elseif ($s_cle==='Homme Cancer - Femme Scorpion')
	{
			$f8=$s_value;
	}
	
	elseif ($s_cle==='Homme Cancer - Femme Sagittaire')
	{
			$f9=$s_value;
	}
	
	elseif ($s_cle==='Homme Cancer - Femme Capricorne')
	{
			$f10=$s_value;
	}
		
	elseif ($s_cle==='Homme Cancer - Femme Verseau')
	{
			$f11=$s_value;
	}
			
	elseif ($s_cle==='Homme Cancer - Femme Poissons')
	{
			$f12=$s_value;
  ...
  ?>	
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme" data-toggle="collapse" data-parent="#accordion1"
                                                            href="#collapse1">Homme Cancer - Femme Bélier
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse2">Homme Cancer - Femme Taureau
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse3">Homme Cancer - Femme Gémeaux
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse4">Homme Cancer - Femme Cancer
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse5">Homme Cancer - Femme Lion
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse6">Homme Cancer - Femme Vierge
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse7">Homme Cancer - Femme Balance
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse8">Homme Cancer - Femme Scorpion
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse9">Homme Cancer - Femme Sagittaire
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse10">Homme Cancer - Femme Capricorne
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse11">Homme Cancer - Femme Verseau
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse12">Homme Cancer - Femme Poissons
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
