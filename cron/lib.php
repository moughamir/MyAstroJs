...
function read_numerologie($num,$type=0 /*0=>Année, 1=>amour, 2=>personnalité*/, $sexe='f'){
	...
	$text=array(0=>'numerologie_2011_num', 1=>'test_amoureux_numerologie_sexe', 2=>'personnalite_num',3=>'etapes_vie_numero');
