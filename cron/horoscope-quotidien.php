...
<td height="25" width="19"></td>
    ...
    foreach($xml1['desc'] as $s_cle => $s_value){
        if($s_cle === 'amour'){
            $s_contenu .= '
                            <td style="font-family: Arial,Helvetica,sans-serif; font-size: 12px; color: rgb(0, 0, 0); text-align: justify; padding-top: 2px;" align="left" height="80" valign="top" width="180">
                                <p>'.substr($s_value, 0, 160).'...</p>
                            </td>
                            <td height="80" width="28"></td>';
            $lien_amour = $A_SIGNE[$i];
        } elseif($s_cle === 'argent'){
            $s_contenu .= '
                            <td style="font-family: Arial,Helvetica,sans-serif; font-size: 12px; color: rgb(0, 0, 0); text-align: justify; padding-top: 2px;" align="left" height="80" valign="top" width="182">
                                <p>'.substr($s_value, 0, 160).'...</p>
                            </td>
            ...
            $s_contenu .= '
                            <td style="font-family: Arial,Helvetica,sans-serif; font-size: 12px; color: rgb(0, 0, 0); text-align: justify; padding-top: 2px;" align="left" height="80" valign="top" width="201">
                                <p>'.substr($s_value, 0, 160).'...</p>
                            </td>
                    ...
                    <tbody>
                        <tr>                   
                            <td align="left" valign="top" width="650">
                                <a href="'.PROTOCOL.'://'.ROOT_URL.'/horoscope-du-jour-'.$lien_amour.'">
                            ...
                            <td align="left" valign="top" width="650">
                                <a href="'.PROTOCOL.'://'.ROOT_URL.'/horoscope-du-jour-'.$lien_argent.'">
                            ...
                            <td align="left" valign="top" width="650">
                                <a href="'.PROTOCOL.'://'.ROOT_URL.'/horoscope-du-jour-'.$lien_travail.'">
