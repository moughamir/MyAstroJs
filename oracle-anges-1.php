...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    <head>
    <title>Oracle des Anges : votre tirage de cartes interprété | MyAstro</title>
...
<body class="oracle oracle-anges">
<div class="subbody">
    <div class="top-nav">
    ...
    <div class="main">
        <div class="left-part">
            ...
            <div class="content">
                <h1>Oracle des <strong>anges</strong></h1>
                <div class="txt-content">
                    <p>Et si les anges avaient un message pour vous ? Et si vous pouviez le connaitre sans attendre ? Avec l'Oracle des Anges de MyAstro, tirez les lames et découvrez leur signification.</p>
                    <p>Une fois votre tirage effectué, l'un de nos spécialistes vous traduira le message de ces êtes angéliques. Amour, argent, travail, famille, futur proche ou lointain, l'Oracle des Anges a forcément des réponses pour vous.</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="paquet">
                            ...
                            <div class="title">Tirez <strong>5</strong> lames</div>
                                ...
                                for ($i = 1; $i <= 21; $i++)
                                {
                                    ...
                                    echo '<img src="images_landing/carte-oracle-anges.png" class="tarot-dos tarot-' . $i . '" data-pos="' . $datapos . '"/>';
                                }
                                ?>
                                </div>
    ...
    <div class="main bottom-part" id="secondpart">
        ...
        <div class="left-bottom-part">
             <div class="comment-ca-marche">
                ...
                <img src="images_landing/oracle-anges.jpg" width="577" height="111" alt="Oracle anges"/>
            </div>
        </div>
                ...
                <aside class="widget w-adv">
                    ...
                    <div id="form-w" class="widget-content clearfix">
                        <div class="visible-part form-part form-part-one">
                            ...
                            <form id="">
                                <input type="hidden" name="source" value="myastro-oracle-a3" />
