...
$n_photo = "11";
$text_l = "J";
$text = "e suis capable de vous aider rapidement. J‘utilise plusieurs outils de prédilection, les plus connus sont la boule de voyance, le pendule ou encore les cartes et surtout les chiffres. Un voyant sérieux peut également travailler sur les énergies, je n’ai  alors besoin d’aucun support pour lire votre avenir et vous le dévoiler.";

$nom_com_1 ="missixty13";
$commentaire_1 = "bonne consultation je vous tiendrais au courant!merci!";
$date_1 ="25 Mar 2013, 15:15 PM";

$nom_com_2 ="Melindda";
$commentaire_2 = "Un grand merci pour votre analyse, ne vous excusez pas d'avoir tardé, je préfère largement que vous preniez votre temps et de l'avoir fait consciencieusement. J'espère vraiment que vos dires sont vrais, en tout cas je vais m'y accrocher, j'en ai besoin. Merci beaucoup pour le temps que vous avez pris pour moi.";
$date_2 ="10 Mar 2013, 00:25 AM";

$nom_com_3 ="Georgette";
$commentaire_3 = "Encore merci henri  de votre aide. J’avais perdu toute confiance en la vie. Chaque rencontre amoureuse était un véritable fiasco et je me croyais condamnée à rester seule. Grâce à vous, j’ai de nouveau l’espoir de construire une famille. Je viens de rencontrer un homme comme vous me l’aviez décrit. Un homme qui n’a pas peur de s’engager et comme vous me l’aviez prédit, il désire vivre avec moi. Tout se réalise enfin ! Votre voyance m’a permis de ne pas désespérer… A très bientôt. ";
$date_3 ="102 Avr 2013, 08:33 AM";
...
<!--<div class="rating"  style="text-align:right;margin-right:10px;" itemprop="reviewRating" itemscope="" itemtype="http://schema.org/Rating">
  ...
  <div style="text-align:right;margin-right:20px;margin-top:10px;">  
                                                                ...
                                                                <span style="color:#000000;font-weight:bold;font-size:13px;font-family:tahoma, verdana, arial, sans-serif;"><br>Tarifs : 6,5€/MIN SUP<br><br>NUMÉROLOGUE</span>
