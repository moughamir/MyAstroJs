      ...
      <div class="col-right">
        <div class="form-container">
          <form method="post" class="af-form-wrapper inscription_form" action="">
            <input name="source" value="voyanceParTchat-default" type="hidden">
            <input name="method" value="voyance-gratuite" type="hidden">
            <input name="site" value="voyance-par-tchat.com" type="hidden">
            <input name="affiliation" value="naturel" type="hidden">
            <input name="tel_needed" value="1" type="hidden">
            <div class="af-form">
