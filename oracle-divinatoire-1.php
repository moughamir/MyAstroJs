...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    <head>
    <title>Oracle Divinatoire : votre tirage de cartes interprété | MyAstro</title>
...
<body class="oracle oracle-divinatoire">
<div class="subbody">
    <div class="top-nav">
    ...
    <div class="main">
        <div class="left-part">
            ...
            <div class="content">
                <h1>Oracle <strong>Divinatoire</strong></h1>
                <div class="txt-content">
                    <p>Avec notre Oracle Divinatoire, trouvez dans un tirage les réponses à vos questions les plus importantes : amour, argent, famille, travail,...</p>
                    <p>Une fois vos lames révélées, un expert de l'Oracle Divinatoire vous communiquera l'interprétation de votre tirage, afin que vous sachiez clairement ce qu'il signifie pour vous.</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="paquet">
                            ...
                            <div class="title">Tirez <strong>5</strong> lames</div>
                                ...
                                for ($i = 1; $i <= 21; $i++)
                                {
                                    ...
                                    echo '<img src="images_landing/carte-oracle-divinatoire.png" class="tarot-dos tarot-' . $i . '" data-pos="' . $datapos . '"/>';
                                }
                                ?>
                                </div>
    ...
    <div class="main bottom-part" id="secondpart">
        ...
        <div class="left-bottom-part">
             <div class="comment-ca-marche">
                ...
                <img src="images_landing/oracle-divinatoire.jpg" width="577" height="111" alt="Oracle divinatoire"/>
            </div>
        </div>
                ...
                <aside class="widget w-adv">
                    ...
                    <div id="form-w" class="widget-content clearfix">
                        <div class="visible-part form-part form-part-one">
                            ...
                            <form id="">
                                <input type="hidden" name="source" value="myastro-oracle-a6" />
