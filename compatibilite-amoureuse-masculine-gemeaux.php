...
<head>
    <title>Compatibilité amoureuse masculine Gémeaux: allez-vous bien ensemble?</title>
	<meta name="description" content="Signe Gémeaux : Les astres, leur alignement et leur position pourront vous indiquer si cette personne que vous chérissez est bien faite pour vous et si la relation doit être entretenue." />
    ...
    <div class="container-fluid" itemscope >
        ...
        <div class="row-fluid">
                            ...
                            <header>
                                <div itemscope >
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li><a href="http://www.myastro.fr/astrologie-gratuite" >Astrologie gratuite</a><i class="icon-caret-right icon-fixed-width"></i><li><a href="http://www.myastro.fr/compatibilite-amoureuse-masculine" >Compatibilité amoureuse masculine</a></li></li><i class="icon-caret-right icon-fixed-width"></i><li>Compatibilité amoureuse masculine Gémeaux</li></h4>
					...
					<div class="cat-widget-title">
                            ...
                            <h1 itemprop="headline">Compatibilité amoureuse masculine Gémeaux</h1>
...
<div class="row-fluid social-share-footer">
                                ...
                                <div class="share-icons">
                                    <h5 itemprop="headline">Signe Gémeaux : Les astres, leur alignement et leur position pourront vous indiquer si cette personne que vous chérissez est bien faite pour vous et si la relation doit être entretenue.</h5>
                                </div>
            ...
            <div class="span6 main-content">
                ...
                <aside class="widget w-pictures">
                    <div class="widget-title">
                        <h4>Votre Compatibilité amoureuse masculine gratuite: Gémeaux</h4>
...
include('lib.php');
  ...
  $xml1 = read_astrologie('gemeaux', 'h' ,1);
 ...
 //echo $s_cle;
    ...
    if ($s_cle==='Homme Gémeaux - Femme Bélier')
	{
			$f1=$s_value;
  	}
	elseif ($s_cle==='Homme Gémeaux - Femme Taureau')
	{
			$f2=$s_value;
	}
	
	elseif ($s_cle==='Homme Gémeaux - Femme Gémeaux')
	{
			$f3=$s_value;
	}
	
	elseif ($s_cle==='Homme Gémeaux - Femme Cancer')
	{
			$f4=$s_value;
	}
	
	elseif ($s_cle==='Homme Gémeaux - Femme Lion')
	{
			$f5=$s_value;
	}
	
	elseif ($s_cle==='Homme Gémeaux - Femme Vierge')
	{
			$f6=$s_value;
	}
	
	elseif ($s_cle==='Homme Gémeaux - Femme Balance')
	{
			$f7=$s_value;
	}
	
	elseif ($s_cle==='Homme Gémeaux - Femme Scorpion')
	{
			$f8=$s_value;
	}
	
	elseif ($s_cle==='Homme Gémeaux - Femme Sagittaire')
	{
			$f9=$s_value;
	}
	
	elseif ($s_cle==='Homme Gémeaux - Femme Capricorne')
	{
			$f10=$s_value;
	}
		
	elseif ($s_cle==='Homme Gémeaux - Femme Verseau')
	{
			$f11=$s_value;
	}
			
	elseif ($s_cle==='Homme Gémeaux - Femme Poissons')
	{
			$f12=$s_value;
  ...
  ?>	
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme" data-toggle="collapse" data-parent="#accordion1"
                                                            href="#collapse1">Homme Gémeaux - Femme Bélier
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse2">Homme Gémeaux - Femme Taureau
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse3">Homme Gémeaux - Femme Gémeaux
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse4">Homme Gémeaux - Femme Cancer
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse5">Homme Gémeaux - Femme Lion
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse6">Homme Gémeaux - Femme Vierge
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse7">Homme Gémeaux - Femme Balance
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse8">Homme Gémeaux - Femme Scorpion
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse9">Homme Gémeaux - Femme Sagittaire
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse10">Homme Gémeaux - Femme Capricorne
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse11">Homme Gémeaux - Femme Verseau
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse12">Homme Gémeaux - Femme Poissons
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
...
elseif (isset($_SERVER['REDIRECT_URL']))
    ...
    trigger_error ('Could not get URL from $_SERVER vars');?>								   
	<iframe src="//www.facebook.com/plugins/like.php?href=<? echo $url;?>&amp;mode=annuel&amp;signe=gemeaux&amp;send=false&amp;layout=button_count&amp;width=150&amp;show_faces=false&amp;action=recommend&amp;colorscheme=light&amp;font&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:150px; height:21px;" allowtransparency="true"></iframe>
