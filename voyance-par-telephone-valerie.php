...
$voyant = "PAZMIN VALERIE";
$prenom = "Valérie";
$n_photo = "06";
$text_l = "V";
$text = "oyante numerologue, je suis une perle rare qui touche tous les domaines de la voyance. L’expérience est le mot maître de ma voyance qui vous apportera des précisions à travers des flashs précis, descriptions de personnalités, précisions temporelles par rapport aux chiffres. Je suis une Véritable experte du domaine sentimentale, je vous guiderai vers un équilibre indispensable à votre bien-être.";

$nom_com_1 ="sam502";
$commentaire_1 = "Avec ma plus grande sincérité, je confirme que Valerie est une personne avec une grandeur d'âme, une humilité et un professionnalisme sans pareil. Pas de complaisance, Valerie vous dit le bon et le moins bon Je vous tient au courant des avancées Merci ma chère Valerie, je vous embrasse très affectueusement.";
$date_1 ="2 Jui 2013, 07:22 PM";

$nom_com_2 ="lona42";
$commentaire_2 = "Merci infiniment Valerie d'avoir fait le point sur le professionnelle et le sentimental. Je reste optimiste pour le boulot. Tu as ete si precise. Je t'ai envoye un MP au sujet d'A avec une derniere question a verifier. Faut absolument que je lache prise bien entendu. L'attente n'est pas evident...faut que je puisse gerer mes sentiments surtout. Je voudrais bien pouvoir avoir une conversation avec lui en prive avant ses vacances mais je pense c'est impossible. Donc patience!:) MERCI bcoup!";
$date_2 ="30 Avr 2013, 8:38 AM";

$nom_com_3 ="losangel2013";
$commentaire_3 = "une question precise ... et votre vie detaillee ,impressionnee par tant de verités que moi seule connait ..;dés que j ai du nouveau..; je vous rappellerais ...merci et surtout ne changez pas ,votre pertinence est au summum!!!";
$date_3 ="25 Fev 2013, 11:35 PM";
                        ...
                        <div class="posts-in-widget">
                            <div class="row-fluid modern-items-list">
                                <?php 
                                    ...
                                    ?>
                                        <img src="images/bannieres/VTE2/valerie.png"  alt="VOYANCE PAR TELEPHONE">
                                    <?php
                                    } else {
                                    ?>
                                    <img src="images/bannieres/voyant-skyscraper/valerie-numerologue.jpg"  alt="VOYANCE PAR TELEPHONE">
                                    <?php
                                    }
                                ?>
...
<!--<div class="rating"  style="text-align:right;margin-right:10px;" itemprop="reviewRating" itemscope="" itemtype="http://schema.org/Rating">
  ...
  <div style="text-align:right;margin-right:20px;margin-top:10px;">  
                                                                ...
                                                                <span style="color:#000000;font-weight:bold;font-size:13px;font-family:tahoma, verdana, arial, sans-serif;"><br>Tarifs : 4,5€/MIN SUP<br><br>VOYANTE ET NUMÉROLOGUE</span>
...
.fermer:hover { background: #00d9ff; }
  ...
  <tr><td class="btn-voir-forfait"><div class="bloc-vf"><br><a href="http://www.myastro.fr/forfait-rubis"><h4>VOIR LES FORFAITS</h4></a></div></td></tr>
 </table>       
