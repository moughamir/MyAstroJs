 <section class="modern-footer">
 	<div class="container-fluid">
 		...
 		include('include/footer_reseaux_sociaux.php');
 		?>

 		<!--div class="tags-cloud">
 			<div class="f-widget-title">
 				<h4 style="font-family: 'Open Sans', OpenSansSemibold, Arial, Sans-Serif;font-weight: 600;text-align:center;color: #fff;font-size:17px !important;line-height: 27px;text-align:center;">Les Tags</h4>
 			</div>
