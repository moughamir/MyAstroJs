...
<?php require_once('include/tools.php');?>

    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="viewport" content="width=device-width" />
    <link rel="stylesheet" href="css/myastro.css" />
    <style>
        .modal p.alert {
            margin: 0;
            padding : 20px;
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu about-company">
                                        <li>
                                                    ...
                                                    <dl id="hcard-myastro" class="vcard">
                                                      <dt><a class="url fn" href="<?= PROTOCOL.'://'.ROOT_URL ?>"><?= ROOT_URL ?></a></dt>
                                                        ...
                                                        <dd>
                                                            <dl class="adr">
                                                                <dt>Lieu :</dt>
                                                                <dd><span class="locality">Lyon</span></dd>
                                                            </dl>
                                                        </dd>
                                                    ...
                                                    <div class="row-fluid">
                                                        ...
                                                        <div class="row-fluid">
                                                            <ul class="social-networks clearfix">
                                                                <li><a href="https://www.facebook.com/pages/Myastro/437290166297323" class="fb-metro-but" rel="help" data-toggle="tooltip" data-placement="top" data-original-title="facebook" ></a></li>
                                                                <li><a href="https://twitter.com/MYASTRO1" class="twitter-metro-but" rel="help" data-toggle="tooltip" data-placement="top" data-original-title="twitter" ></a></li>
                                                                <li><a href="https://plus.google.com/+MyastroFr" class="googleplus-metro-but" rel="help" data-toggle="tooltip" data-placement="top" data-original-title="googleplus" ></a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row-fluid">
                                                <div class="row-fluid title">
                                                    <span class="title-contact"><i class="bo-icon-bell bo-icon-white"></i>Termes et conditions</span>
                                                    <hr />
                                                </div>
                                                <div class="row-fluid">
