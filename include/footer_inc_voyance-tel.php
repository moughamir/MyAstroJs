   ...
   <div class="container-fluid">
    ...
    <div class="tags-cloud">
        ...
        <div class="f-widget-content" style="text-align:center;">
          ...
          <?php include('footer-voyance-tel.php'); ?>
        ...
        <div class="row-fluid">
            ...
            <nav class="span6 ">
               ...
               <ul class="copyright-links">
                 <li><a href="http://www.myastro.fr/a-propos-de-myastro" rel="nofollow">À propos de Myastro</a> - <a href="http://www.myastro.fr/politique-de-confidentialite" rel="nofollow">Politique de confidentialité</a></li>
             </ul>
         </nav>
