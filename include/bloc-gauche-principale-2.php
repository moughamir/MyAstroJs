<section class="span300">
                    ...
                    <div class="widget-title" style="text-align:center;">
                         <h4><?php if ($_SERVER['PHP_SELF'] == '/tarot-gratuit.php' || $_SERVER['PHP_SELF'] == '/tarot-oui-ou-non.php' || $_SERVER['PHP_SELF'] == '/tarot-de-marseille.php' || $_SERVER['PHP_SELF'] == '/tirage-tarot-gratuit.php' || $_SERVER['PHP_SELF'] == '/tarot-persan.php'){echo '2 - posez votre question';}else if($_SERVER['PHP_SELF'] == '/astrologie-gratuite.php'){echo 'astrologie gratuite';}else{echo 'Voyance gratuite';}?></h4>
                    </div>
                    <div id="form-w" class="widget-content clearfix" style="background-image:none;">
                        <div class="visible-part form-part">
                            ...
                            <form id="">
                                <input type="hidden" name="source" value="<?php if($_SERVER['PHP_SELF'] == '/tarot-gratuit.php'){echo 'tarot-gratuit';}else if($_SERVER['PHP_SELF'] == '/tirage-tarot-gratuit.php'){echo 'tirage-tarot-gratuit';}else if($_SERVER['PHP_SELF'] == '/tarot-oui-ou-non.php'){echo 'tarot-oui-non';}else if($_SERVER['PHP_SELF'] == '/tarot-de-marseille.php'){echo 'tarot-marseille';}else if($_SERVER['PHP_SELF'] == '/tarot-persan.php'){echo 'tarot-persan';}else if($_SERVER['PHP_SELF'] == '/astrologie-gratuite.php'){echo 'astrologie-gratuite';}else if($_SERVER['PHP_SELF'] == '/numerologie-gratuite.php'){echo 'numerologie-gratuite';}else{echo 'horoscope-gratuit';}?>"/>
                                <input type="hidden" name="method" value="form-widget" />
                                <input type="hidden" name="support" value="<?php if($_SERVER['PHP_SELF'] == '/tarot-gratuit.php'){echo 'tarot';}else{echo 'voyance';}?>"/>
                                ...
                                <div>
                                    <input class="btn_button btn-full-two" type="submit" name="valider" value="Poser votre question" <?php if ($_SERVER['PHP_SELF'] == '/tarot-gratuit.php'){echo 'disabled';}?>>
                                </div>
                            </form>
                        </div>
                        <div>
