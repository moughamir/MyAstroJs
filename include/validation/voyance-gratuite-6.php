...
$gclid            = (isset($param['gclid'])) ? $param['gclid'] : false;
  ...
  *================================================================*/
  if(in_array($choix_question,$questionConjoint)){
    ...
    $conjoint_prenom = ($param['conjoint']) ? $param['conjoint'] : '';
    $conjoint_date_naissance = ($param['conjoint_date_naissance']) ? $param['conjoint_date_naissance'] : '';
    if(!empty($conjoint_date_naissance)){
      list($conjoint_date_naissance_j , $conjoint_date_naissance_m, $conjoint_date_naissance_a) = explode('/', $conjoint_date_naissance);
