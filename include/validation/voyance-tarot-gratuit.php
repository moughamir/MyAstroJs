...
$questionConjoint = array('question_2','question_22','question_23','question_24','question_12','question_11','question_10');
$needConjoint     = false;
$msg              = array();
$question         = 'sentimentale';
$confidentielle   = "1";
$confidentielle_  = "true";
$source           = (isset($param['source'])) ? $param['source'] : 'myastro-tarot';
...
$gclid            = (isset($param['gclid'])) ? $param['gclid'] : false;
  ...
  *================================================================*/
  ...
  $email          = (isset($param['mail']))           ? trim($param['mail'])      : false;
  $date_naissance = (isset($param['date_naissance'])) ? $param['date_naissance']  : false;
  $tel            = (isset($param['phone']))          ? $param['phone']           : false;
  $pays           = (isset($param['pays']))           ? $param['pays']            : false;

  $test_prenom = trim($prenom, ' ');
  if(!$prenom || empty($test_prenom)){
  ...
  if($date_naissance){
    list($date_naissance_j , $date_naissance_m, $date_naissance_a) = explode('/', $date_naissance);
...
*================================================================*/
  ...
  $choix_question = (isset($param['question'])) ? $param['question'] : false;
  if(!$choix_question){
...
$conjointBirthDate          = (isset($param['conjointBirthDate']))            ? $param['conjointBirthDate']  : '';

if(false !== $choix_question && in_array($choix_question, $questionConjoint)){
  if(!empty($conjointBirthDate)){
      list($conjoint_date_naissance_j , $conjoint_date_naissance_m, $conjoint_date_naissance_a) = explode('/', $conjointBirthDate);
  ...
  if(empty($conjoint_prenom) || empty($test_conjoint_prenom)){
      $msg['conjoint'] = 'Veuillez remplir le prénom de l\'être aimé.<br>';
  }
  if(!empty($test_conjoint_prenom) && !preg_match("#^([a-zA-Z'àâéèêôùûçÀÂÉÈÔÙÛÇ[:blank:]-]{1,75})$#", $conjoint_prenom)){
  ...
  *================================================== */
  ...
  if(!preg_match("#(0{5,}|1{5,}|2{5,}|3{5,}|4{5,}|5{5,}|6{5,}|7{5,}|8{5,}|9{5,}|1234{1,}|(01){5,}|(02){5,}|(03){5,}|(04){5,}|(05){5,}|(06){5,}|(07){5,}|(08){5,}|(09){5,})#",$tel)){
    ...
    $msg['phone'] = "Numéro de téléphone incorrect.";
  }
  ...
  *================================================== */
  ...
  if(empty($msg)){
    ...
    $user_responses = array(
          ...
          'question'  => 'Pas de question sur formulaire tarot.' ,
          'situation' => $mind
      );
