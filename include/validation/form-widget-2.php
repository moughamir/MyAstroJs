...
$source           = isset($param['source']) ? $param['source'] : 'form-widget';
...
$gclid            = (isset($param['gclid'])) ? $param['gclid'] : false;
  ...
  *================================================================*/
  ...
  $choix_question = (isset($param['conjoint']) && !empty($param['conjoint'])) ? 'question_2' : 'question_1'; // En fonction de si le conjoint est rempli, soit amour, soit avour avec P2
  ...
  *================================================================*/
   ...
   if(!empty($conjoint_prenom)){
      $test_conjoint_prenom = trim($conjoint_prenom, ' ');
      if(empty($test_conjoint_prenom)){
        $msg['conjoint'] = 'Merci de remplir le prénom de l\'être aimé. <br />';
      }else{
          if(!preg_match("#^([a-zA-Z'àâéèêôùûçÀÂÉÈÔÙÛÇ[:blank:]-]{1,75})$#", $conjoint_prenom)){
  ...
  *================================================== */
  ...
  if(empty($msg)){
    ...
    if (!$trouve){
      $bdd->insert(
        ...
        array(
          ...
          'questionSujet'           => ( isset($question) ) ? $question : '',
          'questionContent'         => ( isset($choix_question) ) ? $choix_question : '',
          'horoscope'               => ( isset($horoscope) ) ? $horoscope : '',
    ...
    *================================================== */
    ...
    /*==================================================* 
    *          INSERTION MEMBRE DANS SMARTFOCUS         *
    *================================================== */
