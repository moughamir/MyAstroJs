...
<head>
   <title>Obtenir des réponses avec un horoscope de la semaine lion</title>
                            ...
                            <header>
                                <div itemscope >
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li><a href="horoscope-gratuit" >Horoscope gratuit</a><i class="icon-caret-right icon-fixed-width"></i><li><a href="http://www.myastro.fr/horoscope-de-la-semaine" >Horoscope de la semaine</a></li></li><i class="icon-caret-right icon-fixed-width"></i><li>Horoscope de la semaine Lion</li></span>
            ...
            <div class="span6 main-content">
               ...
               <aside class="widget w-pictures">
                    <div class="widget-title">
                        <h2 class="h4">VOTRE HOROSCOPE DE LA SEMAINE GRATUIT: Lion</h2>
               ...
               <!-- texte -->
                <div>
                    <div class="text-justify">
                        ...
                        <p>Pour les natifs du signe lion, l'horoscope est le meilleur moyen pour prévoir et planifier une semaine. Sur le plan sentimental, l'horoscope de la semaine lion s'adapte à la situation amoureuse de chaque consultant. Si vous êtes en couple, vous aurez le plaisir de découvrir les changements et rénovations qui marqueront votre vie conjugale. L'horoscope hebdomadaire vous révélera l'ambiance qui régnera au sein de votre couple et ce, pendant les sept jours à venir. </p>
                        <br/><p>Pour les célibataires, l'horoscope dévoilera les éventuelles rivalités et malentendus de la vie amoureuse. Sur la base de ces informations, vous serez en mesure de mieux vous comporter en couple et de mener les bonnes actions qui mèneront à la rencontre de l’ âme-sœur. </p>
                    </div>
                    <div class="text-justify">
