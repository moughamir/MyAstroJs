...
$voyant = "RITTOU VICTOR";
$prenom = "Victor";
$n_photo = "10";
$text_l = "L";
$text = "e suis là pour vous aider, vous éclairer et vous guider grâce à ce don qui m’accompagne depuis maintenant 25 ans. Je vous accompagnerai tout au long de votre période d’incertitude pour voir ce que nous pouvons ensemble éviter et vous fournir une véritable voyance serieuse.";
...
<br>
 ...
 <div class="row-fluid">	
            ...
            <section class="span270">
                <h2 class="hidden">Barre de centre</h2>
...
<!--<div class="rating"  style="text-align:right;margin-right:10px;" itemprop="reviewRating" itemscope="" itemtype="http://schema.org/Rating">
  ...
  <div style="text-align:right;margin-right:20px;margin-top:10px;">  
                                                                ...
                                                                <span style="color:#000000;font-weight:bold;font-size:13px;font-family:tahoma, verdana, arial, sans-serif;">Tarifs : 5,5€/MIN SUP</span>
