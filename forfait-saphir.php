...
<head>
    <title>Tarifs Forfait saphir - Myastro</title>
...
function prixForfait(offre){
    ...
    /*var prix = [260.00,500.00,710.00,900.00];*/
    var prix = 225.00;
    var detail = "Forfait 50 min SAPHIR";
...
function offreAbo(abo){
    ...
    /* les élements des 2 tableaux doivent correspondre forfait => prix(code) */
    var codes = ["AAC670090EDE9A3","A75AF2325D32972","00E7617EF5C732E"];
    var detail = ["Abonnement offre1 SAPHIR","Abonnement offre2 SAPHIR","Abonnement offre3 SAPHIR"];
...
function methodePay(mth){
    ...
    /* les élements des 2 tableaux doivent correspondre forfait => prix */
    var prix = [500.00,675.00,900.00];
    var detail = ["Forfait 100 min SAPHIR","Forfait 150 min SAPHIR","Forfait 200 min SAPHIR"];
                    ...
                    <div class="bloc-forfait-abonnement">
                        ...
                        <div class="bloc-forfait">
                            ...
                            <div class ="text-forfait">
                                ...
                                <p>Profitez de tarifs dégressifs grâce au forfait <span class="frt-name">saphir</span> avec votre voyant ! <br> Fixez vous du temps selon votre budget !
                            ...
                            <div class="forfait-name">
                                <img src="images/abonnement/saphir/saphir.png">
                            </div>
                            ...
                            <div class="tarifs-min">
                                <ul>
                                    <li><span class="txt-nb-min">&nbsp;&nbsp;50 min</span> <span class="pts-pts">............</span> 225<sup>€</sup>&nbsp;&nbsp;&nbsp;
                                        <span class="prix-ini">275<sup>€</sup></span>
                                    </li>
                                    <li ><span class="txt-nb-min">100 min</span> <span class="pts-pts">............</span> 500<sup>€</sup>&nbsp;&nbsp;&nbsp;
                                        <span class="prix-ini">550<sup>€</sup></span>
                                    </li>
                                    <li><span class="txt-nb-min">150 min</span> <span class="pts-pts">............ </span>675<sup>€</sup>&nbsp;&nbsp;&nbsp;
                                        <span class="prix-ini">825<sup>€</sup></span>
                                    </li>
                                    <li><span class="txt-nb-min">200 min</span> <span class="pts-pts">............</span> 900<sup>€</sup>&nbsp;&nbsp;&nbsp;
                                        <span class="prix-ini">1100<sup>€</sup></span>
                                    </li>
                                </ul>   
                            </div> 
                            <div class="tarifs-min btn-acheter">
                                <ul>
                                    ...
                                    <li><a href="#ouvert"><img src="images/abonnement/acheter.png" onclick="methodePay(0)"></a><span class="txt-pay"> 2x <span class="pay-nb-x">sans frais</span></span></a></li>
                        ...
                        <div class="bloc-abonnement">
                            ...
                            <div class ="text-abonnement">
                                ...
                                <p> <span class="abo-cgu">Abonnement avec un engagement sur 12 mois en profitant de tarifs exceptionnels:<br>
                                    Abonnement mensuel d'une durée d'un an avec un voyant de la gamme <span class="frt-name">saphir</span> de votre choix.</span></p>
                            </div>
                            <div class ="offres offre1 " ><img src="images/abonnement/saphir/saphir-offre1.png"><a href="#ouvert" onclick="offreAbo(0)"><img class="btn-cmd" src="images/abonnement/commander.png"></a>
                            </div>
                            <div class ="offres offre2 " ><a href="#ouvert" onclick="offreAbo(1)"><img class="btn-cmd" src="images/abonnement/commander.png"></a><img src="images/abonnement/saphir/saphir-offre2.png">
                            </div>
                            <div class ="offres offre3 " ><img src="images/abonnement/saphir/saphir-offre3.png"><a href="#ouvert" onclick="offreAbo(2)"><img class="btn-cmd" src="images/abonnement/commander.png"></a>
                            </div>
                        </div>
                    <div>
