...
<head>
    <title>Compatibilité amoureuse féminine Cancer: êtes vous faits l'un pour l'autre?</title>
	<meta name="description" content="Signe Cancer :Myastro vous permet de savoir si cette personne que vous affectionnez tant est faite pour vous. Les astres vous le diront et vous pourrez ensuite prendre votre décision." />
    ...
    <div class="container-fluid" itemscope >
        ...
        <div class="row-fluid">
                            ...
                            <header>
                                <div itemscope >
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li><a href="http://<?= ROOT_URL ?>/astrologie-gratuite" >Astrologie gratuite</a><i class="icon-caret-right icon-fixed-width"></i><li><a href="http://<?= ROOT_URL ?>/compatibilite-amoureuse-feminine" >Compatibilité amoureuse féminine</a></li></li><i class="icon-caret-right icon-fixed-width"></i><li>Compatibilité amoureuse féminine Cancer</li></h4>
					...
					<div class="cat-widget-title">
                            ...
                            <h1 itemprop="headline">Compatibilité amoureuse féminine Cancer</h1>
...
<div class="row-fluid social-share-footer">
                                ...
                                <div class="share-icons">
                                    <h5 itemprop="headline">Signe Cancer :Myastro vous permet de savoir si cette personne que vous affectionnez tant est faite pour vous. Les astres vous le diront et vous pourrez ensuite prendre votre décision.</h5>
                                </div>
            ...
            <div class="span6 main-content">
                ...
                <aside class="widget w-pictures">
                    <div class="widget-title">
                        <h4>Votre Compatibilité amoureuse féminine gratuite: Cancer</h4>
...
include('lib.php');
  ...
  $xml1 = read_astrologie('cancer', 'f' ,1);
 ...
 //echo $s_cle;
    ...
    if ($s_cle==='Femme Cancer - Homme Bélier')
	{
			$f1=$s_value;
  	}
	elseif ($s_cle==='Femme Cancer - Homme Taureau')
	{
			$f2=$s_value;
	}
	
	elseif ($s_cle==='Femme Cancer - Homme Gémeaux')
	{
			$f3=$s_value;
	}
	
	elseif ($s_cle==='Femme Cancer - Homme Cancer')
	{
			$f4=$s_value;
	}
	
	elseif ($s_cle==='Femme Cancer - Homme Lion')
	{
			$f5=$s_value;
	}
	
	elseif ($s_cle==='Femme Cancer - Homme Vierge')
	{
			$f6=$s_value;
	}
	
	elseif ($s_cle==='Femme Cancer - Homme Balance')
	{
			$f7=$s_value;
	}
	
	elseif ($s_cle==='Femme Cancer - Homme Scorpion')
	{
			$f8=$s_value;
	}
	
	elseif ($s_cle==='Femme Cancer - Homme Sagittaire')
	{
			$f9=$s_value;
	}
	
	elseif ($s_cle==='Femme Cancer - Homme Capricorne')
	{
			$f10=$s_value;
	}
		
	elseif ($s_cle==='Femme Cancer - Homme Verseau')
	{
			$f11=$s_value;
	}
			
	elseif ($s_cle==='Femme Cancer - Homme Poissons')
	{
			$f12=$s_value;
  ...
  ?>	
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme" data-toggle="collapse" data-parent="#accordion1"
                                                            href="#collapse1">Femme Cancer - Homme Bélier
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse2">Femme Cancer - Homme Taureau
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse3">Femme Cancer - Homme Gémeaux
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse4">Femme Cancer - Homme Cancer
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse5">Femme Cancer - Homme Lion
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse6">Femme Cancer - Homme Vierge
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse7">Femme Cancer - Homme Balance
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse8">Femme Cancer - Homme Scorpion
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse9">Femme Cancer - Homme Sagittaire
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse10">Femme Cancer - Homme Capricorne
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse11">Femme Cancer - Homme Verseau
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse12">Femme Cancer - Homme Poissons
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
