                            ...
                            <header>
                                <div itemscope >
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li><a href="<?= PROTOCOL.'://'.ROOT_URL ?>/astrologie-gratuite" >Astrologie gratuite</a><i class="icon-caret-right icon-fixed-width"></i><li><a href="<?= PROTOCOL.'://'.ROOT_URL ?>/portrait-astrologique-feminin" >Portrait astrologique féminin</a></li></li><i class="icon-caret-right icon-fixed-width"></i><li>Portrait astrologique féminin Capricorne</li></h4>
