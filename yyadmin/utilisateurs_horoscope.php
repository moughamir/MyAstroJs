...
?>
			...
			<span>&raquo;</span>
			<a href="<?= PROTOCOL.'://'.ROOT_URL ?>/yyadmin/utilisateurs_horoscope.php">Utilisateurs Horoscope</a>
			</div>
...
ORDER BY `ag_users`.`internal_id`";
		...
		for($i=1; $i<=$nb_page; $i++)
		{
			$indexation2 .= '<a href="<?= PROTOCOL.'://'.ROOT_URL ?>/yyadmin/utilisateurs_horoscope.php?page='.$i.'">'.$i.'</a> ';
		}
		...
		{
			$indexation .= '
			<a href="<?= PROTOCOL.'://'.ROOT_URL ?>/yyadmin/utilisateurs_horoscope.php?page=1">D&eacute;but</a>
			<a href="<?= PROTOCOL.'://'.ROOT_URL ?>/yyadmin/utilisateurs_horoscope.php?page='.$page_moins.'">Pr&eacute;c&eacute;dent</a>';
		}
		...
		{ 
			$indexation .= '			
			<a href="<?= PROTOCOL.'://'.ROOT_URL ?>/yyadmin/utilisateurs_horoscope.php?page='.$page_plus.'">Suivant</a>
			<a href="<?= PROTOCOL.'://'.ROOT_URL ?>/yyadmin/utilisateurs_horoscope.php?page='.$nb_page.'">Fin</a>';
		}			
