...
<h2>Historique</h2>
    ...
    <ul class="list-group">
            ...
            <li class="list-group-item">SmartFocus.class.php : <a href="http://www.myastro.fr/yyadmin/documentation-smartfocus.php"> voir ici </a></li>
    </ul>
...
<h2>Base de données</h2>
    ...
    <p>A mon arrivée, cette interface ne possédait que des pages <a href="http://www.myastro.fr/yyadmin/nouveaux.php">comme celle-ci</a>, et ne servait qu'a connaitre les inscrits et MAJ utilisateur. De plus elle ne possédait qu'un seul utilisateur inscrit en dur dans la page login.php</p>
    ...
    <p>Tous les lundis matin, il faut générer le rapport de statistiques. Pour cela il faut : <br />
        ...
        - Enfin : jouer le script <a href="http://www.myastro.fr/yyadmin/stats-hebdo.php">http://www.myastro.fr/yyadmin/stats-hebdo.php</a></p>
    <h3>Git</h3>
    ...
    <h3>Dit</h3>
    <p>J'avais attaqué une refonte durant mon temps libre sur une <a href="http://www.myastro.fr/images/flat.jpg">maquette que j'avais faite</a> sur l'url <a href="http://dit.myastro.fr">dit.myastro.fr</a>. La base technique est un <a href="doc.thelia.net">thélia 2.</a></p>
<?php
