...
<div id="fil">
			...
			<span>»</span>
			<a href="<?= PROTOCOL.'://'.ROOT_URL ?>/yyadmin/nouveaux.php">Liste des nouveaux utilisateurs</a>
...
ORDER BY `ag_users`.`questionDate`";
	...
	while($row1 = mysql_fetch_array($result1))
		...
		{
			if ($i == $pagerech)
			$indexation2 .= '<a href="<?= PROTOCOL.'://'.ROOT_URL ?>/yyadmin/nouveaux.php?page='.$i.'&rech='.$recherche.'"><font style="color:red;" >'.$i.'</font></a> '; else
			$indexation2 .= '<a href="<?= PROTOCOL.'://'.ROOT_URL ?>/yyadmin/nouveaux.php?page='.$i.'">'.$i.'</a> '; 
		}
		...
		{
			$indexation .= '
			<a href="<?= PROTOCOL.'://'.ROOT_URL ?>/yyadmin/nouveaux.php?page=1">D&eacute;but</a>
			<a href="<?= PROTOCOL.'://'.ROOT_URL ?>/yyadmin/nouveaux.php?page='.$page_moins.'">Pr&eacute;c&eacute;dent</a>';
		}
		...
		{ 
			$indexation .= '			
			<a href="<?= PROTOCOL.'://'.ROOT_URL ?>/yyadmin/nouveaux.php?page='.$page_plus.'">Suivant</a>
			<a href="<?= PROTOCOL.'://'.ROOT_URL ?>/yyadmin/nouveaux.php?page='.$nb_page.'">Fin</a>
			<a href="<?= PROTOCOL.'://'.ROOT_URL ?>/yyadmin/excel_page_new.php?fp='.$page.'">Excel</a>';
		}			
