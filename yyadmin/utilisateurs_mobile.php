...
?>
			...
			<span>&raquo;</span>
			<a href="http://www.myastro.fr/yyadmin/utilisateurs_mobile.php">Utilisateurs Mobile</a>
			</div>
...
ORDER BY `ag_users`.`internal_id`";
		...
		for($i=1; $i<=$nb_page; $i++)
		{
			$indexation2 .= '<a href="http://www.myastro.fr/yyadmin/utilisateurs_mobile.php?page='.$i.'">'.$i.'</a> ';
		}
		...
		{
			$indexation .= '
			<a href="http://www.myastro.fr/yyadmin/utilisateurs_mobile.php?page=1">D&eacute;but</a>
			<a href="http://www.myastro.fr/yyadmin/utilisateurs_mobile.php?page='.$page_moins.'">Pr&eacute;c&eacute;dent</a>';
		}
		...
		{ 
			$indexation .= '			
			<a href="http://www.myastro.fr/yyadmin/utilisateurs_mobile.php?page='.$page_plus.'">Suivant</a>
			<a href="http://www.myastro.fr/yyadmin/utilisateurs_mobile.php?page='.$nb_page.'">Fin</a>';
		}			
