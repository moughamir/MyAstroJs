                            ...
                            <header>
                                <div itemscope >
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li><a href="<?= PROTOCOL.'://'.ROOT_URL ?>/astrologie-gratuite" >Astrologie gratuite</a><i class="icon-caret-right icon-fixed-width"></i><li><a href="<?= PROTOCOL.'://'.ROOT_URL ?>/portrait-astrologique-feminin" >Portrait astrologique féminin</a></li></li><i class="icon-caret-right icon-fixed-width"></i><li>Portrait astrologique féminin Gémeaux</li></h4>
...
<div class="row-fluid social-share-footer">
                                ...
                                <div class="share-icons">
                                    <p itemprop="headline">Signe Gémeaux : Grâce à Myastro, définissez avec précision votre profil astrologique et tirez-en les conclusions qui s'imposent. Prenez ensuite les bonnes décisions en toute tranquilité.</p>
                                </div>
