...
<head>
    <title>Portrait astrologique féminin Gémeaux: thème astrologique avec Myastro</title>
    ...
    <div class="container-fluid" itemscope >
        ...
        <div class="row-fluid">
                            ...
                            <header>
                                <div itemscope >
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li><a href="http://www.myastro.fr/astrologie-gratuite" >Astrologie gratuite</a><i class="icon-caret-right icon-fixed-width"></i><li><a href="http://www.myastro.fr/portrait-astrologique-feminin" >Portrait astrologique féminin</a></li></li><i class="icon-caret-right icon-fixed-width"></i><li>Portrait astrologique féminin Gémeaux</li></h4>
					...
					<div class="cat-widget-title">
                            ...
                            <h1 itemprop="headline">Portrait astrologique féminin Gémeaux</h1>
            ...
            <div class="span6 main-content">
                ...
                <aside class="widget w-pictures">
                    <div class="widget-title">
                        <h4>Votre Portrait astrologique féminin gratuit: Gémeaux</h4>
...
include('lib.php');
  ...
  $xml1 = read_astrologie('gemeaux', 'f' ,0);
