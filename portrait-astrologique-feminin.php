        ...
        <div class="span6 main-content">
          ...
          <aside class="widget w-pictures">
            ...
            <div class="widget-content clearfix thumbnails">
              <?php echo getHoroscopeBlock("portrait-femme") ?>
            </div>
          </aside>
          ...
          <aside class="widget w-adv">
            ...
            <form method="POST" action="signe.php?cat=portrait-astrologique-feminin" >
                              ...
                              <article class="fold-item span12">
                                <div class="clearfix">
                                  ...
                                  <div class="description visible-part">
                                    ...
                                    <br>
                                    <h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Que vous réserve l’année 2016? Amour, bonheur, argent, travail, changements? N’attendez plus pour prendre connaissance de ce que prévoient les planètes pour votre signe astrologique avec l’horoscope 2016 gratuit MyAstro !</h6>
