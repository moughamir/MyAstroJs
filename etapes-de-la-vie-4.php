...
<head>
    <title>Votre étapes de la vie, chiffre 4: Myastro</title>
	<meta name="description" content="Chiffre 4 : Grâce aux conseils de Myastro, vous pourrez facilement surmonter toutes les étapes de votre vie au moyen des conseils qui vous sont donnés après une étude de votre numérologie." />
                            ...
                            <header>
                                <div itemscope >
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li><a href="http://www.myastro.fr/etapes-de-la-vie" >Étapes de la vie</a></li><i class="icon-caret-right icon-fixed-width"></i></li>
                                        <li>Étapes de la vie chiffre 4</h4></li>
                                    </ul>
                                </div>
					<div class="cat-widget-title">
                        
                            <h1 itemprop="headline">Étapes de la vie chiffre 4</h1>
...
<div class="row-fluid social-share-footer">
                                ...
                                <div class="share-icons">
                                    <h5 itemprop="headline">Chiffre 4 : Grâce aux conseils de Myastro, vous pourrez facilement surmonter toutes les étapes de votre vie au moyen des conseils qui vous sont donnés après une étude de votre numérologie.</h5>
                                </div>
            ...
            <div class="span6 main-content">
                ...
                <aside class="widget w-pictures">
                    <div class="widget-title">
                        <h4>Votre Étapes de la vie gratuite: chiffre 4</h4>
...
//echo $s_cle;
	...
	{
			$f2=$s_value;
			$f2=preg_replace('@<center[^>]*?>.*?</center>@si', '', $f2);
	}
	...
	{
			$f4=$s_value;
			$f4=preg_replace('@<center[^>]*?>.*?</center>@si', '', $f4);
	}
