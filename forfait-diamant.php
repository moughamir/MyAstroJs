...
<head>
    <title>Tarifs Forfait diamant - Myastro</title>
...
function prixForfait(){
    ...
    var prix = 150.00;
    var detail = "Forfait 50 min DIAMANT";
...
function offreAbo(abo){
    ...
    var codes = ["E2DDACB2E4E31BA","9CDC2E79F443DC8","AE197B9AE59F482"];
    var detail = ["Abonnement offre1 DIAMANT","Abonnement offre2 DIAMANT","Abonnement offre3 DIAMANT"];
...
function methodePay(mth){
    ...
    /* les élements des 2 tableaux doivent correspondre forfait => prix */
    var prix = [300.00,375.00,500.00];
    var detail = ["Forfait 100 min DIAMANT","Forfait 150 min DIAMANT","Forfait 200 min DIAMANT"];
                    ...
                    <div class="bloc-forfait-abonnement">
                        ...
                        <div class="bloc-forfait">
                            ...
                            <div class ="text-forfait">
                                ...
                                <p>Profitez de tarifs dégressifs grâce au forfait <span class="frt-name">diamant</span> avec votre voyant ! <br> Fixez vous du temps selon votre budget !
                            ...
                            <div class="forfait-name">
                                <img src="images/abonnement/diamant/diamant.png">
                            </div>
                            ...
                            <div class="tarifs-min">
                                <ul>
                                    <li><span class="txt-nb-min">&nbsp;&nbsp;50 min</span> <span class="pts-pts">............</span> 150<sup>€</sup>&nbsp;&nbsp;&nbsp;
                                        <span class="prix-ini">175<sup>€</sup></span>
                                    </li>
                                    <li ><span class="txt-nb-min">100 min</span> <span class="pts-pts">............</span> 300<sup>€</sup>&nbsp;&nbsp;&nbsp;
                                        <span class="prix-ini">350<sup>€</sup></span>
                                    </li>
                                    <li><span class="txt-nb-min">150 min</span> <span class="pts-pts">............ </span>375<sup>€</sup>&nbsp;&nbsp;&nbsp;
                                        <span class="prix-ini">525<sup>€</sup></span>
                                    </li>
                                    <li><span class="txt-nb-min">200 min</span> <span class="pts-pts">............</span> 500<sup>€</sup>&nbsp;&nbsp;&nbsp;
                                        <span class="prix-ini">700<sup>€</sup></span>
                                    </li>
                                </ul>   
                            </div> 
                        ...
                        <div class="bloc-abonnement">
                            ...
                            <div class ="text-abonnement">
                                ...
                                <p> <span class="abo-cgu">Abonnement avec un engagement sur 12 mois en profitant de tarifs exceptionnels:<br>
                                    Abonnement mensuel d'une durée d'un an avec un voyant de la gamme <span class="frt-name">diamant</span> de votre choix.</span></p>
                            </div>
                            <div class ="offres offre1"><img src="images/abonnement/diamant/diamant-offre1.png"><a href="#ouvert" onclick="offreAbo(0)"><img class="btn-cmd" src="images/abonnement/commander.png"></a>
                            </div>
                            <div class ="offres offre2"><a href="#ouvert" onclick="offreAbo(1)"><img class="btn-cmd" src="images/abonnement/commander.png"></a><img src="images/abonnement/diamant/diamant-offre2.png">
                            </div>
                            <div class ="offres offre3"><img src="images/abonnement/diamant/diamant-offre3.png"><a href="#ouvert" onclick="offreAbo(2)"><img class="btn-cmd" src="images/abonnement/commander.png"></a>
                            </div>
                        </div>
                    <div>
