	...
	<body class="no-js" id="gvApp">
		<div class="loading">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" id="zodiac" class="colorized" xmlns:xlink="http://www.w3.org/1999/xlink">
				<defs>
					<symbol viewBox="0 0 32 32" id="bel" class="symbol Bélier fire cardinal" data-ldate="03-21" data-ndate="04-18">
					...
					<symbol viewBox="0 0 32 32" id="tau" class="symbol Taureau earth fixe" data-ldate="04-20" data-ndate="05-13">
					...
					<symbol viewBox="0 0 32 32" id="gem" class="symbol Gémeaux air mutable" data-ldate="05-21" data-ndate="06-21">
					...
					<symbol viewBox="0 0 32 32" id="can" class="symbol Cancer water cardinal" data-ldate="06-21" data-ndate="07-20">
					...
					<symbol viewBox="0 0 32 32" id="lio" class="symbol Lion fire fixe" data-ldate="07-23" data-ndate="08-10">
					...
					<symbol viewBox="0 0 32 32" id="vie" class="symbol Vierge earth mutable" data-ldate="08-23" data-ndate="09-16">
					...
					<symbol viewBox="0 0 32 32" id="bal" class="symbol Balance air cardinal" data-ldate="09-23" data-ndate="10-30">
					...
					<symbol viewBox="0 0 32 32" id="sco" class="symbol Scorpion water fixe" data-ldate="10-23" data-ndate="11-20">
					...
					<symbol viewBox="0 0 32 32" id="sag" class="symbol Sagittaire fire mutable" data-ldate="11-22" data-ndate="12-18">
					...
					<symbol viewBox="0 0 32 32" id="cap" class="symbol Capricorne earth cardinal" data-ldate="12-22" data-ndate="01-20">
					...
					<symbol viewBox="0 0 32 32" id="ver" class="symbol Verseau air fixe" data-ldate="01-20" data-ndate="02-16">
					...
					<symbol viewBox="0 0 32 32" id="poi" class="symbol Poisson water mutable" data-ldate="02-19" data-ndate="03-11">
				...
				<g class="arcs" transform="translate(256,256)">
					<a xlink:href="/gv-wdt?p=bel<?=count($parms) ? "&".join('&', $parms) : ""?>">
					...
					<a xlink:href="/gv-wdt?p=tau<?=count($parms) ? "&".join('&', $parms) : ""?>">
					...
					<a xlink:href="/gv-wdt?p=gem<?=count($parms) ? "&".join('&', $parms) : ""?>">
					...
					<a xlink:href="/gv-wdt?p=can<?=count($parms) ? "&".join('&', $parms) : ""?>">
					...
					<a xlink:href="/gv-wdt?p=lio<?=count($parms) ? "&".join('&', $parms) : ""?>">
					...
					<a xlink:href="/gv-wdt?p=vie<?=count($parms) ? "&".join('&', $parms) : ""?>">
					...
					<a xlink:href="/gv-wdt?p=bal<?=count($parms) ? "&".join('&', $parms) : ""?>">
					...
					<a xlink:href="/gv-wdt?p=sco<?=count($parms) ? "&".join('&', $parms) : ""?>">
					...
					<a xlink:href="/gv-wdt?p=sag<?=count($parms) ? "&".join('&', $parms) : ""?>">
					...
					<a xlink:href="/gv-wdt?p=cap<?=count($parms) ? "&".join('&', $parms) : ""?>">
					...
					<a xlink:href="/gv-wdt?p=ver<?=count($parms) ? "&".join('&', $parms) : ""?>">
					...
					<a xlink:href="/gv-wdt?p=poi<?=count($parms) ? "&".join('&', $parms) : ""?>">
				...
				<g class="signs" transform="translate(256,256)">
					<g class="sign Bélier" transform="rotate(-90, 0, 0)">
						<use xlink:href="#bel" width="32px" height="32px" fill="#fff" transform="translate(235 42) rotate(90, 0, 0)"></use>
					</g>
					<g class="sign Taureau" transform="rotate(-90, 0, 0)">
						<use xlink:href="#tau" width="32px" height="32px" fill="#fff" transform="translate(176 144) rotate(90, 0, 0)"></use>
					</g>
					<g class="sign Gémeaux" transform="rotate(-90, 0, 0)">
						<use xlink:href="#gem" width="32px" height="32px" fill="#fff" transform="translate(74 203) rotate(90, 0, 0)"></use>
					</g>
					<g class="sign Cancer" transform="rotate(-90, 0, 0)">
						<use xlink:href="#can" width="32px" height="32px" fill="#fff" transform="translate(-42 203) rotate(90, 0, 0)"></use>
					</g>
					<g class="sign Lion" transform="rotate(-90, 0, 0)">
						<use xlink:href="#lio" width="32px" height="32px" fill="#fff" transform="translate(-144 144) rotate(90, 0, 0)"></use>
					</g>
					<g class="sign Vierge" transform="rotate(-90, 0, 0)">
						<use xlink:href="#vie" width="32px" height="32px" fill="#fff" transform="translate(-203 42) rotate(90, 0, 0)"></use>
					</g>
					<g class="sign Balance" transform="rotate(-90, 0, 0)">
						<use xlink:href="#bal" width="32px" height="32px" fill="#fff" transform="translate(-203 -74) rotate(90, 0, 0)"></use>
					</g>
					<g class="sign Scorpion" transform="rotate(-90, 0, 0)">
						<use xlink:href="#sco" width="32px" height="32px" fill="#fff" transform="translate(-144 -176) rotate(90, 0, 0)"></use>
					</g>
					<g class="sign Sagittaire" transform="rotate(-90, 0, 0)">
						<use xlink:href="#sag" width="32px" height="32px" fill="#fff" transform="translate(-42 -235) rotate(90, 0, 0)"></use>
					</g>
					<g class="sign Capricorne" transform="rotate(-90, 0, 0)">
						<use xlink:href="#cap" width="32px" height="32px" fill="#fff" transform="translate(74 -235) rotate(90, 0, 0)"></use>
					</g>
					<g class="sign Verseau" transform="rotate(-90, 0, 0)">
						<use xlink:href="#ver" width="32px" height="32px" fill="#fff" transform="translate(176 -176) rotate(90, 0, 0)"></use>
					</g>
					<g class="sign Poisson" transform="rotate(-90, 0, 0)">
						<use xlink:href="#poi" width="32px" height="32px" fill="#fff" transform="translate(235 -74) rotate(90, 0, 0)"></use>
					</g>
				</g>
			</svg>
		</div>
		<nav>
			<ul>
				<li><a href="/gv-wdt?p=bel<?=count($parms) ? "&".join('&', $parms) : ""?>" class="signe-bel">Bélier</a></li>
				<li><a href="/gv-wdt?p=tau<?=count($parms) ? "&".join('&', $parms) : ""?>" class="signe-tau">Taureau</a></li>
				<li><a href="/gv-wdt?p=gem<?=count($parms) ? "&".join('&', $parms) : ""?>" class="signe-gem">Gémeaux</a></li>
				<li><a href="/gv-wdt?p=can<?=count($parms) ? "&".join('&', $parms) : ""?>" class="signe-can">Cancer</a></li>
				<li><a href="/gv-wdt?p=lio<?=count($parms) ? "&".join('&', $parms) : ""?>" class="signe-lio">Lion</a></li>
				<li><a href="/gv-wdt?p=vie<?=count($parms) ? "&".join('&', $parms) : ""?>" class="signe-vie">Vierge</a></li>
				<li><a href="/gv-wdt?p=bal<?=count($parms) ? "&".join('&', $parms) : ""?>" class="signe-bal">Balance</a></li>
				<li><a href="/gv-wdt?p=sco<?=count($parms) ? "&".join('&', $parms) : ""?>" class="signe-sco">Scorpion</a></li>
				<li><a href="/gv-wdt?p=sag<?=count($parms) ? "&".join('&', $parms) : ""?>" class="signe-sag">Sagittaire</a></li>
				<li><a href="/gv-wdt?p=cap<?=count($parms) ? "&".join('&', $parms) : ""?>" class="signe-cap">Capricorne</a></li>
				<li><a href="/gv-wdt?p=ver<?=count($parms) ? "&".join('&', $parms) : ""?>" class="signe-ver">Verseau</a></li>
				<li><a href="/gv-wdt?p=poi<?=count($parms) ? "&".join('&', $parms) : ""?>" class="signe-poi">Poissons</a></li>
			</ul>
		</nav>
