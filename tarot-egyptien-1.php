...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    <head>
    <title>Tarot égyptien : 5 lames pour révéler votre avenir | MyAstro</title>
...
<div class="subbody">
    ...
    <div class="main">
        <div class="left-part">
            ...
            <div class="content">
                <h1>Tarot <strong>Egyptien</strong></h1>
                <div class="txt-content">
                    <p>Avec notre tarot égyptien en ligne, tirez les lames et découvrez votre avenir en toute simplicité. Si vous avez des questions sur votre destin, un tirage vous permettra de trouver les réponses.</p>
                    <p>Une fois vos 5 lames tirées, l'un de nos tarologues experts en divination vous livrera son interprétation, afin que vous puissiez mettre un sens sur les figures révélées.</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="paquet">
                            ...
                            <div class="title">Tirez <strong>5</strong> lames</div>
                                ...
                                for ($i = 1; $i <= 21; $i++)
                                {
                                    ...
                                    echo '<img src="images_landing/carte-egyptien.png" class="tarot-dos tarot-' . $i . '" data-pos="' . $datapos . '"/>';
                                }
                                ?>
                                </div>
    ...
    <div class="main bottom-part" id="secondpart">
        ...
        <div class="left-bottom-part">
             <div class="comment-ca-marche">
                ...
                <img src="images_landing/tarot-egyptien.jpg" width="577" height="111" alt="Tarot egyptien"/>
            </div>
        </div>
                ...
                <aside class="widget w-adv">
                    ...
                    <div id="form-w" class="widget-content clearfix">
                        <div class="visible-part form-part form-part-one">
                            ...
                            <form id="">
                                <input type="hidden" name="source" value="myastro-tarot-a8" />
       ...
       <script src="js/jquery-1.11.js"></script>
        <script src="js/voyance-tarot-egyptien.js"></script>
