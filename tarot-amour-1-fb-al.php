<?php
/**
 * tarot-amour-1-fb-al == FACEBOOK ADDS
 * ------------------------------------
 * Created on : 07 avril 2017 By Laurène Dourdin <2aurene@gmail.com>
 */
// Paramètres design
$button = 'Accéder au tchat';
$assets = 'images_landing/tarot-amour/';
// Paramètre formulaire
$url = 'tarot-amour-1-fb-al';
            ...
            <div class="PageWrapper">
                <div class="ContentBand-Column WidgetBand-DescText">
                    <header class="ContentBand-ColumnHeader">
                        ...
                        <h1 class="DescText-Title">Tarot de <strong>lʼamour</strong></h1>
                    </header>
