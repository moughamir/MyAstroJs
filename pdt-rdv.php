          ...
          <aside id="main_container" class="widget">
            <div id="form_pdt">
              <div class="main-content">
                <div> <img class="img-euro" src="<?= $assets;?>/euroffre.png">
                  <ul class="icon-liste">
                    <li class="icon-cray"> <span>Je remplis le formulaire</span> </li>
                    <li class="icon-hand"> <span>Je choisis mon RDV</span> </li>
                    <li class="icon-screen"> <span>Je réserve en ligne</span> </li>
                    <li class="icon-payment"> <span> Le paiement est sécurisé</span> </li>
                  </ul>
                </div>
                <div class="appForm">
                  <form class="ajax">
                    <fieldset>
                      <h2 class="fs-title"> Informations personnelles!</h2> <input type="hidden" name="site" value="MyAstro" /> <input type="hidden" name="source" value="<?= $pageName;?>" /> <input type="hidden" name="method" value="client_web" /> <input type="hidden" name="support"
                        value="rdv-web" /> <input type="hidden" name="affiliation" value="<?= $source;?>" /> <input type="hidden" name="dri" value="consultation_web" /> <input type="hidden" name="redirect_method" value="reload_form" /> <input type="hidden"
                        name="convertir" value="1" /> <input type="hidden" name="tel_needed" value="1" /> <input type="hidden" name="cguv" value="1" /> <input type="hidden" name="partenaires" value="1" /> <input type="hidden" name="gclid" value="<?= $gclid;?>"
                      /> <input type="hidden" name="pays" value="FR" /> <input type="hidden" name="question_code" value="rdv_web" />
                      <div class="FormField radio">
                        <div class="FormField-TableInputContainer fixed-2-col gender">
                          <div class="FormField-TableInputContainer-Cell"> <label for="sexe-f" class="FormField-Label "><span
                                                          class="ico-woman"></span>
                                                  une femme</label> <input type="radio" name="sexe" value="femme" id="sexe-f" class="FormField-Input" /> </div>
                          <div class="FormField-TableInputContainer-Cell"> <label for="sexe-h" class="FormField-Label"><span
                                                          class="ico-man"></span>
                      ...
                      <div class="FormField FormField-mg">
                        ...
                        <div class="FormField-TableInputContainer-Cell"> <label for="tel" class="FormField-Label">Téléphone</label> <input type="tel" id="tel" name="tel" placeholder="Mon téléphone" class="FormField-Input" required/> </div>
                      </div> <button name="next" class="submit action-button" value="Next" type="submit">
                                      Suivant
                                  </button> <button name="next" class="next action-button" value="Next" type="button" style="display: none">
                                      Suivant
                                  </button> </fieldset>
                  </form>
                  <form class="ajax" id="rdv_form">
                    ...
                    <strong class="euro-min">1€ les 10 premières minutes</strong>
                      ...
                      <h3 class="fs-subtitle"></h3> <label for="name" class="FormField-Label carte_name">Nom du propriétaire de la
                                      carte</label>
                      ...
                      <div class="FormField-TableInputContainer FormField-mg ">
                        <div class="FormField-TableInputContainer-Cell"> <label for="name" class="FormField-Label">Cryptogramme de
                                              sécurité </label> <input type="text" id="crypto" name="crypto" class="FormField-Input" required/> <img class="img-crypto" src="../images_landing/rdv/crypto.png"> </div>
                        <div class="FormField-TableInputContainer-Cell">
                      ...
                      </div> <input type="button" name="previous" class="previousSecond action-button" value="Précédent" /> <input type="submit" name="submit" id="valider" class="submit action-button" value="Valider" /> </fieldset>
                  </form>
                </div>
              </div>
            </div>
