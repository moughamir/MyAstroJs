...
$voyant = "JULLIARD CHRISTOPHE";
$prenom = "Christophe";
$n_photo = "03";
$text_l = "A";
$text = "strologue professionnel, je  vous éclaire grâce à mon talent aussi étonnant que mystérieux. Je fais notamment appel à de nombreux outils pour atteindre des précisions, qui vous permettront de prendre des décisions pour votre avenir.";

$nom_com_1 ="legumefleur";
$commentaire_1 = "chose curieuse la situation s est empiree; il faudra ouvrir et tout nettoyer ce qui necessitera quelques jours de repos; je suis en permission une journee; je vous rappelerai pour revoir cela";
$date_1 ="15 Mai 2013, 09:29 PM";

$nom_com_2 ="aaxel2";
$commentaire_2 = "Merci pour cette consultation précise. Vous me dites que c'est bloqué pour l'instant mais que c'est possible. Je comprends pourquoi c'est bloqué car elle est en relation et je pense que c'est compliqué. Mais j'ai envie d'y croire car il y a eu un rapprochement á un moment. Mais depuis quelques temps elle est plus froide. Et tant qu'elle sera en relation il est vrai qu'elle ne bougera pas. Je reste quand même important pour elle. Merci pour votre travail sérieux.";
$date_2 ="25 Avr 2013, 3:08 AM";

$nom_com_3 ="liloudrop";
$commentaire_3 = "MERCI POUR VOTRE VOYANCE CLAIRE ET VOTRE SOUTIEN";
$date_3 ="29 Jan 2013, 05:50 AM";
...
<br>
 ...
 <aside class="widget w-posts">
                    ...
                    <div class="widget-content clearfix">
                        <div class="posts-in-widget">
                            <div class="row-fluid modern-items-list">
                                ...
                                <img src="images/bannieres/voyant-skyscraper/christophe-medium-voyant.jpg"  alt="VOYANCE PAR TELEPHONE">
                            </div>
                        </div>
                    </div>
                </aside>
  ...
  <tr>
	...
	<td><div style="text-align:left;"><br><a href="#ouvert"><img style="margin-left:25px;width: 200px;" src="images_voyance/rappele.png" ></a><br></div></td>
    <td> 
...
<!--<div class="rating"  style="text-align:right;margin-right:10px;" itemprop="reviewRating" itemscope="" itemtype="http://schema.org/Rating">
  ...
  <div style="text-align:right;margin-right:20px;margin-top:10px;">  
                                                                ...
                                                                <span style="color:#000000;font-weight:bold;font-size:13px;font-family:tahoma, verdana, arial, sans-serif;"><br>Tarifs : 3,5€/MIN SUP<br><br>MEDIUM VOYANT AUDITIF</span>
...
.fermer:hover { background: #00d9ff; }
  ...
  <tr><td class="btn-voir-forfait"><div class="bloc-vf"><br><a href="http://www.myastro.fr/forfait-diamant"><h4>VOIR LES FORFAITS</h4></a></div></td></tr>
 </table>       
