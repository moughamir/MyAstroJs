         ...
         <div class="span6 main-content">
          ...
          <aside class="widget w-pictures">
            ...
            <div class="widget-content clearfix thumbnails">
              <?php echo getHoroscopeBlock("compatibilite-homme") ?>
            </div>
          </aside>
          ...
          <aside class="widget w-adv">
            ...
            <form method="POST" action="signe.php?cat=compatibilite-amoureuse-masculine" >
                              ...
                              <article class="fold-item span12">
                                <div class="clearfix">
                                  ...
                                  <div class="description visible-part">
                                    ...
                                    <h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Vous être proche de l’engagement, mais êtes-vous sûr d’être vraiment compatible avec votre bien-aimée? Seuls les arts divinatoires et leurs pouvoirs peuvent le confirmer, alors découvrez vite votre compatibilité amoureuse gratuite sur MyAstro.</h6>
                              ...
                              <article class="fold-item span12">
                                <div class="clearfix">
                                  ...
                                  <div class="description visible-part">
                                    ...
                                    <h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Est-elle la femme de votre vie? Vous pouvez en avoir le coeur net avec la compatibilité amoureuse gratuite de MyAstro : une compatibilité précise permettant de savoir comment votre couple va évoluer, parfaitement, difficilement ou désastreusement… </h6>
                              ...
                              <article class="fold-item span12">
                                <div class="clearfix">
                                  ...
                                  <div class="description visible-part">
                                    ...
                                    <h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Réussissez tout ce que vous entreprenez cette semaine avec l’horoscope hebdomadaire gratuit : amour, travail, santé, argent, famille et la citation de la semaine, vous aurez toutes les cartes en main pour passer une bonne semaine. </h6>
                              ...
                              <article class="fold-item span12">
                                <div class="clearfix">
                                  ...
                                  <div class="description visible-part">
                                    ...
                                    <br>
                                    <h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Que vous réserve l’année 2013? Amour, bonheur, argent, travail, changements? N’attendez plus pour prendre connaissance de ce que prévoient les planètes pour votre signe astrologique avec l’horoscope 2013 gratuit MyAstro !</h6>
                              ...
                              <article class="fold-item span12">
                                <div class="clearfix">
                                  ...
                                  <div class="description visible-part">
                                    ...
                                    <br>
                                    <h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Que va-t-il se passer dans votre vie d’homme aujourd’hui? Vous pouvez connaître à l’avance les choses qui vont s’imposer à vous dans la journée et les appréhender de la meilleur façon avec le tirage du tarot quotidien gratuit MyAstro !</h6>
                              ...
                              <article class="fold-item span12">
                                <div class="clearfix">
                                  ...
                                  <div class="description visible-part">
                                    ...
                                    <br>
                                    <h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Donnez une chance au tarot, vous ne pouvez pas soupçonner à quel point ses prédictions sont proches de la réalité… Les cartes vous guident vers la prospérité pour toute la semaine avec le tarot hebdomadaire gratuit My Astro.</h6>
                              ...
                              <article class="fold-item span12">
                                <div class="clearfix">
                                  ...
                                  <div class="description visible-part">
                                    ...
                                    <br>
                                    <h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Art divinatoire très ancien et apprécié, le tarot est un excellent moyen de connaître votre avenir, ses déceptions et ses bonheurs, à partir du tirage de vos cartes, influencé par votre inconscient. Découvrez ce que les cartes ont à vous dire sur le mois à venir avec le tarot mensuel gratuit ! </h6>
                              ...
                              <article class="fold-item span12">
                                <div class="clearfix">
                                  ...
                                  <div class="description visible-part">
                                    ...
                                    <br>
                                    <h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Que vous soyez en couple ou célibataire, vous pouvez consulter le tarot du couple gratuit de MyAstro, ce dernier vous permettra de vous confronter aux significations des cartes tirées et de savoir si la personne convoitée est la bonne.</h6>
