...
$voyant = "DESZIN CLAUDE";
$prenom = "Claude";
$n_photo = "12";
$text_l = "L";
$text = "la numerologie est l'une des facettes de l'éveil spirituel, vous pouvez l'utilisez comme soutien à travers  mon intermédiaire  mais aussi comme un formidable outil pour découvrir qui vous êtes.";

$nom_com_1 ="pattou";
$commentaire_1 = "Claire, précise et rapide (voir mp) ....a bientôt pour retour ++ j'espere.+";
$date_1 ="25 Mar 2013, 15:15 PM";

$nom_com_2 ="nadine";
$commentaire_2 = "tout vient à point à qui sait attendre, même s'il n'a pas les mêmes sentiments que moi pour l'instant, cela va venir et j'en suis certaine!!! à bientôt";
$date_2 ="18 Avr 2013, 9:25 AM";

$nom_com_3 ="thepanik";
$commentaire_3 = "Bonjour claude, je vous ai envoyé un MP pour partager avec vous ce qui m'arrive... Souvent je vous ai télephoné sous l'emprise de l'émotion, souvent perdue, souvent dans le doute. Aujourd'hui je sens qu'il ne faut plus rien esperer de cette histoire, car il n'y a plus rien à esperer. Vous avez vu des belles choses arriver, peut-être que cela arrivera, mais surement pas avec la personne dont nous avons longement parlé. La relation me semble compromise. Il ne me donne plus aucun 'signe de vie'. Moi non plus, vu que j'ai été très mal accueillie la dernière fois, j'en garde un souvenir triste que j'ai n'ai plus le courage de tenter. Merci beaucoup pour votre soutien, pour vos conseils..";
$date_3 ="21 Jan 2013, 07:50 AM";
