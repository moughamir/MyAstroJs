...
$n_photo = "05";
$text_l = "P";
$text = "uissante tarologue, je vois mon domaine de compétence s'étendre de la cartomancie à la numérologie. Je suis une Grande spécialiste de l'amour, j'eclaire le chemin de votre vie par mon savoir faire et je rattache les aspects cachés de votre personnalité aux révélations des cartes.";
...
<!--<div class="rating"  style="text-align:right;margin-right:10px;" itemprop="reviewRating" itemscope="" itemtype="http://schema.org/Rating">
  ...
  <div style="text-align:right;margin-right:20px;margin-top:10px;">  
                                                                ...
                                                                <span style="color:#000000;font-weight:bold;font-size:13px;font-family:tahoma, verdana, arial, sans-serif;"><br>Tarifs : 4€/MIN SUP<br><br>EXPERTE TAROLOGUE</span>
