...
<head>
    <title>Portrait astrologique féminin Verseau: thème astrologique avec Myastro</title>
	<meta name="description" content="Signe Verseau : Grâce à Myastro, définissez avec précision votre profil astrologique et tirez-en les conclusions qui s'imposent. Prenez ensuite les bonnes décisions en toute tranquilité." />
    ...
    <div class="container-fluid" itemscope >
        ...
        <div class="row-fluid">
                            ...
                            <header>
                                <div itemscope >
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li><a href="<?= PROTOCOL.'://'.ROOT_URL ?>/astrologie-gratuite" >Astrologie gratuite</a><i class="icon-caret-right icon-fixed-width"></i><li><a href="<?= PROTOCOL.'://'.ROOT_URL ?>/portrait-astrologique-feminin" >Portrait astrologique féminin</a></li></li><i class="icon-caret-right icon-fixed-width"></i><li>Portrait astrologique féminin Verseau</li></h4>
					...
					<div class="cat-widget-title">
                            ...
                            <h1 itemprop="headline">Portrait astrologique féminin Verseau</h1>
...
<div class="row-fluid social-share-footer">
                                ...
                                <div class="share-icons">
                                    <p itemprop="headline">Signe Verseau : Grâce à Myastro, définissez avec précision votre profil astrologique et tirez-en les conclusions qui s'imposent. Prenez ensuite les bonnes décisions en toute tranquilité.</p>
                                </div>
            ...
            <div class="span6 main-content">
                ...
                <aside class="widget w-pictures">
                    <div class="widget-title">
                        <h4>Votre Portrait astrologique féminin gratuit: Verseau</h4>
...
include('lib.php');
  ...
  $xml1 = read_astrologie('verseau', 'f' ,0);
