      ...
      <div class="article-content">
        <header>
            <div class="cat-widget-title">
              ...
              <h1 itemprop="headline">Faites confiance à l'horoscope de l'amour</h1>
          ...
          <div class="row-fluid">
           ...
           <div class="span6 main-content">
            ...
            <aside class="widget w-adv">
              ...
              <form method="POST" action="signe.php?cat=horoscope-de-l-amour" >
                                ...
                                <article class="fold-item span12">
                                  <div class="clearfix">
                                    ...
                                    <div class="description visible-part">
                                      ...
                                      <br>
                                      <h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Le calcul de la compatibilité amoureuse gratuit est une information précieuse afin de savoir si vous et votre ami êtes faits l'un pour l'autre. La lecture de la position des astres de vos deux horoscopes donne des indications sur la viabilité et la bonne santé de votre couple.</h6>
