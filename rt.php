...
<head>
    ...
    /*http://www.myastro.fr/rep-voyance.php?prenom=prenom&prenom2=prenom2&question=question_x&code=code*/
    </style>
...
<body>
	...
	<?php
		...
		$prenom2 	= (isset($_GET['prenom2'])) ? $_GET['prenom2'] : '';
		...
		switch($question){
			...
			case 'question_1' :?>
			 <p>Bonjour <?php echo $prenom ;?>,<br><br>
				Je vous écris aujourd'hui suite à votre tirage de tarot sur le site myastro.fr.
				Les cartes m'ont révélés que vous vous trouviez dans une situation que vous pouvez de moins en moins supporter et cela vous affecte dans votre vie quotidienne. A ce jour il est important que vous trouviez un équilibre dans votre vie même si vous maîtrisez totalement l'art et la manière de garder les choses pour vous.<br><br>
				Lors de l'analyse de votre tirage j'ai décelé une rencontre importante pour vous dans les semaines à venir, cette rencontre m'a apparu comme déterminante pour votre avenir amoureux. Malheureusement ce que j'ai vu aussi dans vos cartes, c'est que vous ne serez pas apte à faire face à une telle rencontre au moment voulu <?php echo $prenom ;?>. Votre manque de confiance en vous va inévitablement vous pousser à la faute...<br><br>
				Une carte m'a révélé que vous étiez dans une sorte de cercle vicieux dans lequel vous cherchez désespérément à faire la rencontre qui changera votre vie. Cependant vous avez peur de laisser quelqu'un rentrer dans votre vie à nouveau !<br><br>
				Mais sachez <?php echo $prenom ;?> que vous avez fait appel à la bonne personne, car je peux vraiment être un allié de poids pour vous dans cette aventure !!<br><br>
				Laissez-moi vous le démontrer lors d'une consultation téléphonique !<br><br>
				Je suis même prête à vous faire une offre !! <br><br>
				Une consultation entière pour seulement <span>1€ les 10 premières minutes</span> suivi de 4€ par minute supplémentaire.<br><br>
				Voici votre code personnel :  <span class="code">S1-<?php echo $code ;?></span><br><br>
			...
			case 'question_2' :?>
			 <p>Bonjour <?php echo $prenom ;?>,<br><br>
				Après avoir pu consulter le résultat de votre tirage de tarot sur le site myastro.fr  je me permets donc de vous répondre afin de vous donnez mes premiers ressentis.<br><br>
				Les cartes montrent clairement que vos sentiments pour <?php echo $prenom2 ;?> vous préoccupent la majeure partie du temps. Je comprends tout à fait votre désarroi face à une telle situation <?php echo $prenom ;?>. Vous ne savez pas si vous pouvez envisager un avenir avec <?php echo $prenom2 ;?> et cela vous perturbe. Rien de plus normal <?php echo $prenom ;?> !!<br><br>
				Le tirage nous montre aussi que vous avez en vous de grandes capacités pour surmonter tous les obstacles qui se présenteront devant vous. Cependant, il est clair que lorsqu'il s'agit de <?php echo $prenom2 ;?> toutes vos facultés deviennent obsolètes. Pas de panique <?php echo $prenom ;?>, ce genre de réaction est tout à fait normal lorsqu'on a de tels sentiments et de tels doutes...<br><br>
			...
			case 'question_3' :?>
			<p>Bonjour <?php echo $prenom ;?>,<br><br>
				Vous avez effectué un tirage de tarot gratuit sur le site myastro.fr, c'est moi qui me suis chargée de faire l'analyse de votre tirage, donc voici ce que j'ai pu en déduire.<br><br>
				Les cartes nous montrent que vous vous trouvez dans l'attente d'un emploi et que cela vous stresse, rien de plus normal au vu de la phase d'instabilité que vous traversez actuellement.<br><br>
			...
			<p>Bonjour <?php echo $prenom ;?>,<br><br>
				...
				Écoutez <?php echo $prenom ;?>, je suis prête à vous faire une offre pour cette consultation à seulement <span>1 € les 10 premières minutes </span>suivi de 4€ par minute supplémentaire. Pour cela je vous donne votre code personnel : <span class="code">S1-<?php echo $code ;?></span> ainsi que mon numéro de ligne directe ou vous pouvez me joindre actuellement : <span>04 82 53 71 59</span> <br><br>
				J'attends votre appel <?php echo $prenom ;?> !!<br><br>
				Cécile<br><br>
			</p>
			<?php
			...
			case 'question_11' :?>
			<p>Bonjour <?php echo $prenom ;?>,<br><br>
				Je suis Cécile voyante pure pour Myastro.fr, c'est donc moi qui me suis chargée d'analyser le résultat de votre tirage de tarot concernant votre relation avec <?php echo $prenom2 ;?>. Voici ce que les cartes m'ont révélés. <br><br>
				...
				Je veux vraiment vous aider <?php echo $prenom ;?>, les cartes vous ont révélés comme une personne sincère et qui aujourd'hui à juste besoin d'aide pour avancer. Cette aide je peux vous l'apporter !!<br><br>
				Voici mon numéro de ligne directe : <span>04 82 53 71 59</span> <br><br>
				Exceptionnellement je vous propose de vous prendre en consultation pour seulement <span>1€ les 10 premières minute</span> suivi de 4€ par minute supplémentaire, pour cela je vous donne votre code personnel : <span class="code">S1-<?php echo $code ;?></span><br><br>
			...
			case 'question_24' :?>
			<p>Bonjour <?php echo $prenom ;?>,<br><br>
				Vous avez procédé hier à un tirage de tarot gratuit sur le site de myastro.fr. C'est pour cela que je me permets de vous écrire aujourd'hui car j'ai vu à quel point votre situation actuelle  vous oppresse.<br><br>
				On ne va pas se mentir <?php echo $prenom ;?> les cartes montrent clairement que vous êtes totalement perdu au niveau sentimental et vous ne savez plus ce que vous devez penser et comment agir.<br><br>
				...
				Le tirage révèle bien que vous êtes en pleine détresse et que vous avez besoin de mon aide, alors ce que je peux vous proposer exceptionnellement c'est une consultation à <span>1€ les 10 premières minutes</span> seulement, suivi de 4€ par minute supplémentaire.<br><br>
				...
				Grâce à cette consultation je serais en mesure de vous révéler quels seront les évènements déterminant qui vous attendent dans les semaines à venir.<br><br>
			...
			case 'question_73' :?>
			<p>Bonjour <?php echo $prenom ;?>,<br><br>
				Suite à votre tirage de tarot gratuit sur le site myastro.fr je me permets de vous répondre dès aujourd'hui car j'ai vu que votre situation était vraiment très urgente.<br><br>
				En effet les cartes nous montrent que vous êtes en pleine période d'angoisse et que vos nuits sont de plus en plus agitées. Sachez <?php echo $prenom ;?> qu'il est tout à fait normal d'avoir de telles émotions alors que vous attendez l'investissement qui va peut-être changer votre vie !<br><br>
				...
				Écoutez, j'aimerai vraiment écourter votre période de stress et vous apportez les réponses aux questions que vous vous posez mais pour cela il faudrait que nous puissions nous entretenir ensemble lors d'une consultation privée.
