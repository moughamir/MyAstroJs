...
<html>
	...
	<body class="no-js" id="gvApp">
		<div class="loading">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" id="zodiac" class="colorized" xmlns:xlink="http://www.w3.org/1999/xlink">
				...
				<g class="arcs" transform="translate(256,256)">
					<a xlink:href="/gv-hm?p=bel<?=count($parms) ? "&".join('&', $parms) : ""?>">
					...
					<a xlink:href="/gv-hm?p=tau<?=count($parms) ? "&".join('&', $parms) : ""?>">
					...
					<a xlink:href="/gv-hm?p=gem<?=count($parms) ? "&".join('&', $parms) : ""?>">
					...
					<a xlink:href="/gv-hm?p=can<?=count($parms) ? "&".join('&', $parms) : ""?>">
					...
					<a xlink:href="/gv-hm?p=lio<?=count($parms) ? "&".join('&', $parms) : ""?>">
					...
					<a xlink:href="/gv-hm?p=vie<?=count($parms) ? "&".join('&', $parms) : ""?>">
					...
					<a xlink:href="/gv-hm?p=bal<?=count($parms) ? "&".join('&', $parms) : ""?>">
					...
					<a xlink:href="/gv-hm?p=sco<?=count($parms) ? "&".join('&', $parms) : ""?>">
					...
					<a xlink:href="/gv-hm?p=sag<?=count($parms) ? "&".join('&', $parms) : ""?>">
					...
					<a xlink:href="/gv-hm?p=cap<?=count($parms) ? "&".join('&', $parms) : ""?>">
					...
					<a xlink:href="/gv-hm?p=ver<?=count($parms) ? "&".join('&', $parms) : ""?>">
					...
					<a xlink:href="/gv-hm?p=poi<?=count($parms) ? "&".join('&', $parms) : ""?>">
		...
		<nav>
			<ul>
				<li><a href="/gv-hm?p=bel<?=count($parms) ? "&".join('&', $parms) : ""?>" class="signe-bel">Bélier</a></li>
				<li><a href="/gv-hm?p=tau<?=count($parms) ? "&".join('&', $parms) : ""?>" class="signe-tau">Taureau</a></li>
				<li><a href="/gv-hm?p=gem<?=count($parms) ? "&".join('&', $parms) : ""?>" class="signe-gem">Gémeaux</a></li>
				<li><a href="/gv-hm?p=can<?=count($parms) ? "&".join('&', $parms) : ""?>" class="signe-can">Cancer</a></li>
				<li><a href="/gv-hm?p=lio<?=count($parms) ? "&".join('&', $parms) : ""?>" class="signe-lio">Lion</a></li>
				<li><a href="/gv-hm?p=vie<?=count($parms) ? "&".join('&', $parms) : ""?>" class="signe-vie">Vierge</a></li>
				<li><a href="/gv-hm?p=bal<?=count($parms) ? "&".join('&', $parms) : ""?>" class="signe-bal">Balance</a></li>
				<li><a href="/gv-hm?p=sco<?=count($parms) ? "&".join('&', $parms) : ""?>" class="signe-sco">Scorpion</a></li>
				<li><a href="/gv-hm?p=sag<?=count($parms) ? "&".join('&', $parms) : ""?>" class="signe-sag">Sagittaire</a></li>
				<li><a href="/gv-hm?p=cap<?=count($parms) ? "&".join('&', $parms) : ""?>" class="signe-cap">Capricorne</a></li>
				<li><a href="/gv-hm?p=ver<?=count($parms) ? "&".join('&', $parms) : ""?>" class="signe-ver">Verseau</a></li>
				<li><a href="/gv-hm?p=poi<?=count($parms) ? "&".join('&', $parms) : ""?>" class="signe-poi">Poissons</a></li>
			</ul>
		</nav>
