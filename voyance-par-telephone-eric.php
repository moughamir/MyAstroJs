...
$voyant = "PATONIER ERIC";
$prenom = "Eric";
$n_photo = "14";
$text_l = "J";
$text = "e suis là pour vous aider,pour  vous éclairer et pour vous guider grâce à ce don qui m’accompagne depuis maintenant 25 ans. Je vous accompagnerai tout au long de votre période d’incertitude pour voir ce que nous pouvons ensemble éviter et vous fournir une véritable voyance sérieuse.";

$nom_com_1 ="Annie75";
$commentaire_1 = "je veux témoigner de la fiabilité des voyances de votre cabinet qui m’ont aidé à comprendre pourquoi mon couple battait de l’aile.. Grâce à la précision de vos flashs, j’ai dû me rendre à l’évidence et je l’ai quitté. Je me sens soulagée car maintenant les choses sont claires entre nous. J’attends avec impatience ce nouveau départ que vous m’avez prédit avec un autre homme. Merci énormément de votre soutien moral";
$date_1 ="19 Avr 2013, 14:16 PM";

$nom_com_2 ="bouyves84";
$commentaire_2 = "JJ’ai toujours aimé la voyance. J’y crois depuis très toujours. Il y a quelques mois, j’ai appelé le cabinet my astro car j’étais désespérée, je venais de perdre mon chien et je ne savais plus quoi faire pour le retrouver. Une personne à l’accueil, très gentille, m’a conseillé un médium incroyable de précision grâce à ses flashs. J’ai fait une consultation avec lui et il m’a conseillé d’aller près d’un étang à côté chez moi. Je m’y suis rendue et j’ai appelé mon chien pendant plus de 30 minutes sans me décourager. Vous ne pouvez pas imaginer notre joie à tous les deux quand on s’est retrouvé. Je ne remercierais jamais assez  eric de m’avoir permis de recupérer mon chien. Cela n’a pas de prix";
$date_2 ="30 Jan 2013, 02:50 AM";

$nom_com_3 ="Jy gour95";
$commentaire_3 = "Henri tu m as epater par tes flash precis ; merci ";
                    ...
                    <div class="widget-content clearfix">
                        <div class="posts-in-widget">
                            <div class="row-fluid modern-items-list">
                                ...
                                <img src="images_voyance/voyance-par-telephone.gif"  alt="VOYANCE PAR TELEPHONE">
                            </div>
                        </div>
                    </div>
                </aside>
...
<!--<div class="rating"  style="text-align:right;margin-right:10px;" itemprop="reviewRating" itemscope="" itemtype="http://schema.org/Rating">
  ...
  <div style="text-align:right;margin-right:20px;margin-top:10px;">  
                                                                ...
                                                                <span style="color:#000000;font-weight:bold;font-size:13px;font-family:tahoma, verdana, arial, sans-serif;"><br>Tarifs : 4,5€/MIN SUP<br><br>MEDIUM</span>
