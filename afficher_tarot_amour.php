...
<h3>Tarot quotidien  du '.$date.' pour '.$prenom.' '.$msg .'</h3>
	...
	<table align="center">
	<tr>
	<td><a href="afficher_tarot_quotidien.php#" onclick="window.document.myform.submit();">
...
$echo.= '<br/>'.'<table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <td rowspan="4">
		<form name="myform" method="post" action="afficher_tarot_quotidien.php">
	...
	if($step==5)
	{
		$echo.='<td><a href="afficher_tarot_quotidien.php#" onclick="window.document.myform.submit();"><img src="'.$carte5_img.'" alt="'.$carte5_alt.'" title="'.$carte5_alt.'" border="0"></a></td>';
	}
	else
...
if((int)$prestep>4)
{
	...
	if(!((($page=='tarot.php')&&((int)$step<12))||((int)$step<11)))
	{
		$echo.='<div> 
						...
						<a href="afficher_tarot_quotidien.php#" onclick="window.document.myform.step.value=\'5\'; window.document.myform.submit();">
...
<br>
<h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">L’horoscope 2014 gratuit par MyAstro vous offre les prédictions de votre signe astrologique et des astres qui vont changer votre année : les cartes de votre bonheur sont entre vos mains, vous parviendrez enfin à l’atteindre grâce à l'astrologie.</h6>
...
<br>
<h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Connaissez-vous votre personnalité astrologique? Votre date de naissance et votre signe astrologique ont un impact sur la personne que vous êtes au quotidien sans que vous en ayez conscience, découvrez les secrets de votre véritable personnalité gratuitement avec MyAstro.</h6>
...
<br>
<h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Quel est votre profil astrologique? Plutôt discrète, séductrice, fidèle, paresseuse, indépendante, naïve? Tant d’adjectifs peuvent vous décrire, découvrez-les gratuitement à partir de votre signe astrologique sur MyAstro.</h6>
