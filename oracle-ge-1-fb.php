...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    <head>
    <title>Oracle Gé: votre tirage de cartes interprété | MyAstro</title>
...
<div class="subbody">
    ...
    <div class="main">
        <div class="left-part">
            ...
            <div class="content">
                <h1>Oracle <strong>Gé</strong></h1>
                <div class="txt-content">
                    <p>L'Oracle Gé est un art divinatoire incontournable pour qui souhaite en savoir plus sur son avenir. De quoi sera fait demain ? Voilà bien une question à laquelle les lames de l'Oracle Gé peuvent répondre.</p>
                    <p>Une fois votre tirage effectué, un spécialiste vous communique sa signification, et vous pourrez ainsi mettre un sens sur chacune des lames.</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="paquet">
                            ...
                            <div class="title">Tirez <strong>5</strong> lames</div>
                                ...
                                for ($i = 1; $i <= 21; $i++)
                                {
                                    ...
                                    echo '<img src="images_landing/carte-oracle-ge.png" class="tarot-dos tarot-' . $i . '" data-pos="' . $datapos . '"/>';
                                }
                                ?>
                                </div>
    ...
    <div class="main bottom-part" id="secondpart">
        ...
        <div class="left-bottom-part">
             <div class="comment-ca-marche">
                ...
                <img src="images_landing/oracle-ge.jpg" width="577" height="185" alt="Oracle ge"/>
            </div>
        </div>
                ...
                <aside class="widget w-adv">
                    ...
                    <div id="form-w" class="widget-content clearfix">
                        <div class="visible-part form-part form-part-one">
                            ...
                            <form id="">
                                <input type="hidden" name="source" value="myastro-oracle-fb2" />
       ...
       <script src="js/jquery-1.11.js"></script>
        <script src="js/oracle-ge.js"></script>
