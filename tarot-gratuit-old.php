                        ...
                        <div class="article-content">
                            <header>
								...
								<div class="cat-widget-title">
										...
										<h1 itemprop="headline">Tirage de tarot gratuit Myastro : toutes les réponses à vos questions</h1>
 ...
 <div class="row-fluid">
            ...
            <div class="span6 main-content">
                ...
                <!-- Slider -->
                                ...
                                <div id="carousel-tarotgratuit" class="carousel slide" data-ride="carousel">
                                  <!-- Indicators -->
                                  <ol class="carousel-indicators">
                                    <li data-target="#carousel-tarotgratuit" data-slide-to="0" class="active"></li>
                                    <li data-target="#carousel-tarotgratuit" data-slide-to="1"></li>
                                    <li data-target="#carousel-tarotgratuit" data-slide-to="2"></li>
                                    <li data-target="#carousel-tarotgratuit" data-slide-to="3"></li>
                                    <li data-target="#carousel-tarotgratuit" data-slide-to="4"></li>
                                  </ol>
                                  <div class="carousel-inner">
                                    ...
                                    <div class="item">
                                        <a href="http://www.myastro.fr/tarot-hebdomadaire">
