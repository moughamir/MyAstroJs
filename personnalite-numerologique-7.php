...
<head>
    <title>Votre personnalité numérologique chiffre 7: Myastro</title>
	<meta name="description" content="Chiffre 7 : Myastro vous permet de dresser, en fonction de chiffres et de lettres qui vous sont propres, votre profil numérologique. Ceci vous permet de mieux vous connaitre pour appréhender les situations de la vie." />
                            ...
                            <header>
                                <div itemscope >
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li><a href="http://www.myastro.fr/personnalite-numerologique" >Personnalité numérologique</a></li><i class="icon-caret-right icon-fixed-width"></i></li>
                                        <li>Personnalité numérologique chiffre 7</h4></li>
                                    </ul>
                                </div>
					<div class="cat-widget-title">
                        
                            <h1 itemprop="headline">Personnalité numérologique chiffre 7</h1>
...
<div class="row-fluid social-share-footer">
                                ...
                                <div class="share-icons">
                                    <h5 itemprop="headline">Chiffre 7 : Myastro vous permet de dresser, en fonction de chiffres et de lettres qui vous sont propres, votre profil numérologique. Ceci vous permet de mieux vous connaitre pour appréhender les situations de la vie.</h5>
                                </div>
            ...
            <div class="span6 main-content">
                ...
                <aside class="widget w-pictures">
                    <div class="widget-title">
                        <h4>Votre Personnalité numérologique gratuite: chiffre 7</h4>
...
//echo $s_cle;
	...
	{
			$f5=$s_value;
			$f5=preg_replace('@<center[^>]*?>.*?</center>@si', '', $f5);
	}
	
	elseif ($s_cle===6)
	{
			$f6=$s_value;
			$f6=preg_replace('@<center[^>]*?>.*?</center>@si', '', $f6);
	}
	
	elseif ($s_cle===7)
	{
			$f7=$s_value;
			$f7=preg_replace('@<center[^>]*?>.*?</center>@si', '', $f7);
	}
