...
<head>
    <title>Tarot de l'amour : tirage de cartes pour des réponses</title>
            ...
            <div class="span6 main-content">
                ...
                <section class="pic-slider">
				   ...
				   <section class="cat-widget h-cat-1"> <div class="cat-widget-title">
                        <h3>CONSULTER VOTRE TAROT DE L'AMOUR GRATUIT</h3>
                    </div>
...
//-->
               ...
               <form name="tarot" action="afficher_tarot_amour.php" method="post" onsubmit="return check_prenom()">
<br>
