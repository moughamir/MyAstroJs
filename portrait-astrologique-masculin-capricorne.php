...
<head>
    <title>Portrait astrologique masculin Capricorne: faites le point avec Myastro</title>
	<meta name="description" content="Signe Capricorne : Grâce à Myastro, définissez avec précision votre profil astrologique et tirez-en les conclusions qui s'imposent. Prenez ensuite les bonnes décisions en toute tranquilité." />
    ...
    <div class="container-fluid" itemscope >
        ...
        <div class="row-fluid">
                            ...
                            <header>
                                <div itemscope >
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li><a href="http://www.myastro.fr/astrologie-gratuite" >Astrologie gratuite</a><i class="icon-caret-right icon-fixed-width"></i><li><a href="http://www.myastro.fr/portrait-astrologique-masculin" >Portrait astrologique masculin</a></li></li><i class="icon-caret-right icon-fixed-width"></i><li>Portrait astrologique masculin Capricorne</li></h4>
					...
					<div class="cat-widget-title">
                            ...
                            <h1 itemprop="headline">Portrait astrologique masculin Capricorne</h1>
...
<div class="row-fluid social-share-footer">
                                ...
                                <div class="share-icons">
                                    <h5 itemprop="headline">Signe Capricorne : Grâce à Myastro, définissez avec précision votre profil astrologique et tirez-en les conclusions qui s'imposent. Prenez ensuite les bonnes décisions en toute tranquilité.</h5>
                                </div>
            ...
            <div class="span6 main-content">
                ...
                <aside class="widget w-pictures">
                    <div class="widget-title">
                        <h4>Votre Portrait astrologique masculin gratuit: Capricorne</h4>
...
include('lib.php');
  ...
  $xml1 = read_astrologie('capricorne', 'h' ,0);
