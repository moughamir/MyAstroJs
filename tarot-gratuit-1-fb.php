...
/* 
    --------------------------------------------
    --   tarot-gratuit-1-fb = FACEBOOK ADDS   --
    --------------------------------------------

    Created on : 06 avril 2016
    Author     : Laurène Dourdin <2aurene@gmail.com>
*/
    $page = 'tarot-gratuit-1-fb';
                    ...
                    <article class="FormContainer" id="form-container">
                        ...
                        <div class="FormContainer-Fields">
                            ...
                            <form id="form-container">
                                ...
                                <input type="hidden" name="source" value="myastro-tarot-fb1" />
                                <input type="hidden" name="method" value="affil-maxi" />
                                <input type="hidden" name="support" value="tarot"/>
                                <input type="hidden" name="affiliation" value="facebook_adds" />
                                <input type="hidden" name="dri" value="http://www.myastro.fr/tarot-gratuit-1-fb-tel" />
