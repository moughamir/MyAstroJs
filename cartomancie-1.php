...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    <head>
    <title>Cartomancie : que disent les cartes sur votre avenir ? | Myastro</title>
...
<div class="subbody">
    ...
    <div class="main">
        <div class="left-part">
            ...
            <div class="content">
                <h1><strong>Cartomancie</strong></h1>
                <div class="txt-content">
                    <p>Avec la cartomancie, trouvez des réponses à vos questions sur votre vie et votre avenir dans les cartes ! Effectuez votre tirage, et nos spécialistes vous dévoileront sa signification.</p>
                    <p>Que vous vous interrogiez sur votre avenir sentimental, professionnel ou financier, soyez sûr que la cartomancie vous apportera des indices clairs sur ce que demain vous réserve.</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="paquet">
                            ...
                            <div class="title">Tirez <strong>5</strong> lames</div>
                                ...
                                for ($i = 1; $i <= 21; $i++)
                                {
                                    ...
                                    echo '<img src="images_landing/carte-cartomancie.png" class="tarot-dos tarot-' . $i . '" data-pos="' . $datapos . '"/>';
                                }
                                ?>
                                </div>
 ...
 <!-- Remarketing tags -->
    ...
    <img height="1" width="1" style="border-style:none;" alt="" src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/1024378253/?value=0&amp;guid=ON&amp;script=0"/>
    </div>
    </noscript>
