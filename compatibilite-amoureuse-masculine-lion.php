...
<head>
    <title>Compatibilité amoureuse masculine Lion: allez-vous bien ensemble?</title>
	<meta name="description" content="Signe Lion : Les astres, leur alignement et leur position pourront vous indiquer si cette personne que vous chérissez est bien faite pour vous et si la relation doit être entretenue." />
    ...
    <div class="container-fluid" itemscope >
        ...
        <div class="row-fluid">
                            ...
                            <header>
                                <div itemscope >
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li><a href="http://www.myastro.fr/astrologie-gratuite" >Astrologie gratuite</a><i class="icon-caret-right icon-fixed-width"></i><li><a href="http://www.myastro.fr/compatibilite-amoureuse-masculine" >Compatibilité amoureuse masculine</a></li></li><i class="icon-caret-right icon-fixed-width"></i><li>Compatibilité amoureuse masculine Lion</li></h4>
					...
					<div class="cat-widget-title">
                            ...
                            <h1 itemprop="headline">Compatibilité amoureuse masculine Lion</h1>
...
<div class="row-fluid social-share-footer">
                                ...
                                <div class="share-icons">
                                    <h5 itemprop="headline">Signe Lion : Les astres, leur alignement et leur position pourront vous indiquer si cette personne que vous chérissez est bien faite pour vous et si la relation doit être entretenue.</h5>
                                </div>
            ...
            <div class="span6 main-content">
                ...
                <aside class="widget w-pictures">
                    <div class="widget-title">
                        <h4>Votre Compatibilité amoureuse masculine gratuite: Lion</h4>
...
include('lib.php');
 ...
 //echo $s_cle;
    ...
    if ($s_cle==='Homme Lion - Femme Bélier')
	{
			$f1=$s_value;
  	}
	elseif ($s_cle==='Homme Lion - Femme Taureau')
	{
			$f2=$s_value;
	}
	
	elseif ($s_cle==='Homme Lion - Femme Gémeaux')
	{
			$f3=$s_value;
	}
	
	elseif ($s_cle==='Homme Lion - Femme Cancer')
	{
			$f4=$s_value;
	}
	
	elseif ($s_cle==='Homme Lion - Femme Lion')
	{
			$f5=$s_value;
	}
	
	elseif ($s_cle==='Homme Lion - Femme Vierge')
	{
			$f6=$s_value;
	}
	
	elseif ($s_cle==='Homme Lion - Femme Balance')
	{
			$f7=$s_value;
	}
	
	elseif ($s_cle==='Homme Lion - Femme Scorpion')
	{
			$f8=$s_value;
	}
	
	elseif ($s_cle==='Homme Lion - Femme Sagittaire')
	{
			$f9=$s_value;
	}
	
	elseif ($s_cle==='Homme Lion - Femme Capricorne')
	{
			$f10=$s_value;
	}
		
	elseif ($s_cle==='Homme Lion - Femme Verseau')
	{
			$f11=$s_value;
	}
			
	elseif ($s_cle==='Homme Lion - Femme Poissons')
	{
			$f12=$s_value;
  ...
  ?>	
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme" data-toggle="collapse" data-parent="#accordion1"
                                                            href="#collapse1">Homme Lion - Femme Bélier
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse2">Homme Lion - Femme Taureau
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse3">Homme Lion - Femme Gémeaux
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse4">Homme Lion - Femme Cancer
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse5">Homme Lion - Femme Lion
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse6">Homme Lion - Femme Vierge
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse7">Homme Lion - Femme Balance
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse8">Homme Lion - Femme Scorpion
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse9">Homme Lion - Femme Sagittaire
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse10">Homme Lion - Femme Capricorne
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse11">Homme Lion - Femme Verseau
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse12">Homme Lion - Femme Poissons
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
