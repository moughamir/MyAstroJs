...
<html lang="fr">
	...
	<?php /* <title>Voyance gratuite en ligne par mail : My-astro.fr</title> */ ?>
	...
	<?= $tracker->getCanonical() ?>
        ...
        <link rel="stylesheet" href="./voyance-gratuite-6_files/style-2.css">
        <!--<link rel="stylesheet" href="style.css" />-->
        <script type="text/javascript" src="./js/jquery-1.11.js"></script>
        <script type="text/javascript" src="./voyance-gratuite-6_files/bootstrap.min.js"></script> <script type="text/javascript" src="js/formValidator.js"></script>
        <script type="text/javascript" src="./voyance-gratuite-6_files/jquery.maskedinput.min.js"></script>
        <script src="http://html5shiv.googlecode.com/svn/trunk/html5.js"></script>
        <script type="text/javascript" src="http://beta.myastro.fr/js/placeholder_polyfill.jquery.js"></script>
            ...
            <div class="content row">
                <div id="column1" class="col-md-offset-1 col-md-10">
                    ...
                    <div class="widget w-adv">
                        <div id="form-w" class="widget-content clearfix">
                            <div class="visible-part form-part form-part-two">
                                ...
                                <form id="">
                                    <input type="hidden" name="source" value="voyance-gratuite-a" /> <!-- source unique pour la campagne adwords -->
                    ...
                    <div class="text-center">
                        <h2>Une voyance gratuite pour répondre à toutes vos questions !</h2>
