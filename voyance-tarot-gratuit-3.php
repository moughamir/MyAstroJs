                    ...
                    <div class="tarot-content">
                        ...
                        <div class="tarot-right">
                            <form action="" method="post" class="hidden">
                                <input type="hidden" name="source" value="myastro-tarot-a" /> <!-- source unique pour la campagne adwords -->
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div class="horopart">
                                                    <input type="checkbox" name="cguv" required checked> J'ai lu et j'accepte les conditions générales.<br>
                                                    ...
                                                    <input type="checkbox" name="" required> Je certifie avoir 18 ans ou plus.<br><br>
                                                    <span class="prec">* Vous serez rappelé par le voyant à ce numéro</span>
                                            </div>
                        ...
                        <div class="clearfix"></div>
                        <div style="text-align:justify; margin-left:25px;width:94%;">
