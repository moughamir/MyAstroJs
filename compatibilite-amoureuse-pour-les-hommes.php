				...
				<header>
					...
					<div class="row-fluid social-share-footer">
						...
						<div class="share-icons">
							<h5 itemprop="headline">Calculez votre compatibilité amoureuse avec votre compagne grâce aux expertises de Myastro et sachez si votre relation peut être durable ou non.</h5>
						</div>
					</div>
					<br>
				</header>
				...
				<div class="row-fluid">
					...
					<div class="span6 main-content">
						...
						<aside class="widget w-adv">
							...
							<form method="POST" action="numero.php?cat=compatibilite-amoureuse-pour-les-hommes" >
							...
							<div class="widget-content clearfix thumbnails">
								<ul class="posts-in-images clearfix">
									...
									<li rel="tooltip" data-toggle="tooltip" data-placement="top" data-original-title="1" title="1">
										<a href="http://www.myastro.fr/compatibilite-amoureuse-pour-les-hommes-1">
									...
									<li rel="tooltip" data-toggle="tooltip" data-placement="top" data-original-title="2" title="2">
										<a href="http://www.myastro.fr/compatibilite-amoureuse-pour-les-hommes-2">
											<div class="thumb-effect">
												<div class="mask"></div>
									...
									<li rel="tooltip" data-toggle="tooltip" data-placement="top" data-original-title="3" title="3">
										<a href="http://www.myastro.fr/compatibilite-amoureuse-pour-les-hommes-3">
											<div class="thumb-effect">
												<div class="mask"></div>
									...
									<li rel="tooltip" data-toggle="tooltip" data-placement="top" data-original-title="4" title="4">
										<a href="http://www.myastro.fr/compatibilite-amoureuse-pour-les-hommes-4">
											<div class="thumb-effect">
												<div class="mask"></div>
									...
									<li rel="tooltip" data-toggle="tooltip" data-placement="top" data-original-title="5" title="5">
										<a href="http://www.myastro.fr/compatibilite-amoureuse-pour-les-hommes-5">
											<div class="thumb-effect">
												<div class="mask"></div>
									...
									<li rel="tooltip" data-toggle="tooltip" data-placement="top" data-original-title="6" title="6">
										<a href="http://www.myastro.fr/compatibilite-amoureuse-pour-les-hommes-6">
											<div class="thumb-effect">
												<div class="mask"></div>
									...
									<li rel="tooltip" data-toggle="tooltip" data-placement="top" data-original-title="7" title="7">
										<a href="http://www.myastro.fr/compatibilite-amoureuse-pour-les-hommes-7">
											<div class="thumb-effect">
												<div class="mask"></div>
									...
									<li rel="tooltip" data-toggle="tooltip" data-placement="top" data-original-title="8" title="8">
										<a href="http://www.myastro.fr/compatibilite-amoureuse-pour-les-hommes-8">
											<div class="thumb-effect">
												<div class="mask"></div>
									...
									<li rel="tooltip" data-toggle="tooltip" data-placement="top" data-original-title="9" title="9">
										<a href="http://www.myastro.fr/compatibilite-amoureuse-pour-les-hommes-9">
											<div class="thumb-effect">
												<div class="mask"></div>
																	...
																	<article class="fold-item span12">
																		<div class="clearfix">
																			...
																			<div class="description visible-part">
																				...
																				<br><h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Tous les jours, grâce à l'astrologie gratuite de My Astro, vous pourrez connaître votre avenir proche. L'argent, l'amour, le mariage… Vous pourrez donc la possibilité de vous préparer et d'appréhender ces choses avec sérénité. </h6>
																	...
																	<article class="fold-item span12">
																		<div class="clearfix">
																			...
																			<div class="description visible-part">
																				...
																				<br><h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Vous êtes aujourd'hui en couple et vous avez besoin de savoir si la comparabilité amoureuse féminine peut fonctionner ? Grâce au tirages des cartes, notre site répondra à toutes vos questions. </h6>
																	...
																	<article class="fold-item span12">
																		<div class="clearfix">
																			...
																			<div class="description visible-part">
																				...
																				<br><h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Que vous soyez Taureau ou Capricorne voir Verseau, notre site vous donnera votre horoscope du jour gratuitement. Fini les surprises.</h6>                                                                       
																			</div>
																	...
																	<article class="fold-item span12">
																		<div class="clearfix">
																			...
																			<div class="description visible-part">
																				...
																				<br><h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Vous souhaitez connaître votre avenir pour la fin de l'année ? L'horoscope gratuit en 2013 est accessible pour tous les visiteurs de Myastro. Le tirage des cartes répondra à toutes vos questions. </h6>
																	...
																	<article class="fold-item span12">
																		<div class="clearfix">
																			...
																			<div class="description visible-part">
																				...
																				<br><h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Tous les jours sont différents. C'est pourquoi grâce à notre site, vous pourrez connaître votre avenir grâce au tarot quotidien mis en place sur Myastro.</h6>
																	...
																	<article class="fold-item span12">
																		<div class="clearfix">
																			...
																			<div class="description visible-part">
																				...
																				<br><h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Une fois par semaine, grâce au tirage des cartes, votre avenir n'aura plus de secrets. Notre site vous informera sur votre avenir proche. </h6>
																	...
																	<article class="fold-item span12">
																		<div class="clearfix">
																			...
																			<div class="description visible-part">
																				...
																				<br><h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Tous les mois ne sont pas les mêmes. Après avoir passé plusieurs mois difficiles, pourquoi ne pas connaître votre avenir pour les prochains mois grâce au tarot mensuel. Aujourd'hui Myastro vous offre cette possibilité. </h6>
																	...
																	<article class="fold-item span12">
																		<div class="clearfix">
																			...
																			<div class="description visible-part">
																				...
																				<br><h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Comment connaître les tendances au sein de votre couple ? Myastro vous propose, grâce au tarot de couple gratuit, de connaître votre avenir amoureux. Plus de secrets pour votre futur avec Myastro. </h6>
				...
				<div class="row-fluid">
					<div itemscope >
						<ul class="breadcrumb" itemprop="breadcrumb">
							...
							<li>Compatibilité amoureuse pour les hommes</h4></li>
						</ul>
					</div>
				</div>
			</div>
