<?php
    $source = 'horoscope-du-jour-capricorne';

    $ipg_title = 'HOROSCOPE CAPRICORNE';
    $ipg_pubs = [
        'compatibilite-amoureuse-pour-les-femmes-capricorne', 'compatibilite-amoureuse-pour-les-hommes-capricorne',
        'votre-personnalite-astrologique-capricorne', 'portrait-astrologique-feminin-capricorne',
        'tarot-quotidien-capricorne', 'tarot-hebdomadaire-capricorne',
        'tarot-mensuel-capricorne', 'tarot-de-couple-capricorne'
    ];
    
    ini_set('max_execution_time', 0);
    include('lib.php');
    
    $xml1 = read_horoscope_rss('https://www.asiaflash.com/horoscope/rss_horojour_capricorne.xml');
    $ac_result = array();
                        ...
                        <div class="span6 main-content">
                            <aside class="widget w-pictures">
                                <div class="widget-title">
                                    ...
                                    <img class="signe" src="images_voyance/signes/capricorne.png" title="Symbole Capricorne" />
                                </div>
                                <!-- Résultat horoscope -->
