                            ...
                            <header>
                                <div itemscope >
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li>Compatibilité amoureuse pour les hommes chiffre 6</h4></li>
                                    </ul>
                                </div>
...
<div class="row-fluid social-share-footer">
                                ...
                                <div class="share-icons">
                                    <h5 itemprop="headline">Chiffre 6 : Calculez votre compatibilité amoureuse avec votre compagne grâce aux expertises de Myastro et sachez si votre relation peut être durable ou non.</h5>
                                </div>
            ...
            <div class="span6 main-content">
                ...
                <aside class="widget w-pictures">
                    <div class="widget-title">
                        <h4>Votre Compatibilité amoureuse pour les hommes gratuite: chiffre 6</h4>
...
//echo $s_cle;
    ...
    if ($s_cle==='Homme 6 - Femme 1')
	{
			$f1=$s_value;
  	}
	elseif ($s_cle==='Homme 6 - Femme 2')
	{
			$f2=$s_value;
  ...
  ?>	
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme" data-toggle="collapse" data-parent="#accordion1"
                                                            href="#collapse1">Homme 6 - Femme 1
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse2">Homme 6 - Femme 2
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse3">Homme 6 - Femme 3
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
												...
												<div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse4">Homme 6 - Femme 4
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
												...
												<div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse5">Homme 6 - Femme 5
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
												...
												<div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse6">Homme 6 - Femme 6
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
												...
												<div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse7">Homme 6 - Femme 7
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
												...
												<div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse8">Homme 6 - Femme 8
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
												...
												<div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse9">Homme 6 - Femme 9
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
