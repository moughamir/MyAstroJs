...
$n_photo = "01";
$text_l = "D";
$text = "otée d'un don naturel après de nombreuses années d'études et 30 ans d'expérience, je lis les lames du tarot et éclaire,votre vie passée, présente et future.";

$nom_com_1 ="guesskan";
$commentaire_1 = "grand merci de ton soutien et ta clairvoyance ä chaque consultation faite est professionnelle efficace et super humaine en tout cas merci de me rassurer je reviens vers toi tres vite. je te souhaite bonne chance et longue vie";
$date_1 ="19 Avr 2013, 14:16 PM";

$nom_com_2 ="Raymonde";
$commentaire_2 = "Je préfères les consultations téléphoniques mais il est vrai que le chat, on peut y revenir, le relire et penser à ce qui a été dit. Comme je doute fréquemment dans cette relation, cela va me faire du bien. Merci encore. ";
$date_2 ="30 Jan 2013, 02:50 AM";

$nom_com_3 ="TANO";
$commentaire_3 = "tjr exellent bravoo.";
                        ...
                        <div class="posts-in-widget">
                            <div class="row-fluid modern-items-list">
                            	<?php 
                                    ...
                                    ?>
                                        <img src="images/bannieres/VTE2/kathy.png"  alt="VOYANCE PAR TELEPHONE">
                                    <?php
                                    } else {
                                    ?>
                                    <img src="images/bannieres/voyant-skyscraper/katy-voyante-pur.jpg"  alt="VOYANCE PAR TELEPHONE">
                                    <?php
                                    }
                                ?>
  ...
  <tr>
    <td> 
                                                        ...
                                                        <div style="margin-top:0px;">
                                                            <img src="images/voyants/kathy.png"  class="imgtelvr">
                                                        </div>
...
<!--<div class="rating"  style="text-align:right;margin-right:10px;" itemprop="reviewRating" itemscope="" itemtype="http://schema.org/Rating">
  ...
  <div style="text-align:right;margin-right:20px;margin-top:10px;">  
                                                                ...
                                                                <span style="color:#000000;font-weight:bold;font-size:13px;font-family:tahoma, verdana, arial, sans-serif;"><br>Tarifs : 3,5€/MIN SUP<br><br>MEDIUM PUR</span>
...
.fermer:hover { background: #00d9ff; }
  ...
  <tr><td class="btn-voir-forfait" style="margin-left:172px;"><div class="bloc-vf"><br><a href="http://www.myastro.fr/forfait-diamant"><h4>VOIR LES FORFAITS</h4></a></div></td></tr>
 </table>       
