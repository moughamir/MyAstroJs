...
$voyant = "MANSOUR DALIL";
$prenom = "Dalil";
$n_photo = "05";
$text_l = "T";
$text = "arologue spécialiste du tarot de Marseille, je me sers également beaucoup de l’Oracle de Belline et de l’Oracle de la Triade. Avec mes cartes, je suis en mesure d’apporter la lumière là ou vous ne voyez que des doutes et des remises en question. Les cartes ont des messages à faire passer, laissez-moi vous les interpréter.";

$nom_com_1 ="NATH35";
$commentaire_1 = "Consultation au TOP qui me correspond. Excellente tarologue et je ne le dis pas parce que vous m'avez annoncé que du positif, mais j'ai aimé votre façon de procédé. Dès que ça bouge, vous aurez de mes nouvelles. Merci Cecile. A bientôt.";
$date_1 ="15 Avr 2013, 10:06 PM";

$nom_com_2 ="ARIANE";
$commentaire_2 = "Merci Cecile pour notre entretien. J'espère que je pourrai vous confirmer votre prédiction. Merci à bientôt Ariane";
$date_2 ="08 Mar 2013, 3:15 PM";

$nom_com_3 ="esila";
$commentaire_3 = "Bonjour cecile, le temps est longt et toujours aucunes nouvelles, j' espère en avoir car maintenant je commence à me dire que ça ne sert plus à rien et qu'il ne m'aime pas. Je me demande même si je ne devrais pas tourner la page et l' oublier. J' espère que tu vois juste et qu'il reviendra mais sincèrement je n' y crois plus";
$date_3 ="20 Mar 2013, 8:35 AM";
...
if(isset($_POST['valider'])){
    ...
    if(($nom != "") && ($_POST['c1']!= "") && ($_POST['c2']!= "") && ($_POST['c3']!= "") && ($_POST['c4']!= "") && ($_POST['c5']!= "")){
        ...
        $msg_err = '<BR><font style="color: red;font-family: Tahoma,Sans-serif;font-size: 11px;font-weight: bold;" >Afin que votre demande puisse être correctement prise en compte par notre service, merci de bien vouloir remplir le formulaire.</font><br><br>';
        if ($pays != ""){
                    ...
                    <section class="span270">
                            ...
                            <div class="widget-content clearfix">
                                <div class="posts-in-widget">
                                    <div class="row-fluid modern-items-list">
                                        <?php if($_SERVER['HTTP_REFERER'] == 'http://www.myastro.fr/voyance-par-telephone-2'){ ?>
                                            <img src="images/bannieres/VTE2/cecile.png" alt="VOYANCE PAR TELEPHONE" />
                                        <?php } else { ?>
                                            <img src="images/bannieres/voyant-skyscraper/cecile-tarologue.jpg" alt="VOYANCE PAR TELEPHONE" />
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <aside class="widget w-posts">
                            <div style="text-align:justify;">
                                ...
                                <div class="widget-content clearfix">
                                    <h5>
                                        Découvrez l’ensemble de l’équipe d’experts sélectionnés par My Astro avec qui vous établirez une relation de confiance et qui vous guideront sur le chemin d’une voyance par téléphone en toute sérénité.<br/><br/>
                                        Le tarif est de 10€ les 10 premières minutes.
                                    </h5>
                                    <br>
                                </div>
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="text-align:left;">
                                            <br/>
                                            <a href="#ouvert"><img style="margin-left:20px;width: 200px;" src="images_voyance/rappele.png" /></a>
                                            <br/>
                                        </div>
                                    </td>
                                    <td>
                                        <div>
                                            <div class="media-body span9" style="margin-left:15px;margin-top:0px; height: 150px;width:100%;">
                                                <div style="text-align:right;margin-right:20px;">
                                                    <h3 style="font-weight:bold;font-family:arial black, sans-serif;line-height:1;">
                                                        <?= $voyant;?>
                                                    </h3>
                                                ...
                                                <div style="text-align:right;margin-right:20px;margin-top:10px;">
                                                    <span style="color:#000000;font-weight:bold;font-size:13px;font-family:tahoma, verdana, arial, sans-serif;"><br/>
                                                        Tarifs : 4€/MIN SUP<br/><br/>
                                                        EXPERTE TAROLOGUE
                                                    </span>
                                                </div>
                                            </div>
                                                ...
                                                <div>
                                                    ...
                                                    <div class="widget-content clearfix">
                                                        <div class="profil_cadre_block profil_cadre_block_rapide">
                                                            <div class="profil_cadre_centre" style="background-color: #fcf8e3;border: 1px solid #fbeed5;-webkit-border-radius: 4px;-moz-border-radius: 4px;border-radius: 4px;margin-left:0px;background-color: #D5D3D0;">
                                                                <form action="voyance-par-telephone.php#ouvert" method="post">
                                                                    <div style="width: 100%;text-align:left;margin-left:15px;">
                                                                        <strong><br/>
                                                                            Saisissez le numéro de téléphone sur lequel vous <br/>
                                                                    ...
                                                                    <div style="width: 100%;text-align:left;margin-left:15px;"><br/>
                                                                        Votre numéro : 
                                                                        <div class="fields">
                        ...
                        <div class="cat-widget"><br/>
                            ...
                            <div class="cat-widget-content">
                                ...
                                <div class="row-fluid split-top leave-comment">
                                    ...
                                    <p>
                                        Votre adresse de messagerie ne sera pas publiée. Les champs obligatoires sont indiqués avec <i class="bo-icon-star"></i>
                                    </p><br/>
                                    <form>
                                        <fieldset>
