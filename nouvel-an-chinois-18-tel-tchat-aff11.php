<?php
    session_start();
    $form = $url = 'nouvel-an-chinois-18-tchat-aff11';
...
?>
                        ...
                        <div class="FormContainer-Fields">
                            ...
                            <input type="hidden" name="dri" value="<?= strpos($_SESSION['ab_request_url'],'tchat') ? 'nouvel-an-chinois-18-tchat-d' : 'nouvel-an-chinois-18-dri'?>" />
