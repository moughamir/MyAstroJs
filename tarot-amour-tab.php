    	...
    	<div class="left-bottom-part">
    		 <div class="comment-ca-marche">
                ...
                <ul>
                	...
                	<li class="li3"><strong>3</strong> <span>J’accède au chat </span></li>
                	<li class="li4"><strong>4</strong> <span>Je reçois mon interprétation par mail</span></li>
                </ul>
                ...
                <aside class="widget w-adv">
                    ...
                    <div id="form-w" class="widget-content clearfix">
                        <div class="visible-part form-part form-part-one">
                            ...
                            <form id="">
                                <input type="hidden" name="source" value="tarot-amour-tab" />
