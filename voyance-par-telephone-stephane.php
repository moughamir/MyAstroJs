...
$voyant = "GIRARD STEPHANE";
$prenom = "Stephane";
$n_photo = "02";
$text_l = "P";
$text = "rofessionnel reconnu dans mon domaine, étude poussée en astro-psychologie, coach (stratégie de communication et analyste comportementale) vous serez entre de bonne main. Perspicace, sérieux, travail garanti, Tels sont les termes qui définiront notre consultation. Beaucoup de personnes me recommandent.";

$nom_com_1 ="kathleen185";
$commentaire_1 = "Stephane saisit immédiatement les caractères des personnes de façon précise et sans erreur aucune.Bravo,Stephane!De plus,il fait preuve de beaucoup de délicatesse et de gentillesse. Sa rapidité à voir les choses en fait un excellent voyant.Sa voix douce est pleine de chaleur.Quel plaisir de dialoguer avec lui.Je lui envoie mille bisous et je vous le conseille.Vous ne serez pas déçus!Continuez de la sorte,Stephane!";
$date_1 ="15 Avr 2013, 1:10 PM";

$nom_com_2 ="marye";
$commentaire_2 = "merci Stephane de m'avoir rassurée et reboostée , avec votre voix tellement apaisante , je crois dans vos paroles et vous donnerais vite de bonnes nouvelles je l'espère , je vous recommande a tout ceux qui comme moi ont besoin de réconfort et d'une vrai consultation";
$date_2 ="10 Avr 2013, 03:05 AM";

$nom_com_3 ="jessouille2410";
$commentaire_3 = "Très sympathique. J'espère que tout se passera comme vous le voyez. Bien a vous Encore merci.";
$date_3 ="03 Avr 2013, 15:33 AM";
                        ...
                        <div class="posts-in-widget">
                            <div class="row-fluid modern-items-list">
                            	<?php 
                                    ...
                                    ?>
                                        <img src="images/bannieres/VTE2/stephane.png"  alt="VOYANCE PAR TELEPHONE">
                                    <?php
                                    } else {
                                    ?>
                                    <img src="images/bannieres/voyant-skyscraper/stephane-astrologue.jpg"  alt="VOYANCE PAR TELEPHONE">
                                    <?php
                                    }
                                ?>
...
<!--<div class="rating"  style="text-align:right;margin-right:10px;" itemprop="reviewRating" itemscope="" itemtype="http://schema.org/Rating">
  ...
  <div style="text-align:right;margin-right:20px;margin-top:10px;">  
                                                                ...
                                                                <span style="color:#000000;font-weight:bold;font-size:13px;font-family:tahoma, verdana, arial, sans-serif;"><br>Tarifs : 4€/MIN SUP<br><br>VOYANT ET ASTROLOGUE</span>
...
.fermer:hover { background: #00d9ff; }
  ...
  <tr><td class="btn-voir-forfait"><div class="bloc-vf"><br><a href="http://www.myastro.fr/forfait-emeraude"><h4>VOIR LES FORFAITS</h4></a></div></td></tr>
 </table>       
