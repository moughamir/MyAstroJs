...
<head>
    <title>Compatibilité amoureuse féminine Bélier: êtes vous faits l'un pour l'autre?</title>
	<meta name="description" content="Signe Bélier :Myastro vous permet de savoir si cette personne que vous affectionnez tant est faite pour vous. Les astres vous le diront et vous pourrez ensuite prendre votre décision." />
    ...
    <div class="container-fluid" itemscope >
        ...
        <div class="row-fluid">
                            ...
                            <header>
                                <div itemscope >
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li><a href="http://<?= ROOT_URL ?>/astrologie-gratuite" >Astrologie gratuite</a><i class="icon-caret-right icon-fixed-width"></i><li><a href="http://<?= ROOT_URL ?>/compatibilite-amoureuse-feminine" >Compatibilité amoureuse féminine</a></li></li><i class="icon-caret-right icon-fixed-width"></i><li>Compatibilité amoureuse féminine Bélier</li></h4>
					...
					<div class="cat-widget-title">
                            ...
                            <h1 itemprop="headline">Compatibilité amoureuse féminine Bélier</h1>
...
<div class="row-fluid social-share-footer">
                                ...
                                <div class="share-icons">
                                    <h5 itemprop="headline">Signe Bélier :Myastro vous permet de savoir si cette personne que vous affectionnez tant est faite pour vous. Les astres vous le diront et vous pourrez ensuite prendre votre décision.</h5>
                                </div>
            ...
            <div class="span6 main-content">
                ...
                <aside class="widget w-pictures">
                    <div class="widget-title">
                        <h4>Votre Compatibilité amoureuse féminine gratuite: Bélier</h4>
...
include('lib.php');
  ...
  $xml1 = read_astrologie('belier', 'f' ,1);
 ...
 //echo $s_cle;
    ...
    if ($s_cle==='Femme Bélier - Homme Bélier')
	{
			$f1=$s_value;
  	}
	elseif ($s_cle==='Femme Bélier - Homme Taureau')
	{
			$f2=$s_value;
	}
	
	elseif ($s_cle==='Femme Bélier - Homme Gémeaux')
	{
			$f3=$s_value;
	}
	
	elseif ($s_cle==='Femme Bélier - Homme Cancer')
	{
			$f4=$s_value;
	}
	
	elseif ($s_cle==='Femme Bélier - Homme Lion')
	{
			$f5=$s_value;
	}
	
	elseif ($s_cle==='Femme Bélier - Homme Vierge')
	{
			$f6=$s_value;
	}
	
	elseif ($s_cle==='Femme Bélier - Homme Balance')
	{
			$f7=$s_value;
	}
	
	elseif ($s_cle==='Femme Bélier - Homme Scorpion')
	{
			$f8=$s_value;
	}
	
	elseif ($s_cle==='Femme Bélier - Homme Sagittaire')
	{
			$f9=$s_value;
	}
	
	elseif ($s_cle==='Femme Bélier - Homme Capricorne')
	{
			$f10=$s_value;
	}
		
	elseif ($s_cle==='Femme Bélier - Homme Verseau')
	{
			$f11=$s_value;
	}
			
	elseif ($s_cle==='Femme Bélier - Homme Poissons')
	{
			$f12=$s_value;
  ...
  ?>	
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme" data-toggle="collapse" data-parent="#accordion1"
                                                            href="#collapse1">Femme Bélier - Homme Bélier
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse2">Femme Bélier - Homme Taureau
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse3">Femme Bélier - Homme Gémeaux
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse4">Femme Bélier - Homme Cancer
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse5">Femme Bélier - Homme Lion
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse6">Femme Bélier - Homme Vierge
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse7">Femme Bélier - Homme Balance
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse8">Femme Bélier - Homme Scorpion
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse9">Femme Bélier - Homme Sagittaire
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse10">Femme Bélier - Homme Capricorne
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse11">Femme Bélier - Homme Verseau
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
	...
	?></p>
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse"
                                                            data-parent="#accordion1" href="#collapse12">Femme Bélier - Homme Poissons
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
