...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    <head>
    <title>Oracle Amour : votre tirage de cartes interprété | MyAstro</title>
...
<body class="oracle oracle-amour">
<div class="subbody">
    <div class="top-nav">
    ...
    <div class="main">
        <div class="left-part">
            ...
            <div class="content">
                <h1>Oracle de l'<strong>Amour</strong></h1>
                <div class="txt-content">
                    <p>Tirez les lames d'un Oracle spécialisé dans l'amour et obtenez des réponses pour les questions qui vous importent : m'aime-t-il/elle vraiment ? Notre union va-t-elle durer ? Vais-je trouver l'âme soeur ?</p>
                    <p>Ces réponses, un spécialiste de l'Oracle de l'Amour vous les apporte en interprétant directement votre tirage, afin de ne pas vous laissez dans l'attente.</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="paquet">
                            ...
                            <div class="title">Tirez <strong>5</strong> lames</div>
                                ...
                                for ($i = 1; $i <= 21; $i++)
                                {
                                    ...
                                    echo '<img src="images_landing/carte-oracle-amour.png" class="tarot-dos tarot-' . $i . '" data-pos="' . $datapos . '"/>';
                                }
                                ?>
                                </div>
    ...
    <div class="main bottom-part" id="secondpart">
        ...
        <div class="left-bottom-part">
             <div class="comment-ca-marche">
                ...
                <ul>
                    <li class="li1"><strong>1</strong> <span>Je tire mes cinq lames</span></li>
                ...
                <img src="images_landing/oracle-amour.jpg" width="577" height="185" alt="Oracle amour"/>
            </div>
        </div>
                ...
                <aside class="widget w-adv">
                    ...
                    <div id="form-w" class="widget-content clearfix">
                        <div class="visible-part form-part form-part-one">
                            ...
                            <form id="">
                                <input type="hidden" name="source" value="myastro-oracle-a2" />
                                ...
                                <div class="form-w-two li-form">
                                    <div>
                                        <label><img src="images_landing/ico-femme.png" alt="" width="12" height="20"/> Femme<input type="radio" name="sexe" value="femme"></label>
                                        <label><img src="images_landing/ico-homme.png" alt="" width="20" height="20"/> Homme<input type="radio" name="sexe" value="homme"></label> 
                                    </div>
                                </div>
       ...
       <script src="js/jquery-1.11.js"></script>
        <script src="js/triade.js"></script>
