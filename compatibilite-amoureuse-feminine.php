          ...
          <div class="span6 main-content">
            ...
            <aside class="widget w-pictures">
              ...
              <div class="widget-content clearfix thumbnails">
                <?php echo getHoroscopeBlock("compatibilite-femme") ?>
              </div>
            </aside>
            ...
            <aside class="widget w-adv">
              ...
              <form method="POST" action="signe.php?cat=compatibilite-amoureuse-feminine" >
                          ...
                          <ul class="items left clearfix">
                                ...
                                <article class="fold-item span12">
                                  <div class="clearfix">
                                    ...
                                    <div class="description visible-part">
                                      ...
                                      <h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Vous savez que vous l'aimez mais êtes-vous faits l'un pour l'autre? Répondez à cette question grâce à la compatibilité amoureuse gratuite que vous propose Myastro. Sachez réellement si vous et votre partenaires aurez la chance d'être compatibles à 100%</h6>
                                ...
                                <article class="fold-item span12">
                                  <div class="clearfix">
                                    ...
                                    <div class="description visible-part">
                                      ...
                                      <h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Votre amie et vous êtes éperduement amoureux et n'imaginez pas vous séparer l'un de l'autre. Le calcul de la compatibilité amoureuse pour les hommes gratuit vous donnera la possibilité, grâce à l'étude de vos horoscopes, de savoir si vous êtes aussi compatibles l'un avec l'autre</h6>
                            ...
                            <li class="row-fluid">
                                ...
                                <article class="fold-item span12">
                                  <div class="clearfix">
                                    ...
                                    <div class="description visible-part">
                                      ...
                                      <h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Votre horoscope de la semaine gratuit vous donnera une vision d'ensemble sur les jours à venir. En amour ou au travail, sachez à quoi vous attendre et préparez-vous aux éventuelles déconvenues qui pourraient surgir à tout moment le long de votre semaine.</h6>
                              ...
                              <div class="span6">
                                <article class="fold-item span12">
                                  <div class="clearfix">
                                    <img src="images_voyance/banniere/horoscope-2016.png" class="post-img" />

                                    <div class="description visible-part">
                                      <h5 class="title">Votre horoscope 2016</h5>
                                      <br>
                                      <h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">L'année 2016 n'est pas encore terminée. Avec votre horoscope 2016 gratuit, n'ayez plus aucune crainte. Vous pourrez appréhender calmement les réussites comme les échecs grâce à la lecture des informations que nous transmettent les astres.</h6>
                                ...
                                <article class="fold-item span12">
                                  <div class="clearfix">
                                    ...
                                    <div class="description visible-part">
                                      ...
                                      <br>
                                      <h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Avec un tirage de tarot quotidien gratuit, portez vos efforts sur les sujets importants de votre journée. Il y a toujours du positif dans la lecture d'un tirage de cartes de tarot et des problèmes plus importants méritent toute votre attention. Identifiez-les et traitez-les.</h6>
                                ...
                                <article class="fold-item span12">
                                  <div class="clearfix">
                                    ...
                                    <div class="description visible-part">
                                      ...
                                      <br>
                                      <h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Chaque semaine étant différente, il sera intéressant pour vous de connaître votre tirage de tarot hebdomadaire. Les différentes couleurs et séries ont chacune une signification qui s'appliquera à vous et à votre situation, lue par l'oracle qui effectue le tirage.</h6>
                                ...
                                <article class="fold-item span12">
                                  <div class="clearfix">
                                    ...
                                    <div class="description visible-part">
                                      ...
                                      <br>
                                      <h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Que va-t-il se passer ce mois-ci? Quelles sont les surprises que vous réserve votre futur? Avec le tarot mensuel, ayez une visibilité plus importante sur les faits et votre situation psychologique pour le mois à venir et adaptez votre comportement en conséquence.</h6>
                                ...
                                <article class="fold-item span12">
                                  <div class="clearfix">
                                    ...
                                    <div class="description visible-part">
                                      ...
                                      <br>
                                      <h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Des problèmes dans votre couple dont vous n'arrivez pas à déceler l'origine ni la cause? Avec le tarot de couple gratuit, obtenez toutes les informations nécessaires et ne vivez plus sans cesse dans le doute de vivre une relation défectueuse.</h6>
