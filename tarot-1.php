...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    <head>
    <title>Tarot : tirez 5 Lames et découvrez leur signification | MyAstro</title>
...
<div class="subbody">
    ...
    <div class="main">
        <div class="left-part">
            ...
            <div class="content">
                <h1>Tirage de <strong>Tarot</strong></h1>
                <div class="txt-content">
                    <p>Comptant parmi les arts divinatoires les plus prisés, le tarot vous livre des informations sur votre avenir au travers de ses lames.</p>
                    <p>5 lames tirées, et une interprétation par un expert de la divination, et vous obtiendrez des réponses à vos questions et saurez ce que votre destin vous réserve. N'hésitez donc pas à faire votre tirage !</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="paquet">
                            ...
                            <div class="title">Tirez <strong>5</strong> lames</div>
                                ...
                                for ($i = 1; $i <= 21; $i++)
                                {
                                    ...
                                    echo '<img src="images_landing/carte-tarot-general.png" class="tarot-dos tarot-' . $i . '" data-pos="' . $datapos . '"/>';
                                }
                                ?>
                                </div>
    ...
    <div class="main bottom-part" id="secondpart">
        ...
        <div class="left-bottom-part">
             <div class="comment-ca-marche">
                ...
                <img src="images_landing/tarot-general.jpg" width="577" height="180" alt="Tarot general"/>
            </div>
        </div>
                        ...
                        <div class="visible-part form-part form-part-one">
                            <?php
                                if(isset($_POST['demande_rappel']) && empty($_POST['antisp']) && !isset($_SESSION['demanderappel'])){
                                    ...
                                    $message .= "Page : http://www.myastro.fr/tarot-1\r";
