...
<body class="voyance-telephone-1 page_appel">
    <div class="top-nav">
    ...
    <div class="main">
        <div class="left-part">
            ...
            <div class="content">
                ...
                <p>Profitez d'une voyance par téléphone claire et sérieuse avec MyAstro : en échangeant avec un voyant expert, vos interrogations trouveront leur réponse en quelques instants.</p>
                <p>Les voyants sélectionnés pour notre voyance par téléphones sont à votre écoute : ne redoutez ainsi pas d'aborder les sujets qui vous importent, la confidentialité est assurée !</p>
                </div>
            </div>
        ...
        <div class="right-part">
            <div class="appel-voyante">
                ...
                <span class="offre">
                    Vos <strong>10</strong> premières minutes à <strong>1€</strong> avec le code promo <strong>ASTRO10</strong>
                </span>
            </div>
            <div class="voyant-membre">
                ...
                <div class="cols4"><img src="images_landing/voyants/anna.jpg" alt="" width="110" height="110" />Anna</div>
                <div class="cols4"><img src="images_landing/voyants/george.jpg" alt="" width="110" height="110" />George</div>
                <div class="cols4"><img src="images_landing/voyants/andre.jpg" alt="" width="110" height="110" />André</div>
                <div class="cols4"><img src="images_landing/voyants/sophie.jpg" alt="" width="110" height="110" />Sophie</div>
