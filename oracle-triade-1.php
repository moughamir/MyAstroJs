...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    <head>
    <title>Oracle de la Triade : votre tirage de cartes interprété | MyAstro</title>
...
<body class="oracle oracle-triade">
<div class="subbody">
    <div class="top-nav">
    ...
    <div class="main">
        <div class="left-part">
            ...
            <div class="content">
                <h1>Oracle de la <strong>triade</strong></h1>
                <div class="txt-content">
                    <p>L'oracle de la Triade est un art divinatoire réputé pour ses particularités. Basé sur le principe ternaire, il vous permet d'obtenir des réponses à vos questions en tirant vos cartes.</p>
                    <p>Ce tirage, nos spécialistes de l'oracle de la Triade l'interprètent et vous en apporte la signification. Toujours disponible, l'oracle de la Triade de MyAstro n'attend plus que vous...</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="paquet">
                            ...
                            <div class="title">Tirez <strong>5</strong> lames</div>
                                ...
                                for ($i = 1; $i <= 21; $i++)
                                {
                                    ...
                                    echo '<img src="images_landing/carte-oracle-triade.png" class="tarot-dos tarot-' . $i . '" data-pos="' . $datapos . '"/>';
                                }
                                ?>
                                </div>
    ...
    <div class="main bottom-part" id="secondpart">
        ...
        <div class="left-bottom-part">
             <div class="comment-ca-marche">
                ...
                <img src="images_landing/oracle-triade.jpg" width="577" height="111" alt="Oracle triade"/>
            </div>
        </div>
                ...
                <aside class="widget w-adv">
                    ...
                    <div id="form-w" class="widget-content clearfix">
                        <div class="visible-part form-part form-part-one">
                            ...
                            <form id="">
                                <input type="hidden" name="source" value="myastro-oracle-a1" />
