...
/*******************************************************************/
	$content = '<table style=>
					<tr>
						<td>
							<img src="<?= PROTOCOL.'://'.ROOT_URL ?>/images/logo_new.gif" alt="LOGO"/>
						</td>
						<td>
							Demande de Rappel.
						</td>
					...
					<tr>
						<td>
							<img src="<?= PROTOCOL.'://'.ROOT_URL ?>/images/user.png"  alt="User : " width="24"/>
						</td>
						<td>
							'. $data['user']['name'] .'
						</td>
					...
					<tr>
						<td>
							<img src="<?= PROTOCOL.'://'.ROOT_URL ?>/images/'.$gender.'.png"  alt="genre : " width="24"/>
						</td>
						<td>
							'. $gender .'
						</td>
	...
	$content .=		'<tr>
						<td>
							<img src="<?= PROTOCOL.'://'.ROOT_URL ?>/images/birthday.png"  alt="Phone : " width="24"/>
						</td>
						<td>
							'.  $data['user']['birthdate'] .'
						</td>
					...
					<tr>
						<td>
							<img src="<?= PROTOCOL.'://'.ROOT_URL ?>/images/'.$pays.'.png"  alt="'.$pays.' : " width="24"/>
						</td>
						<td>
							'.$pays.'
						</td>
	...
	$content .=		'<tr>
						<td>
							<img src="<?= PROTOCOL.'://'.ROOT_URL ?>/images/phone.png"  alt="Phone : " width="24"/>
						</td>
						<td>
							'. $phone .'
						</td>
					...
					<tr>
						<td>
							<img src="<?= PROTOCOL.'://'.ROOT_URL ?>/images/email.png"  alt="Email : " width="24"/>
						</td>
						<td>
							'. $data['user']['email'] .'
						</td>
