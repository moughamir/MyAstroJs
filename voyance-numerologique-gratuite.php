...
<head>
    ...
    <title>Votre voyance numérologique complète et gratuite</title>
                            ...
                            <header>
                                <div itemscope >
                                    <ul class="breadcrumb" itemprop="breadcrumb">
                                        ...
                                        <li>Voyance numérologique gratuite</h4></li>
                                    </ul>
                                </div>
								<div class="cat-widget-title">
									
										<h1 itemprop="headline">Voyance numérologique gratuite</h1>
...
<br>
            ...
            <aside class="widget w-sponsors">
                    <div class="widget-title">
                        <h4>CHOISISSEZ UN NUMÉROLOGUE</h4>
                    </div>
        ...
        <tbody>
				...
				<td>
					<div class="ch0r pic">
					  <a href="voyance-numerologique-gratuite-chiffres-VALERIE-06"><img src="images_voyance/voyant/06.jpg" title="VALERIE"></a>
					</div>
				</td>
				
				<td>
					<div class="ch0 pic">
					  <a href="voyance-numerologique-gratuite-chiffres-CLAUDE-12"><img src="images_voyance/voyant/12.jpg" title="CLAUDE"></a>
					</div>
				</td>
				<td>
					<div class="ch0 pic">
					  <a href="voyance-numerologique-gratuite-chiffres-HENRI-11"><img src="images_voyance/voyant/11.jpg" title="HENRI"></a>
					</div>
				</td>
