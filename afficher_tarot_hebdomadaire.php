...
<h3>Tarot hebdomadaire pour '.$prenom.'<br>'.$msg .'</h3>
	...
	<table align="center">
	<tr>
	<td><a href="afficher_tarot_hebdomadaire.php#" onclick="window.document.myform.submit();">
...
$echo.= '<br/>'.'<table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <td rowspan="4">
		<form name="myform" method="post" action="afficher_tarot_hebdomadaire.php">
	...
	if($step==5)
	{
		$echo.='<td><a href="afficher_tarot_hebdomadaire.php#" onclick="window.document.myform.submit();"><img src="'.$carte5_img.'" alt="'.$carte5_alt.'" title="'.$carte5_alt.'" border="0"></a></td>';
	}
	else
...
if((int)$prestep>4)
{
	...
	if(!((($page=='tarot.php')&&((int)$step<12))||((int)$step<11)))
	{
		$echo.='<div> 
						...
						<a href="afficher_tarot_hebdomadaire.php#" onclick="window.document.myform.step.value=\'5\'; window.document.myform.submit();">
...
$text3=substr($_SESSION['reponse'][3],8,750);
$text4=str_replace('Travail=>','',$_SESSION['reponse'][4]);
$text5=str_replace('Famille=>','',$_SESSION['reponse'][5]);
$echo.='
		</form>
	</td>
...
<div class="row-fluid">
                                        <div class="modern-accordion-container">
                                            ...
                                            <div class="accordion" id="accordion1">
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse" data-parent="#accordion4" href="#collapse4">TRAVAIL
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
												...
												<div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse" data-parent="#accordion5" href="#collapse5">SANTE
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
												...
												<div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle btn-theme collapsed" data-toggle="collapse" data-parent="#accordion6" href="#collapse6">VIE SOCIALE
                                                         <i class="icon-angle-down pull-right"></i>
                                                        </a>
                                                    </div>
...
<br><h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Les astres sont riches pour des prédictions de qualité. Chaque astre du système solaire a ses messages propres votre astrologie gratuite quotidienne vous révèle l'influence de l'un ou l'autre.</h6>
...
<br><h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Chaque année est une étape, vous pourrez vérifier chaque année ce que les signes vous réservent. Optez pour un horoscope 2013 annuel avec MyAstro.</h6>
...
<h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Votre personnalité évolue en fonction des humeurs et de votre bilan d'astrologie personnalité. Faites votre astrologie personnalité avec MyAstro.</h6>
...
<br><h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Le profil astrologique féminin tient compte d'une multitude d'éléments. MyAstro saura faire le profil personnalisé en fonction des planètes.</h6>
...
<h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Nous sommes régis par des lois cosmiques qui nous dépassent. MyAstro saura tirer votre compatibilité amoureuse avec votre partenaire.</h6>
...
<h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">La compatibilité amoureuse pour les hommes est importante et fonction de tellement d'éléments, MyAstro se charge de vous donner les principaux traits de caractère des uns et des autres pour trouver le juste.</h6>
