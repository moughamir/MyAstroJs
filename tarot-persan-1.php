...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    <head>
    <title>Tarot Persan : 5 lames pour révéler votre avenir | MyAstro</title>
...
<body class="tarot-chinois-1 tarot-persan">
<div class="subbody">
    <div class="top-nav">
    ...
    <div class="main">
        <div class="left-part">
            ...
            <div class="content">
                <h1>Tarot <strong>persan</strong></h1>
                <div class="txt-content">
                    <p>Tirez les lames de notre Tarot Persan et recevez directement par mail l'interprétation de l'un de nos médiums spécialisés dans cette forme ancienne et prisée du Tarot.</p>
                    <p>Votre couple est-il solide ? Vos rapports familiaux vont-ils évoluer ? Votre carrière va-t-elle changer ? Quelle que soit la question que vous vous posez, avec notre Tarot Persan, vous pourrez obtenir une réponse honnête.</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="paquet">
                            ...
                            <div class="title">Tirez <strong>5</strong> lames</div>
                                ...
                                for ($i = 1; $i <= 21; $i++)
                                {
                                    ...
                                    echo '<img src="images_landing/carte-persan.png" class="tarot-dos tarot-' . $i . '" data-pos="' . $datapos . '"/>';
                                }
                                ?>
                                </div>
    ...
    <div class="main bottom-part" id="secondpart">
        ...
        <div class="left-bottom-part">
             <div class="comment-ca-marche">
                ...
                <img src="images_landing/tarot-persan.jpg" width="577" height="111" alt="Tarot Persan"/>
            </div>
        </div>
                ...
                <aside class="widget w-adv">
                    ...
                    <div id="form-w" class="widget-content clearfix">
                        <div class="visible-part form-part form-part-one">
                            ...
                            <form id="">
                                <input type="hidden" name="source" value="myastro-tarot-a7" />
       ...
       <script src="js/jquery-1.11.js"></script>
        <script src="js/persan.js"></script>
