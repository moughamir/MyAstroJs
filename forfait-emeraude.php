...
<head>
    <title>Tarifs Forfait emeraude - Myastro</title>
...
function prixForfait(){
    ...
    /* les élements des tableaux doivent correspondre forfait => prix */
    /*var prix = [185.00,350.00,490.00,600.00];*/
    var prix = 175.00;
    var detail = "Forfait 50 min EMERAUDE";
...
function offreAbo(abo){
    ...
    /* les élements des tableaux doivent correspondre forfait => prix(code) */
    var codes = ["F3B765E8DB904E4","2632FF2BCE28159","52DA3D954633702"];
    var detail = ["Abonnement offre1 EMERAUDE","Abonnement offre2 EMERAUDE","Abonnement offre3 EMERAUDE"];
...
function methodePay(mth){
    ...
    /* les élements des tableaux doivent correspondre forfait => prix */
    var prix = [350.00,450.00,600.00];
    var detail = ["Forfait 100 min EMERAUDE","Forfait 150 min EMERAUDE","Forfait 200 min EMERAUDE"];
                    ...
                    <div class="bloc-forfait-abonnement">
                        ...
                        <div class="bloc-forfait">
                            ...
                            <div class ="text-forfait">
                                ...
                                <p>Profitez de tarifs dégressifs grâce au forfait <span class="frt-name">emeraude</span> avec votre voyant ! <br> Fixez vous du temps selon votre budget !
                            ...
                            <div class="forfait-name">
                                <img src="images/abonnement/emeraude/emeraude.png">
                            </div>
                            <div class="forfait-name forfait-secure">
                                <img src="images/abonnement/paiement-securise.png"/>
                            </div>
                            <div class="tarifs-min">
                                <ul>
                                    <li><span class="txt-nb-min">&nbsp;&nbsp;50 min</span> <span class="pts-pts">............</span> 175<sup>€</sup>&nbsp;&nbsp;&nbsp;
                                        <span class="prix-ini">200<sup>€</sup></span>
                                    </li>
                                    <li ><span class="txt-nb-min">100 min</span> <span class="pts-pts">............</span> 350<sup>€</sup>&nbsp;&nbsp;&nbsp;
                                        <span class="prix-ini">400<sup>€</sup></span>
                                    </li>
                                    <li><span class="txt-nb-min">150 min</span> <span class="pts-pts">............ </span>450<sup>€</sup>&nbsp;&nbsp;&nbsp;
                                        <span class="prix-ini">600<sup>€</sup></span>
                                    </li>
                                    <li><span class="txt-nb-min">200 min</span> <span class="pts-pts">............</span> 600<sup>€</sup>&nbsp;&nbsp;&nbsp;
                                        <span class="prix-ini">800<sup>€</sup></span>
                                    </li>
                                </ul>   
                            </div> 
                        ...
                        <div class="bloc-abonnement">
                            ...
                            <div class ="text-abonnement">
                                ...
                                <p> <span class="abo-cgu">Abonnement avec un engagement sur 12 mois en profitant de tarifs exceptionnels:<br>
                                    Abonnement mensuel d'une durée d'un an avec un voyant de la gamme <span class="frt-name">emeraude</span> de votre choix.</span></p>
                            </div>
                            <div class ="offres offre1"><img src="images/abonnement/emeraude/emeraude-offre1.png"><a href="#ouvert" onclick="offreAbo(0)"><img class="btn-cmd" src="images/abonnement/commander.png"></a>
                            </div>
                            <div class ="offres offre2"><a href="#ouvert" onclick="offreAbo(1)"><img class="btn-cmd" src="images/abonnement/commander.png"></a><img src="images/abonnement/emeraude/emeraude-offre2.png">
                            </div>
                            <div class ="offres offre3"><img src="images/abonnement/emeraude/emeraude-offre3.png"><a href="#ouvert" onclick="offreAbo(2)"><img class="btn-cmd" src="images/abonnement/commander.png"></a>
                            </div>
                        </div>
                    <div>
