...
$.extend($.validator, {
	...
	messages: {
		...
		url: "S'il vous plaît entrer une adresse email valide.",
		...
		digits: "S'il vous plaît entrer un numéro valide.",
		creditcard: "S'il vous plaît entrer un numéro de carte de crédit valide.",
		equalTo: "S'il vous plaît entrez la même valeur à nouveau.",
		accept: "S'il vous plaît entrer une valeur avec une extension valide.",
		maxlength: $.validator.format("S'il vous plaît entrer plus que {0} caractères."),
	...
	methods: {
		...
		var bits = value.match(/([0-9]+)/gi), value;
            if (!bits)
                return this.optional(element) || false;
            value = bits[1] + '/' + bits[0] + '/' + bits[2];
