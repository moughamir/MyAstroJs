    ...
    <div class="main">
        <div class="left-part">
            ...
            <div class="content">
                ...
                <p>Vous voulez savoir ce que votre avenir à deux vous réserve ? Profitez d'une question de voyance gratuite pour découvrir si vous êtes faits l'un pour l'autre</p>
            ...
            <div class="comment-ca-marche">
                ...
                <div class="cols-3 middle" style="height:35px;">
                    J’accède au chat 
                </div>
                ...
                <aside class="widget w-adv">
                    ...
                    <div id="form-w" class="widget-content clearfix">
                        <div class="visible-part form-part form-part-one">
                            ...
                            <form id="">
                                <input type="hidden" name="source" value="voyance-amour-tab" />
                                ...
                                <div>
                                    <input class="btn_button btn-full-one" type="submit" name="valider" value="J'ACCEDE AU CHAT" >
                                </div>
                            </form>
                        </div>
                        <div>
