        ...
        <header>
          ...
          <div class="row-fluid social-share-footer">
            ...
            <div class="share-icons">
              <h5 itemprop="headline">Grâce à Myastro et votre horoscope au masculin, définissez avec précision votre profil astrologique et tirez-en les conclusions qui s'imposent. Prenez ensuite les bonnes décisions en toute tranquilité.</h5>
            </div>
          ...
          <div class="span6 main-content">
            ...
            <aside class="widget w-pictures">
              ...
              <div class="widget-content clearfix thumbnails">
                <?php echo getHoroscopeBlock("portrait-homme") ?>
              </div>
            </aside>
            ...
            <aside class="widget w-adv">
              ...
              <form method="POST" action="signe.php?cat=portrait-astrologique-masculin" >
                                ...
                                <article class="fold-item span12">
                                  <div class="clearfix">
                                    ...
                                    <div class="description visible-part">
                                      ...
                                      <h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">MyAstro vous permet de réaliser la compatibilité amoureuse avec votre partenaire de façon gratuite. C'est très important car cela permet notamment de faire des arbitrages sur ce qui est acceptable ou non dans vos relations.</h6>
                                ...
                                <article class="fold-item span12">
                                  <div class="clearfix">
                                    ...
                                    <div class="description visible-part">
                                      ...
                                      <h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">L'horoscope basé sur la position des planètes vous donne les grandes orientations de votre semaine. Une étude plus précise peut être réalisée avec les astrologues de MyAstro mais votre horoscope de la semaine peut être compulsé gratuitement. Il est toujours confortable d'être avisé avant que les choses ne nous prennent au dépourvu.</h6>
                                ...
                                <article class="fold-item span12">
                                  <div class="clearfix">
                                    ...
                                    <div class="description visible-part">
                                      ...
                                      <br>
                                      <h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Moins communément utilisé par les hommes, votre tirage astrologique quotidien gratuit peut être mis à profit pour déjouer les pièges nombreux de la vie. C'est simple d'utilisation et s'ils ne l'avouent pas, les hommes sont de plus en plus nombreux à l'utiliser quotidiennement.</h6>
                                ...
                                <article class="fold-item span12">
                                  <div class="clearfix">
                                    ...
                                    <div class="description visible-part">
                                      ...
                                      <br>
                                      <h6 style="line-height:120%;margin-top:20px;text-align: justify;color:#ffffff;">Le tirage d'un tarot mensuel pour un homme est signe d'un intérêt pour son avenir. MyAstro met à disposition ce type de tirage gratuit. Il permet de capter des bribes de l'avenir et de préparer sa "riposte" car il commence son anticipation. L'astrologie, le tarot sont autant d'outils pour soulever un coin du voile.</h6>
