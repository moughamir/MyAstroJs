...
$questionConjoint = array('question_2','question_24','question_22','question_23','question_12','question_11','question_10');
$needConjoint     = false;
...
$source           = (isset($_POST['source'])) ? $_POST['source'] : 'myastro-astrologie';
	    ...
	    *================================================== */
	    ...
	    $params = array(
	             /*   'emv_tag'           => '10040002651C8CC1',
	                ...
	                'EMVADMIN2'   => $horoscope, // Set a true par default. Demande de steeve. Opt-in malgré eux.
	                'EMVADMIN3'   => $partenaire,
	                'DATEOFBIRTH' => $datean1,
	                'SEED3'		=> $signe,
	                'FIRSTNAME'   => $prenom,
	                'TITLE'       => $sexe,
	                'GROUPE_FLAG'   => $flagCompteur['flag5'],
                  	'GROUPE_FLAG'   => $flagCompteur['flag7'],
                  	'GROUPE_FLAG'  => $flagCompteur['flag15'],
                  	'GROUPE_FLAG'  => $flagCompteur['flag30']
	    );
...
<head>
    <title>Inscription Astrologique gratuite : apprenez-en plus sur votre futur avec Myastro</title>
	<meta name="description" content="Recevez votre étude Astrologique gratuite rapide et personnalisée." />
            ...
            <div class="article-content">
            	<header>
					...
					<div class="cat-widget-title">
						<h1 itemprop="headline">Inscription voyance astrologique gratuite</h1>			
					</div>
                		...
                		<aside class="widget w-sponsors">
							<section class="span270">
								<div class="widget-title">
                        			<h4>Votre Astrologue</h4>
                				</div>
                				<div class="widget-content clearfix">
					  				<img src="images_voyance/voyant/<?php echo $ch; ?>.jpg" alt="coeur">
                 				</div>
				 				<div style="text-align:center;">
				 					<div style="margin-left:0px;font-size:12px;padding-top:10px;">
				 						<?php echo $vt; ?>
										...
										<br>
			  							<p>
			    							<input style="font-size:9px;height: 10px;" type="checkbox" name="horoscope" checked="checked" />
			    								...
			    								<br />
			    								<a onClick="window.open(this.href);return false;" href="conditions-generale" >
			    									<font style="font-size:9px;color:red;">Condition générale et désabonnement.</font></a> 
			    									<br /><span class="p_rens_sup_mini rose">
			    									<font style="font-size:9px;">Tous les Champs sont obligatoires.</span> 
			    									<br />
							...
							<section class="span300" style="margin-left:2.564102564102564%;">
				 			...
				 			<div class="span6 main-content">
								<div class="widget-title">
                        			<h4>Pour recevoir votre étude Astrologique gratuite, remplissez le formulaire</h4>
                				</div>
								<div class="widget-content clearfix" style="padding:15px;background-color: #f90;background-image: -webkit-gradient(linear, 0 0, 100% 0, color-stop(.5, rgba(255, 255, 255, .2)), color-stop(.5, transparent), to(transparent));background-image: -webkit-linear-gradient(0deg, rgba(255, 255, 255, .2) 50%, transparent 50%, transparent);background-image: -moz-linear-gradient(0deg, rgba(255, 255, 255, .2) 50%, transparent 50%, transparent);background-image: -ms-linear-gradient(0deg, rgba(255, 255, 255, .2) 50%, transparent 50%, transparent);background-image: -o-linear-gradient(0deg, rgba(255, 255, 255, .2) 50%, transparent 50%, transparent);background-image: linear-gradient(0deg, rgba(255, 255, 255, .2) 50%, transparent 50%, transparent);margin: 10px;-webkit-background-size: 50px 50px;-moz-background-size: 50px 50px;background-size: 50px 50px;-moz-box-shadow: 1px 1px 8px gray;-webkit-box-shadow: 1px 1px 8px gray;box-shadow: 1px 1px 8px gray;}">
