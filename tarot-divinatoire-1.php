...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    <head>
    <title>Tarot divinatoire : nos experts interprètent votre tirage | Myastro</title>
...
<body class="tarot-divinatoire-1">
<div class="subbody">
    <div class="top-nav">
    ...
    <div class="main">
        <div class="left-part">
            ...
            <div class="content">
                <h1>Tarot <strong>divinatoire</strong></h1>
                <div class="txt-content">
                <p>Vous vous interrogez sur votre avenir ? Sur ce que vous réserve la journée de demain ou l'année à venir ? Avec le tarot divinatoire de MyAstro, dissipez vos doutes en laissant parler les lames.</p>
                <p>Et pour une divination claire et précise, nos spécialistes interprètent votre tirage et vous révèlent ce que les figures signifient, pour un tarot divinatoire honnête.</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="paquet">
                            ...
                            <div class="title">Tirez <strong>5</strong> lames</div>
                                ...
                                for ($i = 1; $i <= 21; $i++)
                                {
                                    ...
                                    echo '<img src="images_landing/carte-tarot-divinatoire.png" class="tarot-dos tarot-' . $i . '" data-pos="' . $datapos . '"/>';
                                }
                                ?>
                                </div>
                ...
                <aside class="widget w-adv">
                    ...
                    <div id="form-w" class="widget-content clearfix">
                        <div class="visible-part form-part form-part-one">
                            ...
                            <form id="">
                                <input type="hidden" name="source" value="myastro-tarot-a3" />
