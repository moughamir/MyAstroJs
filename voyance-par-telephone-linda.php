...
$voyant = "Sherbatski Linda";
$prenom = "linda";
$n_photo = "15";
$text_l = "M";
$text = "édium de naissance mais aussi Numérologue par passion, Mes dons découverts à l’âge de 16 ans sont héréditaires.Grâce à mes dons de voyance, je peux vous éclairer dans votre vie affective, votre vie professionnelle, votre vie de famille, votre patrimoine.";

$nom_com_1 ="Lebonheur49";
$commentaire_1 = "J y croyais plus jusqu a qu linda prenne le temps de m ecouter et de me guider a travers ses flashs, aujourdhui je suis epanouie je te remercirai jamais assez linda … foncez la verité est avec linda";
$date_1 ="19 Avr 2013, 14:16 PM";

$nom_com_2 ="Binocledu 72";
$commentaire_2 = "Tres interessant , tres prometteurs pour mon avenir , linda merci ";
$date_2 ="30 Jan 2013, 02:50 AM";

$nom_com_3 ="Kathy1986";
$commentaire_3 = "Tu m as ouvert les yeux, tu m as permis d avancer , j ai adorer partager avec toi , je te rappel semaine prochaine pour l evolution . merci linda ";
                        ...
                        <div class="posts-in-widget">
                            <div class="row-fluid modern-items-list">
                            	<?php 
                                    ...
                                    ?>
                                        <img src="images/bannieres/VTE2/linda.png"  alt="VOYANCE PAR TELEPHONE">
                                    <?php
                                    } else {
                                    ?>
                                    <img src="images/bannieres/voyant-skyscraper/linda-numerologue.jpg"  alt="VOYANCE PAR TELEPHONE">
                                    <?php
                                    }
                                ?>
  ...
  <tr>
    <td> 
                                                        ...
                                                        <div style="margin-top:0px;">
                                                            <img src="images/voyants/linda.png"  class="imgtelvr">
                                                        </div>
...
<!--<div class="rating"  style="text-align:right;margin-right:10px;" itemprop="reviewRating" itemscope="" itemtype="http://schema.org/Rating">
  ...
  <div style="text-align:right;margin-right:20px;margin-top:10px;">  
                                                                ...
                                                                <span style="color:#000000;font-weight:bold;font-size:13px;font-family:tahoma, verdana, arial, sans-serif;"><br>Tarifs : 5,5€/MIN SUP<br><br>NUMEROLOGUE</span>
