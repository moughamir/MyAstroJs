...
$voyant = "PAVYS CAROLINE";
$prenom = "Caroline";
$n_photo = "07";
$text_l = "A";
$text = "strologue confirmée et reconnue, passionnée et spécialiste des astres et de leur influence, je saurai vous dévoiler point par point ce que les planètes vous réservent. L'utilisation du pendule apporte une touche rayonnante à mon travail. Pour une consultation lumineuse avec une étoile montante de la voyance.";

$nom_com_1 ="jessouille215";
$commentaire_1 = "Toujours constante, sympathique et rassurante. J'espère que les choses finiront par rentrer dans l'ordre et qu'il reviendra vers moi comme vous le voyez. Merci bien a vous";
$date_1 ="13 Jui 2013, 09:00 PM";

$nom_com_2 ="Ocean85";
$commentaire_2 = "Je t'ai envoyé un Mp Merci pour notre consultation passée qui m'avait bc aidée maintenant j'ai de nouveau besoin de tes conseils Tu es quelqu'un d'extraordinaire et humaine Merci pour ta réponse .tu es son ange";
$date_2 ="1 Mar 2013, 15:20 PM";

$nom_com_3 ="losangel2013";
$commentaire_3 = "D'énormes BISOUS pour vous caroline , vous les méritez amplement tellement vous êtes formidable ! Je ne mesurerais pas mes propos en vous disant que je vous adore , MERCI MILLE FOIS ! Cette consultation écrite est encore très empreinte de faits à venir mais très explicite à tout point de vue car vous ajoutez votre point de vue personnel pour rendre celle ci plus compréhensible , ce que j'apprécie ce qui montre votre engagement et toute la sincérité que vous mettez au service de vos clients.BIZ +++";
$date_3 ="14 Jan 2013, 5:55 PM";
                        ...
                        <div class="posts-in-widget">
                            <div class="row-fluid modern-items-list">
                                <?php if(isset($_SERVER['HTTP_REFERER']) && $_SERVER['HTTP_REFERER'] == 'http://'.ROOT_URL.'/voyance-par-telephone-2'){?>
                                    <img src="images/bannieres/VTE2/caroline.png"  alt="VOYANCE PAR TELEPHONE" />
                                <?php } else { ?>
                                    <img src="images/bannieres/voyant-skyscraper/caroline-voyante.jpg" alt="VOYANCE PAR TELEPHONE" />
                                <?php } ?>
                            </div>
                        </div>
                    </div>
...
<!--<div class="rating"  style="text-align:right;margin-right:10px;" itemprop="reviewRating" itemscope="" itemtype="http://schema.org/Rating">
  ...
  <div style="text-align:right;margin-right:20px;margin-top:10px;">  
                                                                ...
                                                                <span style="color:#000000;font-weight:bold;font-size:13px;font-family:tahoma, verdana, arial, sans-serif;"><br>Tarifs : 6,5€/MIN SUP<br><br>VOYANTE ET ASTROLOGUE</span>
