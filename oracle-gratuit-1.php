...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    <head>
    <title>Oracle Gratuit : votre tirage de cartes interprété | MyAstro</title>
...
<body class="oracle oracle-gratuit">
<div class="subbody">
    <div class="top-nav">
    ...
    <div class="main">
        <div class="left-part">
            ...
            <div class="content">
                <h1>Oracle <strong>gratuit</strong></h1>
                <div class="txt-content">
                    <p>Vous vous demandez ce que votre avenir vous réserve ? Avec notre Oracle gratuit, obtenez toutes les réponses qui comptent pour vous.</p>
                    <p>Que vous recherchiez une information sur votre avenir professionnel ou souhaitiez savoir si votre couple va tenir, nos experts se tiennent à votre disposition pour interpréter le tirage de votre Oracle gratuit.</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="paquet">
                            ...
                            <div class="title">Tirez <strong>5</strong> lames</div>
                                ...
                                for ($i = 1; $i <= 21; $i++)
                                {
                                    ...
                                    echo '<img src="images_landing/carte-oracle-gratuit.png" class="tarot-dos tarot-' . $i . '" data-pos="' . $datapos . '"/>';
                                }
                                ?>
                                </div>
    ...
    <div class="main bottom-part" id="secondpart">
        ...
        <div class="left-bottom-part">
             <div class="comment-ca-marche">
                ...
                <img src="images_landing/oracle-gratuit.jpg" width="577" height="111" alt="Oracle belline"/>
            </div>
        </div>
                ...
                <aside class="widget w-adv">
                    ...
                    <div id="form-w" class="widget-content clearfix">
                        <div class="visible-part form-part form-part-one">
                            ...
                            <form id="">
                                <input type="hidden" name="source" value="myastro-oracle-a7" />
