    	...
    	<div class="left-bottom-part">
    		 <div class="comment-ca-marche">
                ...
                <ul>
                	...
                	<li class="li3"><strong>3</strong> <span>Un voyant me répond immédiatement par tchat </span></li>
                ...
                <aside class="widget w-adv">
                    ...
                    <div id="form-w" class="widget-content clearfix">
                        <div class="visible-part form-part form-part-one">
                            ...
                            <form id="">
                                <input type="hidden" name="source" value="tarot-amour-vps" />
                               ...
                               <div class="form-w-three li-form">
                                ...
                                <div class="form-w-two li-form radio-theme">
                                    <div>
                                        <label>Thème de la question : vous êtes</label>
                                        <label class="sublabel">En couple<input type="radio" name="theme_id" value="question_2"></label>
                                        <label class="sublabel">Séparés<input type="radio" name="theme_id" value="question_11"></label> 
                                        <label class="sublabel">Amants<input type="radio" name="theme_id" value="question_24"></label> 
                                    </div>
                                </div>
                                ...
                                <div>
                                    <input class="btn_button btn-full-one" type="submit" name="valider" value="J'accède au tchat" >
                                </div>
                            </form>
                        </div>
                        <div>
