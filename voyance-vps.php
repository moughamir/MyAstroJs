...
<body class="voyance-gratuite-1">
                ...
                <aside class="widget w-adv">
                    ...
                    <div id="form-w" class="widget-content clearfix">
                        <div class="visible-part form-part form-part-one">
                            ...
                            <form id="">
                                <input type="hidden" name="source" value="voyance-vps" />
                                <input type="hidden" name="method" value="voyance-landing" />
                                <input type="hidden" name="dri" value="http://www.myastro.fr/dri-8" />
                               ...
                               <div class="form-w-three li-form">
                                ...
                                <div>
                                    <img class="valider" style="cursor:pointer;" src="http://tool.we-gclic.com/gclic/image/EHT8wz" />
                                    <input class="btn_button btn-full-one hidden" type="submit" name="valider" value="Je valide" >
                                </div>
                            </form>
                        </div>
                        <div>
    ...
    <!-- valider du formulaire au click sur le boutton image -->
    <script type="text/javascript">
       $(document).ready(function(){
             jQuery(document).on('click','.valider',function(e){
                jQuery(".btn_button").click();
            });
        });
    </script>
