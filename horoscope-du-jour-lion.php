<?php
    ...
    $xml1 = read_horoscope_rss('https://www.asiaflash.com/horoscope/rss_horojour_lion.xml');
    $ac_result = array();
                    ...
                    <header>
                        ...
                        <div class="row-fluid social-share-footer">
                            ...
                            <div class="share-icons">
                                <p itemprop="headline">Qui a dit que l’avenir devait nécessairement être effrayant ? Pour que vous puissiez débuter cette nouvelle année <?= $annee;?> sous les meilleurs auspices, l’horoscope du jour lion est à découvrir sans attendre.</p>
                            </div>
                        </div>
                    </header>
