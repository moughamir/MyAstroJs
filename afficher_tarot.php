...
<h3>Tarot quotidien  du '.$date.' pour '.$prenom.' '.$msg .'</h3>
	...
	<table align="center">
	<tr>
	<td><a href="afficher_tarot.php#" onclick="window.document.myform.submit();">
...
$echo.= '<br/>'.'<table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <td rowspan="4">
		<form name="myform" method="post" action="afficher_tarot.php">
	...
	if($step==5)
	{
		$echo.='<td><a href="afficher_tarot.php#" onclick="window.document.myform.submit();"><img src="'.$carte5_img.'" alt="'.$carte5_alt.'" title="'.$carte5_alt.'" border="0"></a></td>';
	}
	else
...
if((int)$prestep>4)
{
	...
	if(!((($page=='tarot.php')&&((int)$step<12))||((int)$step<11)))
	{
		$echo.='<div> 
						...
						<a href="afficher_tarot.php#" onclick="window.document.myform.step.value=\'5\'; window.document.myform.submit();">
