...
$voyant = "SARRUT GEORGES";
$prenom = "Georges";
$n_photo = "09";
$text_l = "V";
$text = "ous pensez que le bonheur n'est pas pour vous ? Que rien de bien ne peut vous arriver ? Détrompez-vous ! Avec les bonnes prévisions et mon savoir-faire, je rendrai votre chemin plus lumineux ! je suis a votre disponibilité grâce a mon don de voyance je saurai vous éclairer";

$nom_com_1 ="wonderwoman";
$commentaire_1 = "Retour +++++ pour toi ! Ce que tu m as prédit., s est produit. À quelques détails près... J attend la suite des événements! ;-) en espérant pouvoir te faire confiance à nouveau. Tu as toujours tout vu jusqu.à présent pour moi! N hésitez pas à contacter ! Il vous guidera sur la bonne route à prendre. ;-).Un très grand merci . Clair et honnête . À bientôt";
$date_1 ="10 Mar 2013, 01:00 PM";

$nom_com_2 ="viriri";
$commentaire_2 = "un expert deu debut a la fin , tu m as predit beaucoup de choses qu elles soient bonne a entendre ou non mais au moins aujourdhui je sais comment avancer et grace a toi , de nouvelles portes se sont ouvertes.";
$date_2 ="19 Jan 2013, 1:20 PM";

$nom_com_3 ="cathycat83";
$commentaire_3 = "Comment ne pas laisser un commentaire rempli d'éloges à ton sujet .Excellente interprétation de ce que tu vois dans mon futur, toujours dans le juste. Beaucoup d'intelligence dans tes conseils pour passer les moments un peu plus délicat, coaching professionnel très efficace car ça donne des sacrés résultats. Merci de croire en moi dans ce nouveau projet, je te tiendrai au courant et comme tu me le confirmes: ça va marcher du tonnerre! Alors j'ai confiance et pour ça je te crois aussi!";
$date_3 ="2 Jan 2013, 7:00 AM";
                        ...
                        <div class="posts-in-widget">
                            <div class="row-fluid modern-items-list">
                                <?php 
                                    ...
                                    ?>
                                        <img src="images/bannieres/VTE2/georges.png"  alt="VOYANCE PAR TELEPHONE">
                                    <?php
                                    } else {
                                    ?>
                                    <img src="images/bannieres/voyant-skyscraper/georges-voyant-pur.jpg"  alt="VOYANCE PAR TELEPHONE">
                                    <?php
                                    }
                                ?>
...
<!--<div class="rating"  style="text-align:right;margin-right:10px;" itemprop="reviewRating" itemscope="" itemtype="http://schema.org/Rating">
  ...
  <div style="text-align:right;margin-right:20px;margin-top:10px;">  
                                                                ...
                                                                <span style="color:#000000;font-weight:bold;font-size:13px;font-family:tahoma, verdana, arial, sans-serif;"><br>Tarifs : 5,5€/MIN SUP<br><br>VOYANT PUR</span>
...
.fermer:hover { background: #00d9ff; }
  ...
  <tr><td class="btn-voir-forfait"><div class="bloc-vf"><br><a href="http://www.myastro.fr/forfait-saphir"><h4>VOIR LES FORFAITS</h4></a></div></td></tr>
 </table>       
