$(document).ready(function(){
	var cards 			= new Array("b1.png","b2.png","b3.png","b4.png","b5.png","b6.png","b7.png","b8.png","b9.png","b10.png","b11.png","b12.png","b13.png","b14.png","b15.png","b16.png","b17.png","b18.png");
	...
	$('.paquet img').on('click',function(){
		...
		if(!$(this).data('hasBeenClicked') && alreadyPicked < 5){
			...
			$(this).attr('src','http://www.myastro.fr/tarot/cartes/belline/'+picked);
