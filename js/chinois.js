$(document).ready(function(){
	var cards 			= new Array("c1.png","c2.png","c3.png","c4.png","c5.png","c6.png","c7.png","c8.png","c9.png","c10.png","c11.png","c12.png"
								,"c13.png","c14.png","c15.png","c16.png","c17.png","c18.png","c19.png","c20.png","c21.png","c22.png","c23.png"
								,"c24.png","c25.png");
	...
	$('.paquet img').on('click',function(){
		...
		if(!$(this).data('hasBeenClicked') && alreadyPicked < 5){
			...
			$(this).attr('src','http://www.myastro.fr/tarot/cartes/chinois/'+picked);
