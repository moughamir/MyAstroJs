...
$(document).ready(function() {
    ...
    questions = {
        'amour': "{'code':'pdt_amour','subject':'sentimental','text':'Pouvoir des Trois - Amour'}",
        'argent': "{'code':'pdt_argent','subject':'financier','text':'Pouvoir des Trois - Argent'}",
        'travail': "{'code':'pdt_travail','subject':'professionnel','text':'Pouvoir des Trois - Travail'}"
    };
    choice = $('.choice'),
    holder = $('.result'),
