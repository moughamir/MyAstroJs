                            ...
                            <div class="FormContainer-Fields Fields-Table">
                                ...
                                <div class="Fields-Table-Row gender">
                                    ...
                                    <div class="FormField radio">
                                        <div class="FormField-TableInputContainer gender">
                                            <div class="FormField-TableInputContainer-Cell">
                                                <input type="radio" name="sexe" value="femme-Mme" id="sexe-f1" class="FormField-Input" />
                                                <label for="sexe-f1" class="FormField-Label "><span class="radio">Mme</span></label>
                                            </div>
                                            <div class="FormField-TableInputContainer-Cell">
                                                <input type="radio" name="sexe" value="femme-Melle" id="sexe-f2" class="FormField-Input" />
                                                <label for="sexe-f2" class="FormField-Label "><span class="radio">Melle</span></label>
                                            </div>
                                            <div class="FormField-TableInputContainer-Cell">
                                                <input type="radio" name="sexe" value="homme" id="sexe-h" class="FormField-Input" />
                                                <label for="sexe-h" class="FormField-Label"><span class="radio"></span>Mr</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="Fields-Table-Row">
                                    ...
                                    <div class="FormField">
                                        <input type="text" id="name" name="prenom" class="FormField-Input" value="<?= $prenom ?>" placeholder="Mon Prénom"/>
                                    </div>
                                </div>
                                <div class="Fields-Table-Row">
                                ...
                                <div class="Fields-Table-Row sonprenom" style="display: none;">
                                    ...
                                    <div class="FormField">
                                        <input type="text" id="son_prenom" name="conjoint" class="FormField-Input" placeholder="Son prénom uniquement!"/>
                                    </div>
                                </div>
                                <div class="Fields-Table-Row">
                                    <label for="email" class="FormField-Label">Votre email</label>
                                    <div class="FormField">
                                        <input id="email" type="email" name="email" class="FormField-Input" value="<?= $email ?>" placeholder="mon@email.com" required />
                                    </div>
                                </div>
                                <div class="Fields-Table-Row">
                                ...
                                <div class="Fields-Table-Row">
                                    ...
                                    <div class="FormField">
                                        <input id="tel" type="tel" name="tel" class="FormField-Input" placeholder="Faculatif"/>
                                    </div>
                                </div>
                                <div class="Fields-Table-Row">
                                ...
                                <div class="Fields-Table-Row">
                                    <div class="FormField checkbox">
                                        <div class="FormField-TableInputContainer">
                                            <div class="FormField-TableInputContainer">
                                                <input type="checkbox" name="cguv" value="1" id="privacy" class="FormField-Input" />
                                                <label for="privacy" class="FormField-Label "><span class="checkbox">Je souhaite que mes informations restent confidentielles.</span></label>
                                            </div>
                                            <div class="FormField-TableInputContainer">
                                                <input type="checkbox" name="partenaires" value="1" id="parteners" class="FormField-Input" />
                                                <label for="parteners" class="FormField-Label "><span class="checkbox">Je souhaite recevoir les offres de partenaires. (conditions et désinscription)</span></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
