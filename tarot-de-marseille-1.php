...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    <head>
    <title>Tarot de Marseille : des réponses à chaque tirage | Myastro</title>
...
<div class="subbody">
    ...
    <div class="main">
        <div class="left-part">
            ...
            <div class="content">
                <h1>Tarot de <strong>marseille</strong></h1>
                <div class="txt-content">
                <p>Besoin de réponses ? Tirez vos lames et laissez les enseignes du tarot de Marseille vous révéler ce que votre avenir vous réserve. Amour, argent, famille, rien n'est tabou lorsqu'il s'agit de répondre à d'importantes questions.</p>
                <p>Une fois vos lames tirées, nos experts dans les arts divinatoires vous font part de leur interprétation, afin de mettre des mots sur votre tarot de Marseille, et ainsi vous apporter ce que vous êtes venu chercher.</p>
                        ...
                        <div class="paquet">
                            ...
                            <div class="title">Tirez <strong>5</strong> lames</div>
                                ...
                                for ($i = 1; $i <= 21; $i++)
                                {
                                    ...
                                    echo '<img src="images_landing/carte-marseille.png" class="tarot-dos tarot-' . $i . '" data-pos="' . $datapos . '"/>';
                                }
                                ?>
                                </div>
