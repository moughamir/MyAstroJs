	...
	<div class="main">
            <div class="right-part right-part-merci">
                <div class="container-fluid text-center top-header">
                    <div class="row">
                        <div class="col-lg-12">
                            <img class="img-responsive" src="images_landing/logo-dri3.png" alt="MyAstro" />
			</div>
                    </div>
			</div>
			<div class="container-fluid header-container">
				<div class="row">
					<p>
						...
						<span class="header-txt-4"><img class="img-responsive" src="images_landing/tarif-min-dri3.png" alt="MyAstro"></span>
					</p>
				</div>
			</div>
			<div class="container-fluid content-container">
				<div class="row">
					<aside class="widget" id="form-merci-voyance">
						...
						<div id="" class="widget-content col-xs-12 col-sm-12 col-lg-6">
							<img class="img-promo" src="images_landing/promo-dri3.png">
				...
				<div class="row row-voyant">
					<div class="voyant-membre voyant-merci-voyance">  
						<div class="cols4 mg-right"><img src="images_landing/voyants/marc.png" alt="" width="178" height="128" />M<span>arc</span><br/></div>
						<div class="cols4 mg-right"><img src="images_landing/voyants/aline.png" alt="" width="178" height="128" />A<span>line</span><br/></div>
						<div class="cols4 mg-right"><img src="images_landing/voyants/francis.png" alt="" width="178" height="128" />F<span>rancis</span><br/></div>
						<div class="cols4"><img src="images_landing/voyants/benedicte.png" alt="" width="178" height="128" />B<span>énédicte</span><br/></div>
					</div>
				</div>
			</div>
		</div>
