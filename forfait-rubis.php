...
<head>
    <title>Tarifs Forfait rubis - Myastro</title>
...
function prixForfait(offre){
    ...
    var prix = 200.00;
    var detail = "Forfait 50 min RUBIS";
...
function offreAbo(abo){
    ...
    var codes = ["1E6E4899FACE13C","B18824DE47D4D2E","CA98F8436C79D33"];
    var detail = ["Abonnement offre1 RUBIS","Abonnement offre2 RUBIS","Abonnement offre3 RUBIS"];
...
function methodePay(mth){
    ...
    /* les élements des 2 tableaux doivent correspondre forfait => prix */
    var prix = [400.00,525.00,700.00];
    var detail = ["Forfait 100 min RUBIS","Forfait 150 min RUBIS","Forfait 200 min RUBIS"];
                    ...
                    <div class="bloc-forfait-abonnement">
                        ...
                        <div class="bloc-forfait">
                            ...
                            <div class ="text-forfait">
                                ...
                                <p>Profitez de tarifs dégressifs grâce au forfait <span class="frt-name">rubis</span> avec votre voyant ! <br> Fixez vous du temps selon votre budget !
                            ...
                            <div class="forfait-name">
                                <img src="images/abonnement/rubis/rubis.png">
                            </div>
                            ...
                            <div class="tarifs-min">
                                <ul>
                                    <li><span class="txt-nb-min">&nbsp;&nbsp;50 min</span> <span class="pts-pts">............</span> 200<sup>€</sup>&nbsp;&nbsp;&nbsp;
                                        <span class="prix-ini">250<sup>€</sup></span>
                                    </li>
                                    <li ><span class="txt-nb-min">100 min</span> <span class="pts-pts">............</span> 400<sup>€</sup>&nbsp;&nbsp;&nbsp;
                                        <span class="prix-ini">450<sup>€</sup></span>
                                    </li>
                                    <li><span class="txt-nb-min">150 min</span> <span class="pts-pts">............ </span>525<sup>€</sup>&nbsp;&nbsp;&nbsp;
                                        <span class="prix-ini">675<sup>€</sup></span>
                                    </li>
                                    <li><span class="txt-nb-min">200 min</span> <span class="pts-pts">............</span> 700<sup>€</sup>&nbsp;&nbsp;&nbsp;
                                        <span class="prix-ini">900<sup>€</sup></span>
                                    </li>
                                </ul>   
                            </div> 
                        ...
                        <div class="bloc-abonnement">
                            ...
                            <div class ="text-abonnement">
                                ...
                                <p> <span class="abo-cgu">Abonnement avec un engagement sur 12 mois en profitant de tarifs exceptionnels:<br>
                                    Abonnement mensuel d'une durée d'un an avec un voyant de la gamme <span class="frt-name">rubis</span> de votre choix.</span></p>
                            </div>
                            <div class ="offres offre1"><img src="images/abonnement/rubis/rubis-offre1.png"><a href="#ouvert" onclick="offreAbo(0)"><img class="btn-cmd" src="images/abonnement/commander.png"></a>
                            </div>
                            <div class ="offres offre2"><a href="#ouvert" onclick="offreAbo(1)"><img class="btn-cmd" src="images/abonnement/commander.png"></a><img src="images/abonnement/rubis/rubis-offre2.png">
                            </div>
                            <div class ="offres offre3"><img src="images/abonnement/rubis/rubis-offre3.png"><a href="#ouvert" onclick="offreAbo(2)"><img class="btn-cmd" src="images/abonnement/commander.png"></a>
                            </div>
                        </div>
                    <div>
