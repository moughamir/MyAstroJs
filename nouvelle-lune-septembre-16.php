...
/* 
    -------------------------------------------------
    --   nouvelle-lune-septembre-16 = AFFIL BASE   --
    -------------------------------------------------

    Created on : 29 septembre 2016
    Author     : Laurène Dourdin <2aurene@gmail.com>
*/

$questions = array(
    'Amour' => array(
        [ 'code' => 'nls16_question_1', 'subject' => 'sentimental', 'text' => 'Quand vais-je rencontrer l’amour ?' ],
        [ 'code' => 'nls16_question_2', 'subject' => 'sentimental', 'text' => 'Quels sont ses sentiments pour moi ?', 'conjoint' => true ],
        [ 'code' => 'nls16_question_24', 'subject' => 'sentimental', 'text' => 'Mes sentiments sont confus, que dois-je faire ?', 'conjoint' => true],
        [ 'code' => 'nls16_question_11', 'subject' => 'sentimental', 'text' => 'Ai-je encore un avenir avec lui/elle ?', 'conjoint' => true],
    ),
    'Argent' => array(
        [ 'code' => 'nls16_question_73', 'subject' => 'financier', 'text' => 'Vais-je gagner de l’argent ?' ],
    ),
    'Travail' => array(
        [ 'code' => 'nls16_question_4', 'subject' => 'professionnel', 'text' => 'Quel sera mon avenir professionnel ?' ],
        [ 'code' => 'nls16_question_3', 'subject' => 'professionnel', 'text' => 'Quand vais-je trouver du travail ?' ],
    )
);
?>
<!DOCTYPE html>
<html lang="fr">
    <head>
        ...
        <meta property="og:url" content="http://www.myastro.fr/nouvelle-lune-septembre-16" />
